...
const file_api_db_v1_db_proto_rawDesc = "" +
	...
	"\x02ok\x18\x01 \x01(\bR\x02ok\"\xfd\x01\n" +
	...
	"\blost_ids\x18\x06 \x03(\x03R\alostIds\"\x19\n" +
	...
	"#CREATE_GUILD_REFUSAL_CHARACTER_GONE\x10\x052\xfd&\n" +
	...
	"\x18SalvarPersonagemComCarga\x12&.db.v1.SalvarPersonagemComCargaRequest\x1a\x1c.db.v1.SaveCharacterResponse\x12S\n" +
...
var file_api_db_v1_db_proto_msgTypes = make([]protoimpl.MessageInfo, 214)
var file_api_db_v1_db_proto_goTypes = []any{
	...
	(*SalvarPersonagemComCargaRequest)(nil),  // 19: db.v1.SalvarPersonagemComCargaRequest
	(*QuoteKingdomCapeRequest)(nil),          // 20: db.v1.QuoteKingdomCapeRequest
	(*QuoteKingdomCapeResponse)(nil),         // 21: db.v1.QuoteKingdomCapeResponse
	(*PurchaseKingdomCapeRequest)(nil),       // 22: db.v1.PurchaseKingdomCapeRequest
	(*PurchaseKingdomCapeResponse)(nil),      // 23: db.v1.PurchaseKingdomCapeResponse
	(*TransferPlayerBalanceRequest)(nil),     // 24: db.v1.TransferPlayerBalanceRequest
	(*TransferPlayerBalanceResponse)(nil),    // 25: db.v1.TransferPlayerBalanceResponse
	(*CreateCharacterRequest)(nil),           // 26: db.v1.CreateCharacterRequest
	(*CreateCharacterResponse)(nil),          // 27: db.v1.CreateCharacterResponse
	(*CreateArchCharacterRequest)(nil),       // 28: db.v1.CreateArchCharacterRequest
	(*CreateArchCharacterResponse)(nil),      // 29: db.v1.CreateArchCharacterResponse
	(*DeleteCharacterRequest)(nil),           // 30: db.v1.DeleteCharacterRequest
	(*DeleteCharacterResponse)(nil),          // 31: db.v1.DeleteCharacterResponse
	(*SetPinRequest)(nil),                    // 32: db.v1.SetPinRequest
	(*SetPinResponse)(nil),                   // 33: db.v1.SetPinResponse
	(*VerifyPinRequest)(nil),                 // 34: db.v1.VerifyPinRequest
	(*VerifyPinResponse)(nil),                // 35: db.v1.VerifyPinResponse
	(*LoadCargoRequest)(nil),                 // 36: db.v1.LoadCargoRequest
	(*LoadCargoResponse)(nil),                // 37: db.v1.LoadCargoResponse
	(*SaveCargoRequest)(nil),                 // 38: db.v1.SaveCargoRequest
	(*SaveCargoResponse)(nil),                // 39: db.v1.SaveCargoResponse
	(*Delivery)(nil),                         // 40: db.v1.Delivery
	(*ListPendingDeliveriesRequest)(nil),     // 41: db.v1.ListPendingDeliveriesRequest
	(*ListPendingDeliveriesResponse)(nil),    // 42: db.v1.ListPendingDeliveriesResponse
	(*ListSoldEscrowSlotsRequest)(nil),       // 43: db.v1.ListSoldEscrowSlotsRequest
	(*ListSoldEscrowSlotsResponse)(nil),      // 44: db.v1.ListSoldEscrowSlotsResponse
	(*RmtListing)(nil),                       // 45: db.v1.RmtListing
	(*OpenRmtListingsRequest)(nil),           // 46: db.v1.OpenRmtListingsRequest
	(*OpenRmtListingsResponse)(nil),          // 47: db.v1.OpenRmtListingsResponse
	(*CancelRmtListingsRequest)(nil),         // 48: db.v1.CancelRmtListingsRequest
	(*CancelRmtListingsResponse)(nil),        // 49: db.v1.CancelRmtListingsResponse
	(*CloseRmtListingsRequest)(nil),          // 50: db.v1.CloseRmtListingsRequest
	(*ClosedRmtListing)(nil),                 // 51: db.v1.ClosedRmtListing
	(*CloseRmtListingsResponse)(nil),         // 52: db.v1.CloseRmtListingsResponse
	(*OpenRmtChargeRequest)(nil),             // 53: db.v1.OpenRmtChargeRequest
	(*OpenRmtChargeResponse)(nil),            // 54: db.v1.OpenRmtChargeResponse
	(*ReconcileRmtEscrowRequest)(nil),        // 55: db.v1.ReconcileRmtEscrowRequest
	(*ReconcileRmtEscrowResponse)(nil),       // 56: db.v1.ReconcileRmtEscrowResponse
	(*SaveCargoWithDeliveriesRequest)(nil),   // 57: db.v1.SaveCargoWithDeliveriesRequest
	(*SetAccountBlockedRequest)(nil),         // 58: db.v1.SetAccountBlockedRequest
	(*SetAccountBlockedResponse)(nil),        // 59: db.v1.SetAccountBlockedResponse
	(*RecordDuelResultRequest)(nil),          // 60: db.v1.RecordDuelResultRequest
	(*RecordDuelResultResponse)(nil),         // 61: db.v1.RecordDuelResultResponse
	(*TradeItem)(nil),                        // 62: db.v1.TradeItem
	(*RecordTradeRequest)(nil),               // 63: db.v1.RecordTradeRequest
	(*RecordTradeResponse)(nil),              // 64: db.v1.RecordTradeResponse
	(*ReserveSerialsRequest)(nil),            // 65: db.v1.ReserveSerialsRequest
	(*ReserveSerialsResponse)(nil),           // 66: db.v1.ReserveSerialsResponse
	(*ChatLine)(nil),                         // 67: db.v1.ChatLine
	(*RecordChatRequest)(nil),                // 68: db.v1.RecordChatRequest
	(*RecordChatResponse)(nil),               // 69: db.v1.RecordChatResponse
	(*RecordGroundRequest)(nil),              // 70: db.v1.RecordGroundRequest
	(*RecordGroundResponse)(nil),             // 71: db.v1.RecordGroundResponse
	(*RecordReportRequest)(nil),              // 72: db.v1.RecordReportRequest
	(*RecordReportResponse)(nil),             // 73: db.v1.RecordReportResponse
	(*SetCharacterPresenceRequest)(nil),      // 74: db.v1.SetCharacterPresenceRequest
	(*SetCharacterPresenceResponse)(nil),     // 75: db.v1.SetCharacterPresenceResponse
	(*ClearAllPresenceRequest)(nil),          // 76: db.v1.ClearAllPresenceRequest
	(*ClearAllPresenceResponse)(nil),         // 77: db.v1.ClearAllPresenceResponse
	(*AddShopPointsRequest)(nil),             // 78: db.v1.AddShopPointsRequest
	(*AddShopPointsResponse)(nil),            // 79: db.v1.AddShopPointsResponse
	(*ShopPointsRequest)(nil),                // 80: db.v1.ShopPointsRequest
	(*ShopPointsResponse)(nil),               // 81: db.v1.ShopPointsResponse
	(*SpendShopPointsRequest)(nil),           // 82: db.v1.SpendShopPointsRequest
	(*SpendShopPointsResponse)(nil),          // 83: db.v1.SpendShopPointsResponse
	(*ClaimNewbieKitRequest)(nil),            // 84: db.v1.ClaimNewbieKitRequest
	(*ClaimNewbieKitResponse)(nil),           // 85: db.v1.ClaimNewbieKitResponse
	(*Guild)(nil),                            // 86: db.v1.Guild
	(*GuildMember)(nil),                      // 87: db.v1.GuildMember
	(*GuildRelation)(nil),                    // 88: db.v1.GuildRelation
	(*CreateGuildRequest)(nil),               // 89: db.v1.CreateGuildRequest
	(*CreateGuildResponse)(nil),              // 90: db.v1.CreateGuildResponse
	(*SetGuildMemberRequest)(nil),            // 91: db.v1.SetGuildMemberRequest
	(*SetGuildMemberResponse)(nil),           // 92: db.v1.SetGuildMemberResponse
	(*LeaveGuildRequest)(nil),                // 93: db.v1.LeaveGuildRequest
	(*PromoteGuildMemberRequest)(nil),        // 94: db.v1.PromoteGuildMemberRequest
	(*PromoteGuildMemberResponse)(nil),       // 95: db.v1.PromoteGuildMemberResponse
	(*TransferGuildLeaderRequest)(nil),       // 96: db.v1.TransferGuildLeaderRequest
	(*SetGuildRelationRequest)(nil),          // 97: db.v1.SetGuildRelationRequest
	(*SetGuildRelationResponse)(nil),         // 98: db.v1.SetGuildRelationResponse
	(*ListGuildsRequest)(nil),                // 99: db.v1.ListGuildsRequest
	(*ListGuildsResponse)(nil),               // 100: db.v1.ListGuildsResponse
	(*ListGuildRelationsRequest)(nil),        // 101: db.v1.ListGuildRelationsRequest
	(*ListGuildRelationsResponse)(nil),       // 102: db.v1.ListGuildRelationsResponse
	(*ListGuildMembersRequest)(nil),          // 103: db.v1.ListGuildMembersRequest
	(*GuildBuff)(nil),                        // 104: db.v1.GuildBuff
	(*GuildSummary)(nil),                     // 105: db.v1.GuildSummary
	(*ListGuildSummariesRequest)(nil),        // 106: db.v1.ListGuildSummariesRequest
	(*ListGuildSummariesResponse)(nil),       // 107: db.v1.ListGuildSummariesResponse
	(*GuildSquad)(nil),                       // 108: db.v1.GuildSquad
	(*ListGuildSquadsRequest)(nil),           // 109: db.v1.ListGuildSquadsRequest
	(*ListGuildSquadsResponse)(nil),          // 110: db.v1.ListGuildSquadsResponse
	(*SetGuildSquadRequest)(nil),             // 111: db.v1.SetGuildSquadRequest
	(*SetGuildSquadResponse)(nil),            // 112: db.v1.SetGuildSquadResponse
	(*ListGuildBuffsRequest)(nil),            // 113: db.v1.ListGuildBuffsRequest
	(*ListGuildBuffsResponse)(nil),           // 114: db.v1.ListGuildBuffsResponse
	(*SaveGuildBuffRequest)(nil),             // 115: db.v1.SaveGuildBuffRequest
	(*SaveGuildBuffResponse)(nil),            // 116: db.v1.SaveGuildBuffResponse
	(*DeleteGuildBuffRequest)(nil),           // 117: db.v1.DeleteGuildBuffRequest
	(*DeleteGuildBuffResponse)(nil),          // 118: db.v1.DeleteGuildBuffResponse
	(*ListGuildMembersResponse)(nil),         // 119: db.v1.ListGuildMembersResponse
	(*SaveGuildNoticeRequest)(nil),           // 120: db.v1.SaveGuildNoticeRequest
	(*SaveGuildNoticeResponse)(nil),          // 121: db.v1.SaveGuildNoticeResponse
	(*GuildZone)(nil),                        // 122: db.v1.GuildZone
	(*LoadGuildZonesRequest)(nil),            // 123: db.v1.LoadGuildZonesRequest
	(*LoadGuildZonesResponse)(nil),           // 124: db.v1.LoadGuildZonesResponse
	(*SaveGuildZoneRequest)(nil),             // 125: db.v1.SaveGuildZoneRequest
	(*SaveGuildZoneResponse)(nil),            // 126: db.v1.SaveGuildZoneResponse
	(*GuildTowerState)(nil),                  // 127: db.v1.GuildTowerState
	(*LoadGuildTowerStateRequest)(nil),       // 128: db.v1.LoadGuildTowerStateRequest
	(*LoadGuildTowerStateResponse)(nil),      // 129: db.v1.LoadGuildTowerStateResponse
	(*SaveGuildTowerStateRequest)(nil),       // 130: db.v1.SaveGuildTowerStateRequest
	(*SaveGuildTowerStateResponse)(nil),      // 131: db.v1.SaveGuildTowerStateResponse
	(*SaveGuildFameRequest)(nil),             // 132: db.v1.SaveGuildFameRequest
	(*SaveGuildFameResponse)(nil),            // 133: db.v1.SaveGuildFameResponse
	(*CastleQuestState)(nil),                 // 134: db.v1.CastleQuestState
	(*LoadCastleQuestStateRequest)(nil),      // 135: db.v1.LoadCastleQuestStateRequest
	(*LoadCastleQuestStateResponse)(nil),     // 136: db.v1.LoadCastleQuestStateResponse
	(*SaveCastleQuestStateRequest)(nil),      // 137: db.v1.SaveCastleQuestStateRequest
	(*SaveCastleQuestStateResponse)(nil),     // 138: db.v1.SaveCastleQuestStateResponse
	(*NpcConfigVersionRequest)(nil),          // 139: db.v1.NpcConfigVersionRequest
	(*NpcConfigVersionResponse)(nil),         // 140: db.v1.NpcConfigVersionResponse
	(*ListNpcDefinitionsRequest)(nil),        // 141: db.v1.ListNpcDefinitionsRequest
	(*ListNpcDefinitionsResponse)(nil),       // 142: db.v1.ListNpcDefinitionsResponse
	(*NpcShopItem)(nil),                      // 143: db.v1.NpcShopItem
	(*NpcDefinition)(nil),                    // 144: db.v1.NpcDefinition
	(*ItemPrice)(nil),                        // 145: db.v1.ItemPrice
	(*WorldEventConfigVersionRequest)(nil),   // 146: db.v1.WorldEventConfigVersionRequest
	(*WorldEventConfigVersionResponse)(nil),  // 147: db.v1.WorldEventConfigVersionResponse
	(*GetWorldEventConfigRequest)(nil),       // 148: db.v1.GetWorldEventConfigRequest
	(*GetWorldEventConfigResponse)(nil),      // 149: db.v1.GetWorldEventConfigResponse
	(*UpdateWorldEventProgressRequest)(nil),  // 150: db.v1.UpdateWorldEventProgressRequest
	(*UpdateWorldEventProgressResponse)(nil), // 151: db.v1.UpdateWorldEventProgressResponse
	(*SetKefraStateRequest)(nil),             // 152: db.v1.SetKefraStateRequest
	(*SetKefraStateResponse)(nil),            // 153: db.v1.SetKefraStateResponse
	(*WorldEventConfig)(nil),                 // 154: db.v1.WorldEventConfig
	(*ListMobTemplateStatsRequest)(nil),      // 155: db.v1.ListMobTemplateStatsRequest
	(*ListMobTemplateStatsResponse)(nil),     // 156: db.v1.ListMobTemplateStatsResponse
	(*MobTemplateEquipItem)(nil),             // 157: db.v1.MobTemplateEquipItem
	(*MobTemplateStat)(nil),                  // 158: db.v1.MobTemplateStat
	(*ListItemStatsRequest)(nil),             // 159: db.v1.ListItemStatsRequest
	(*ListItemStatsResponse)(nil),            // 160: db.v1.ListItemStatsResponse
	(*ItemStat)(nil),                         // 161: db.v1.ItemStat
	(*ListMountGrowthRatesRequest)(nil),      // 162: db.v1.ListMountGrowthRatesRequest
	(*ListMountGrowthRatesResponse)(nil),     // 163: db.v1.ListMountGrowthRatesResponse
	(*MountGrowthRate)(nil),                  // 164: db.v1.MountGrowthRate
	(*MountConfigVersionRequest)(nil),        // 165: db.v1.MountConfigVersionRequest
	(*MountConfigVersionResponse)(nil),       // 166: db.v1.MountConfigVersionResponse
	(*ListMountAbsorbRequest)(nil),           // 167: db.v1.ListMountAbsorbRequest
	(*ListMountAbsorbResponse)(nil),          // 168: db.v1.ListMountAbsorbResponse
	(*MountAbsorb)(nil),                      // 169: db.v1.MountAbsorb
	(*ListMountBonusRequest)(nil),            // 170: db.v1.ListMountBonusRequest
	(*ListMountBonusResponse)(nil),           // 171: db.v1.ListMountBonusResponse
	(*MountBonus)(nil),                       // 172: db.v1.MountBonus
	(*XPConfigVersionRequest)(nil),           // 173: db.v1.XPConfigVersionRequest
	(*XPConfigVersionResponse)(nil),          // 174: db.v1.XPConfigVersionResponse
	(*GetXPConfigRequest)(nil),               // 175: db.v1.GetXPConfigRequest
	(*GetXPConfigResponse)(nil),              // 176: db.v1.GetXPConfigResponse
	(*XPCut)(nil),                            // 177: db.v1.XPCut
	(*XPRule)(nil),                           // 178: db.v1.XPRule
	(*DungeonGateVersionRequest)(nil),        // 179: db.v1.DungeonGateVersionRequest
	(*DungeonGateVersionResponse)(nil),       // 180: db.v1.DungeonGateVersionResponse
	(*GetDungeonGatesRequest)(nil),           // 181: db.v1.GetDungeonGatesRequest
	(*GetDungeonGatesResponse)(nil),          // 182: db.v1.GetDungeonGatesResponse
	(*DungeonGate)(nil),                      // 183: db.v1.DungeonGate
	(*GetQuestRewardsRequest)(nil),           // 184: db.v1.GetQuestRewardsRequest
	(*GetQuestRewardsResponse)(nil),          // 185: db.v1.GetQuestRewardsResponse
	(*QuestReward)(nil),                      // 186: db.v1.QuestReward
	(*GetDropBonusRequest)(nil),              // 187: db.v1.GetDropBonusRequest
	(*GetDropBonusResponse)(nil),             // 188: db.v1.GetDropBonusResponse
	(*DropBonusBand)(nil),                    // 189: db.v1.DropBonusBand
	(*SpawnRateVersionRequest)(nil),          // 190: db.v1.SpawnRateVersionRequest
	(*SpawnRateVersionResponse)(nil),         // 191: db.v1.SpawnRateVersionResponse
	(*GetSpawnRatesRequest)(nil),             // 192: db.v1.GetSpawnRatesRequest
	(*GetSpawnRatesResponse)(nil),            // 193: db.v1.GetSpawnRatesResponse
	(*SpawnRate)(nil),                        // 194: db.v1.SpawnRate
	(*CombineRateVersionRequest)(nil),        // 195: db.v1.CombineRateVersionRequest
	(*CombineRateVersionResponse)(nil),       // 196: db.v1.CombineRateVersionResponse
	(*GetCombineRatesRequest)(nil),           // 197: db.v1.GetCombineRatesRequest
	(*GetCombineRatesResponse)(nil),          // 198: db.v1.GetCombineRatesResponse
	(*CombineRate)(nil),                      // 199: db.v1.CombineRate
	(*CombineBand)(nil),                      // 200: db.v1.CombineBand
	(*CombatRuleVersionRequest)(nil),         // 201: db.v1.CombatRuleVersionRequest
	(*CombatRuleVersionResponse)(nil),        // 202: db.v1.CombatRuleVersionResponse
	(*GetCombatRuleRequest)(nil),             // 203: db.v1.GetCombatRuleRequest
	(*GetCombatRuleResponse)(nil),            // 204: db.v1.GetCombatRuleResponse
	(*GeneratorOffVersionRequest)(nil),       // 205: db.v1.GeneratorOffVersionRequest
	(*GeneratorOffVersionResponse)(nil),      // 206: db.v1.GeneratorOffVersionResponse
	(*GetGeneratorsOffRequest)(nil),          // 207: db.v1.GetGeneratorsOffRequest
	(*GetGeneratorsOffResponse)(nil),         // 208: db.v1.GetGeneratorsOffResponse
	(*GeneratorOff)(nil),                     // 209: db.v1.GeneratorOff
	(*SetGeneratorOffRequest)(nil),           // 210: db.v1.SetGeneratorOffRequest
	(*SetGeneratorOffResponse)(nil),          // 211: db.v1.SetGeneratorOffResponse
	(*DropRuleVersionRequest)(nil),           // 212: db.v1.DropRuleVersionRequest
	(*DropRuleVersionResponse)(nil),          // 213: db.v1.DropRuleVersionResponse
	(*ListDropRulesRequest)(nil),             // 214: db.v1.ListDropRulesRequest
	(*DropRule)(nil),                         // 215: db.v1.DropRule
	(*ListDropRulesResponse)(nil),            // 216: db.v1.ListDropRulesResponse
	(*CreditDonateRequest)(nil),              // 217: db.v1.CreditDonateRequest
	(*CreditDonateResponse)(nil),             // 218: db.v1.CreditDonateResponse
	(*DonateBalanceRequest)(nil),             // 219: db.v1.DonateBalanceRequest
	(*DonateBalanceResponse)(nil),            // 220: db.v1.DonateBalanceResponse
}
var file_api_db_v1_db_proto_depIdxs = []int32{
	...
	21,  // 11: db.v1.PurchaseKingdomCapeResponse.quote:type_name -> db.v1.QuoteKingdomCapeResponse
	...
	40,  // 18: db.v1.ListPendingDeliveriesResponse.deliveries:type_name -> db.v1.Delivery
	45,  // 19: db.v1.OpenRmtListingsRequest.listings:type_name -> db.v1.RmtListing
	51,  // 20: db.v1.CloseRmtListingsResponse.closed:type_name -> db.v1.ClosedRmtListing
	...
	62,  // 23: db.v1.RecordTradeRequest.items_a:type_name -> db.v1.TradeItem
	62,  // 24: db.v1.RecordTradeRequest.items_b:type_name -> db.v1.TradeItem
	67,  // 25: db.v1.RecordChatRequest.lines:type_name -> db.v1.ChatLine
	5,   // 26: db.v1.GuildRelation.kind:type_name -> db.v1.GuildRelationKind
	86,  // 27: db.v1.CreateGuildResponse.guild:type_name -> db.v1.Guild
	...
	86,  // 30: db.v1.ListGuildsResponse.guilds:type_name -> db.v1.Guild
	88,  // 31: db.v1.ListGuildRelationsResponse.relations:type_name -> db.v1.GuildRelation
	105, // 32: db.v1.ListGuildSummariesResponse.guilds:type_name -> db.v1.GuildSummary
	108, // 33: db.v1.ListGuildSquadsResponse.squads:type_name -> db.v1.GuildSquad
	104, // 34: db.v1.ListGuildBuffsResponse.buffs:type_name -> db.v1.GuildBuff
	104, // 35: db.v1.SaveGuildBuffRequest.buff:type_name -> db.v1.GuildBuff
	87,  // 36: db.v1.ListGuildMembersResponse.members:type_name -> db.v1.GuildMember
	122, // 37: db.v1.LoadGuildZonesResponse.zones:type_name -> db.v1.GuildZone
	122, // 38: db.v1.SaveGuildZoneRequest.zone:type_name -> db.v1.GuildZone
	127, // 39: db.v1.LoadGuildTowerStateResponse.state:type_name -> db.v1.GuildTowerState
	127, // 40: db.v1.SaveGuildTowerStateRequest.state:type_name -> db.v1.GuildTowerState
	134, // 41: db.v1.LoadCastleQuestStateResponse.state:type_name -> db.v1.CastleQuestState
	134, // 42: db.v1.SaveCastleQuestStateRequest.state:type_name -> db.v1.CastleQuestState
	144, // 43: db.v1.ListNpcDefinitionsResponse.definitions:type_name -> db.v1.NpcDefinition
	145, // 44: db.v1.ListNpcDefinitionsResponse.price_overrides:type_name -> db.v1.ItemPrice
	143, // 45: db.v1.NpcDefinition.shop:type_name -> db.v1.NpcShopItem
	154, // 46: db.v1.GetWorldEventConfigResponse.config:type_name -> db.v1.WorldEventConfig
	158, // 47: db.v1.ListMobTemplateStatsResponse.overrides:type_name -> db.v1.MobTemplateStat
	157, // 48: db.v1.MobTemplateStat.equip:type_name -> db.v1.MobTemplateEquipItem
	161, // 49: db.v1.ListItemStatsResponse.overrides:type_name -> db.v1.ItemStat
	164, // 50: db.v1.ListMountGrowthRatesResponse.rates:type_name -> db.v1.MountGrowthRate
	169, // 51: db.v1.ListMountAbsorbResponse.absorb:type_name -> db.v1.MountAbsorb
	172, // 52: db.v1.ListMountBonusResponse.bonus:type_name -> db.v1.MountBonus
	178, // 53: db.v1.GetXPConfigResponse.rules:type_name -> db.v1.XPRule
	177, // 54: db.v1.XPRule.cuts:type_name -> db.v1.XPCut
	183, // 55: db.v1.GetDungeonGatesResponse.gates:type_name -> db.v1.DungeonGate
	186, // 56: db.v1.GetQuestRewardsResponse.tiers:type_name -> db.v1.QuestReward
	189, // 57: db.v1.GetDropBonusResponse.faixas:type_name -> db.v1.DropBonusBand
	194, // 58: db.v1.GetSpawnRatesResponse.areas:type_name -> db.v1.SpawnRate
	199, // 59: db.v1.GetCombineRatesResponse.rates:type_name -> db.v1.CombineRate
	200, // 60: db.v1.GetCombineRatesResponse.bands:type_name -> db.v1.CombineBand
	209, // 61: db.v1.GetGeneratorsOffResponse.off:type_name -> db.v1.GeneratorOff
	215, // 62: db.v1.ListDropRulesResponse.rules:type_name -> db.v1.DropRule
	...
	19,  // 67: db.v1.AccountService.SalvarPersonagemComCarga:input_type -> db.v1.SalvarPersonagemComCargaRequest
	20,  // 68: db.v1.AccountService.QuoteKingdomCape:input_type -> db.v1.QuoteKingdomCapeRequest
	22,  // 69: db.v1.AccountService.PurchaseKingdomCape:input_type -> db.v1.PurchaseKingdomCapeRequest
	24,  // 70: db.v1.AccountService.TransferPlayerBalance:input_type -> db.v1.TransferPlayerBalanceRequest
	26,  // 71: db.v1.AccountService.CreateCharacter:input_type -> db.v1.CreateCharacterRequest
	28,  // 72: db.v1.AccountService.CreateArchCharacter:input_type -> db.v1.CreateArchCharacterRequest
	30,  // 73: db.v1.AccountService.DeleteCharacter:input_type -> db.v1.DeleteCharacterRequest
	32,  // 74: db.v1.AccountService.SetPin:input_type -> db.v1.SetPinRequest
	34,  // 75: db.v1.AccountService.VerifyPin:input_type -> db.v1.VerifyPinRequest
	36,  // 76: db.v1.AccountService.LoadCargo:input_type -> db.v1.LoadCargoRequest
	38,  // 77: db.v1.AccountService.SaveCargo:input_type -> db.v1.SaveCargoRequest
	41,  // 78: db.v1.AccountService.ListPendingDeliveries:input_type -> db.v1.ListPendingDeliveriesRequest
	43,  // 79: db.v1.AccountService.ListSoldEscrowSlots:input_type -> db.v1.ListSoldEscrowSlotsRequest
	46,  // 80: db.v1.AccountService.OpenRmtListings:input_type -> db.v1.OpenRmtListingsRequest
	48,  // 81: db.v1.AccountService.CancelRmtListings:input_type -> db.v1.CancelRmtListingsRequest
	50,  // 82: db.v1.AccountService.CloseRmtListings:input_type -> db.v1.CloseRmtListingsRequest
	55,  // 83: db.v1.AccountService.ReconcileRmtEscrow:input_type -> db.v1.ReconcileRmtEscrowRequest
	53,  // 84: db.v1.AccountService.OpenRmtCharge:input_type -> db.v1.OpenRmtChargeRequest
	57,  // 85: db.v1.AccountService.SaveCargoWithDeliveries:input_type -> db.v1.SaveCargoWithDeliveriesRequest
	58,  // 86: db.v1.AccountService.SetAccountBlocked:input_type -> db.v1.SetAccountBlockedRequest
	60,  // 87: db.v1.AccountService.RecordDuelResult:input_type -> db.v1.RecordDuelResultRequest
	63,  // 88: db.v1.AccountService.RecordTrade:input_type -> db.v1.RecordTradeRequest
	72,  // 89: db.v1.AccountService.RecordReport:input_type -> db.v1.RecordReportRequest
	70,  // 90: db.v1.AccountService.RecordGround:input_type -> db.v1.RecordGroundRequest
	65,  // 91: db.v1.AccountService.ReserveSerials:input_type -> db.v1.ReserveSerialsRequest
	68,  // 92: db.v1.AccountService.RecordChat:input_type -> db.v1.RecordChatRequest
	74,  // 93: db.v1.AccountService.SetCharacterPresence:input_type -> db.v1.SetCharacterPresenceRequest
	76,  // 94: db.v1.AccountService.ClearAllPresence:input_type -> db.v1.ClearAllPresenceRequest
	78,  // 95: db.v1.AccountService.AddShopPoints:input_type -> db.v1.AddShopPointsRequest
	80,  // 96: db.v1.AccountService.ShopPoints:input_type -> db.v1.ShopPointsRequest
	82,  // 97: db.v1.AccountService.SpendShopPoints:input_type -> db.v1.SpendShopPointsRequest
	84,  // 98: db.v1.AccountService.ClaimNewbieKit:input_type -> db.v1.ClaimNewbieKitRequest
	217, // 99: db.v1.AccountService.CreditDonate:input_type -> db.v1.CreditDonateRequest
	219, // 100: db.v1.AccountService.DonateBalance:input_type -> db.v1.DonateBalanceRequest
	89,  // 101: db.v1.AccountService.CreateGuild:input_type -> db.v1.CreateGuildRequest
	91,  // 102: db.v1.AccountService.SetGuildMember:input_type -> db.v1.SetGuildMemberRequest
	93,  // 103: db.v1.AccountService.LeaveGuild:input_type -> db.v1.LeaveGuildRequest
	94,  // 104: db.v1.AccountService.PromoteGuildMember:input_type -> db.v1.PromoteGuildMemberRequest
	96,  // 105: db.v1.AccountService.TransferGuildLeader:input_type -> db.v1.TransferGuildLeaderRequest
	97,  // 106: db.v1.AccountService.SetGuildRelation:input_type -> db.v1.SetGuildRelationRequest
	99,  // 107: db.v1.AccountService.ListGuilds:input_type -> db.v1.ListGuildsRequest
	101, // 108: db.v1.AccountService.ListGuildRelations:input_type -> db.v1.ListGuildRelationsRequest
	103, // 109: db.v1.AccountService.ListGuildMembers:input_type -> db.v1.ListGuildMembersRequest
	120, // 110: db.v1.AccountService.SaveGuildNotice:input_type -> db.v1.SaveGuildNoticeRequest
	106, // 111: db.v1.AccountService.ListGuildSummaries:input_type -> db.v1.ListGuildSummariesRequest
	109, // 112: db.v1.AccountService.ListGuildSquads:input_type -> db.v1.ListGuildSquadsRequest
	111, // 113: db.v1.AccountService.SetGuildSquad:input_type -> db.v1.SetGuildSquadRequest
	113, // 114: db.v1.AccountService.ListGuildBuffs:input_type -> db.v1.ListGuildBuffsRequest
	115, // 115: db.v1.AccountService.SaveGuildBuff:input_type -> db.v1.SaveGuildBuffRequest
	117, // 116: db.v1.AccountService.DeleteGuildBuff:input_type -> db.v1.DeleteGuildBuffRequest
	123, // 117: db.v1.AccountService.LoadGuildZones:input_type -> db.v1.LoadGuildZonesRequest
	125, // 118: db.v1.AccountService.SaveGuildZone:input_type -> db.v1.SaveGuildZoneRequest
	128, // 119: db.v1.AccountService.LoadGuildTowerState:input_type -> db.v1.LoadGuildTowerStateRequest
	130, // 120: db.v1.AccountService.SaveGuildTowerState:input_type -> db.v1.SaveGuildTowerStateRequest
	132, // 121: db.v1.AccountService.SaveGuildFame:input_type -> db.v1.SaveGuildFameRequest
	135, // 122: db.v1.AccountService.LoadCastleQuestState:input_type -> db.v1.LoadCastleQuestStateRequest
	137, // 123: db.v1.AccountService.SaveCastleQuestState:input_type -> db.v1.SaveCastleQuestStateRequest
	139, // 124: db.v1.NpcConfigService.NpcConfigVersion:input_type -> db.v1.NpcConfigVersionRequest
	141, // 125: db.v1.NpcConfigService.ListNpcDefinitions:input_type -> db.v1.ListNpcDefinitionsRequest
	155, // 126: db.v1.NpcConfigService.ListMobTemplateStats:input_type -> db.v1.ListMobTemplateStatsRequest
	159, // 127: db.v1.NpcConfigService.ListItemStats:input_type -> db.v1.ListItemStatsRequest
	162, // 128: db.v1.NpcConfigService.ListMountGrowthRates:input_type -> db.v1.ListMountGrowthRatesRequest
	167, // 129: db.v1.NpcConfigService.ListMountAbsorb:input_type -> db.v1.ListMountAbsorbRequest
	170, // 130: db.v1.NpcConfigService.ListMountBonus:input_type -> db.v1.ListMountBonusRequest
	165, // 131: db.v1.NpcConfigService.MountConfigVersion:input_type -> db.v1.MountConfigVersionRequest
	146, // 132: db.v1.WorldEventConfigService.WorldEventConfigVersion:input_type -> db.v1.WorldEventConfigVersionRequest
	148, // 133: db.v1.WorldEventConfigService.GetWorldEventConfig:input_type -> db.v1.GetWorldEventConfigRequest
	150, // 134: db.v1.WorldEventConfigService.UpdateWorldEventProgress:input_type -> db.v1.UpdateWorldEventProgressRequest
	152, // 135: db.v1.WorldEventConfigService.SetKefraState:input_type -> db.v1.SetKefraStateRequest
	173, // 136: db.v1.XPConfigService.XPConfigVersion:input_type -> db.v1.XPConfigVersionRequest
	175, // 137: db.v1.XPConfigService.GetXPConfig:input_type -> db.v1.GetXPConfigRequest
	179, // 138: db.v1.DungeonGateService.DungeonGateVersion:input_type -> db.v1.DungeonGateVersionRequest
	181, // 139: db.v1.DungeonGateService.GetDungeonGates:input_type -> db.v1.GetDungeonGatesRequest
	184, // 140: db.v1.QuestRewardService.GetQuestRewards:input_type -> db.v1.GetQuestRewardsRequest
	187, // 141: db.v1.DropBonusService.GetDropBonus:input_type -> db.v1.GetDropBonusRequest
	190, // 142: db.v1.SpawnRateService.SpawnRateVersion:input_type -> db.v1.SpawnRateVersionRequest
	192, // 143: db.v1.SpawnRateService.GetSpawnRates:input_type -> db.v1.GetSpawnRatesRequest
	195, // 144: db.v1.CombineRateService.CombineRateVersion:input_type -> db.v1.CombineRateVersionRequest
	197, // 145: db.v1.CombineRateService.GetCombineRates:input_type -> db.v1.GetCombineRatesRequest
	201, // 146: db.v1.CombatRuleService.CombatRuleVersion:input_type -> db.v1.CombatRuleVersionRequest
	203, // 147: db.v1.CombatRuleService.GetCombatRule:input_type -> db.v1.GetCombatRuleRequest
	205, // 148: db.v1.NpcGeneratorService.GeneratorOffVersion:input_type -> db.v1.GeneratorOffVersionRequest
	207, // 149: db.v1.NpcGeneratorService.GetGeneratorsOff:input_type -> db.v1.GetGeneratorsOffRequest
	210, // 150: db.v1.NpcGeneratorService.SetGeneratorOff:input_type -> db.v1.SetGeneratorOffRequest
	212, // 151: db.v1.DropRuleService.DropRuleVersion:input_type -> db.v1.DropRuleVersionRequest
	214, // 152: db.v1.DropRuleService.ListDropRules:input_type -> db.v1.ListDropRulesRequest
	8,   // 153: db.v1.AccountService.AccountLogin:output_type -> db.v1.AccountLoginResponse
	11,  // 154: db.v1.AccountService.ListCharacters:output_type -> db.v1.ListCharactersResponse
	16,  // 155: db.v1.AccountService.LoadCharacter:output_type -> db.v1.LoadCharacterResponse
	18,  // 156: db.v1.AccountService.SaveCharacter:output_type -> db.v1.SaveCharacterResponse
	18,  // 157: db.v1.AccountService.SalvarPersonagemComCarga:output_type -> db.v1.SaveCharacterResponse
	21,  // 158: db.v1.AccountService.QuoteKingdomCape:output_type -> db.v1.QuoteKingdomCapeResponse
	23,  // 159: db.v1.AccountService.PurchaseKingdomCape:output_type -> db.v1.PurchaseKingdomCapeResponse
	25,  // 160: db.v1.AccountService.TransferPlayerBalance:output_type -> db.v1.TransferPlayerBalanceResponse
	27,  // 161: db.v1.AccountService.CreateCharacter:output_type -> db.v1.CreateCharacterResponse
	29,  // 162: db.v1.AccountService.CreateArchCharacter:output_type -> db.v1.CreateArchCharacterResponse
	31,  // 163: db.v1.AccountService.DeleteCharacter:output_type -> db.v1.DeleteCharacterResponse
	33,  // 164: db.v1.AccountService.SetPin:output_type -> db.v1.SetPinResponse
	35,  // 165: db.v1.AccountService.VerifyPin:output_type -> db.v1.VerifyPinResponse
	37,  // 166: db.v1.AccountService.LoadCargo:output_type -> db.v1.LoadCargoResponse
	39,  // 167: db.v1.AccountService.SaveCargo:output_type -> db.v1.SaveCargoResponse
	42,  // 168: db.v1.AccountService.ListPendingDeliveries:output_type -> db.v1.ListPendingDeliveriesResponse
	44,  // 169: db.v1.AccountService.ListSoldEscrowSlots:output_type -> db.v1.ListSoldEscrowSlotsResponse
	47,  // 170: db.v1.AccountService.OpenRmtListings:output_type -> db.v1.OpenRmtListingsResponse
	49,  // 171: db.v1.AccountService.CancelRmtListings:output_type -> db.v1.CancelRmtListingsResponse
	52,  // 172: db.v1.AccountService.CloseRmtListings:output_type -> db.v1.CloseRmtListingsResponse
	56,  // 173: db.v1.AccountService.ReconcileRmtEscrow:output_type -> db.v1.ReconcileRmtEscrowResponse
	54,  // 174: db.v1.AccountService.OpenRmtCharge:output_type -> db.v1.OpenRmtChargeResponse
	39,  // 175: db.v1.AccountService.SaveCargoWithDeliveries:output_type -> db.v1.SaveCargoResponse
	59,  // 176: db.v1.AccountService.SetAccountBlocked:output_type -> db.v1.SetAccountBlockedResponse
	61,  // 177: db.v1.AccountService.RecordDuelResult:output_type -> db.v1.RecordDuelResultResponse
	64,  // 178: db.v1.AccountService.RecordTrade:output_type -> db.v1.RecordTradeResponse
	73,  // 179: db.v1.AccountService.RecordReport:output_type -> db.v1.RecordReportResponse
	71,  // 180: db.v1.AccountService.RecordGround:output_type -> db.v1.RecordGroundResponse
	66,  // 181: db.v1.AccountService.ReserveSerials:output_type -> db.v1.ReserveSerialsResponse
	69,  // 182: db.v1.AccountService.RecordChat:output_type -> db.v1.RecordChatResponse
	75,  // 183: db.v1.AccountService.SetCharacterPresence:output_type -> db.v1.SetCharacterPresenceResponse
	77,  // 184: db.v1.AccountService.ClearAllPresence:output_type -> db.v1.ClearAllPresenceResponse
	79,  // 185: db.v1.AccountService.AddShopPoints:output_type -> db.v1.AddShopPointsResponse
	81,  // 186: db.v1.AccountService.ShopPoints:output_type -> db.v1.ShopPointsResponse
	83,  // 187: db.v1.AccountService.SpendShopPoints:output_type -> db.v1.SpendShopPointsResponse
	85,  // 188: db.v1.AccountService.ClaimNewbieKit:output_type -> db.v1.ClaimNewbieKitResponse
	218, // 189: db.v1.AccountService.CreditDonate:output_type -> db.v1.CreditDonateResponse
	220, // 190: db.v1.AccountService.DonateBalance:output_type -> db.v1.DonateBalanceResponse
	90,  // 191: db.v1.AccountService.CreateGuild:output_type -> db.v1.CreateGuildResponse
	92,  // 192: db.v1.AccountService.SetGuildMember:output_type -> db.v1.SetGuildMemberResponse
	92,  // 193: db.v1.AccountService.LeaveGuild:output_type -> db.v1.SetGuildMemberResponse
	95,  // 194: db.v1.AccountService.PromoteGuildMember:output_type -> db.v1.PromoteGuildMemberResponse
	92,  // 195: db.v1.AccountService.TransferGuildLeader:output_type -> db.v1.SetGuildMemberResponse
	98,  // 196: db.v1.AccountService.SetGuildRelation:output_type -> db.v1.SetGuildRelationResponse
	100, // 197: db.v1.AccountService.ListGuilds:output_type -> db.v1.ListGuildsResponse
	102, // 198: db.v1.AccountService.ListGuildRelations:output_type -> db.v1.ListGuildRelationsResponse
	119, // 199: db.v1.AccountService.ListGuildMembers:output_type -> db.v1.ListGuildMembersResponse
	121, // 200: db.v1.AccountService.SaveGuildNotice:output_type -> db.v1.SaveGuildNoticeResponse
	107, // 201: db.v1.AccountService.ListGuildSummaries:output_type -> db.v1.ListGuildSummariesResponse
	110, // 202: db.v1.AccountService.ListGuildSquads:output_type -> db.v1.ListGuildSquadsResponse
	112, // 203: db.v1.AccountService.SetGuildSquad:output_type -> db.v1.SetGuildSquadResponse
	114, // 204: db.v1.AccountService.ListGuildBuffs:output_type -> db.v1.ListGuildBuffsResponse
	116, // 205: db.v1.AccountService.SaveGuildBuff:output_type -> db.v1.SaveGuildBuffResponse
	118, // 206: db.v1.AccountService.DeleteGuildBuff:output_type -> db.v1.DeleteGuildBuffResponse
	124, // 207: db.v1.AccountService.LoadGuildZones:output_type -> db.v1.LoadGuildZonesResponse
	126, // 208: db.v1.AccountService.SaveGuildZone:output_type -> db.v1.SaveGuildZoneResponse
	129, // 209: db.v1.AccountService.LoadGuildTowerState:output_type -> db.v1.LoadGuildTowerStateResponse
	131, // 210: db.v1.AccountService.SaveGuildTowerState:output_type -> db.v1.SaveGuildTowerStateResponse
	133, // 211: db.v1.AccountService.SaveGuildFame:output_type -> db.v1.SaveGuildFameResponse
	136, // 212: db.v1.AccountService.LoadCastleQuestState:output_type -> db.v1.LoadCastleQuestStateResponse
	138, // 213: db.v1.AccountService.SaveCastleQuestState:output_type -> db.v1.SaveCastleQuestStateResponse
	140, // 214: db.v1.NpcConfigService.NpcConfigVersion:output_type -> db.v1.NpcConfigVersionResponse
	142, // 215: db.v1.NpcConfigService.ListNpcDefinitions:output_type -> db.v1.ListNpcDefinitionsResponse
	156, // 216: db.v1.NpcConfigService.ListMobTemplateStats:output_type -> db.v1.ListMobTemplateStatsResponse
	160, // 217: db.v1.NpcConfigService.ListItemStats:output_type -> db.v1.ListItemStatsResponse
	163, // 218: db.v1.NpcConfigService.ListMountGrowthRates:output_type -> db.v1.ListMountGrowthRatesResponse
	168, // 219: db.v1.NpcConfigService.ListMountAbsorb:output_type -> db.v1.ListMountAbsorbResponse
	171, // 220: db.v1.NpcConfigService.ListMountBonus:output_type -> db.v1.ListMountBonusResponse
	166, // 221: db.v1.NpcConfigService.MountConfigVersion:output_type -> db.v1.MountConfigVersionResponse
	147, // 222: db.v1.WorldEventConfigService.WorldEventConfigVersion:output_type -> db.v1.WorldEventConfigVersionResponse
	149, // 223: db.v1.WorldEventConfigService.GetWorldEventConfig:output_type -> db.v1.GetWorldEventConfigResponse
	151, // 224: db.v1.WorldEventConfigService.UpdateWorldEventProgress:output_type -> db.v1.UpdateWorldEventProgressResponse
	153, // 225: db.v1.WorldEventConfigService.SetKefraState:output_type -> db.v1.SetKefraStateResponse
	174, // 226: db.v1.XPConfigService.XPConfigVersion:output_type -> db.v1.XPConfigVersionResponse
	176, // 227: db.v1.XPConfigService.GetXPConfig:output_type -> db.v1.GetXPConfigResponse
	180, // 228: db.v1.DungeonGateService.DungeonGateVersion:output_type -> db.v1.DungeonGateVersionResponse
	182, // 229: db.v1.DungeonGateService.GetDungeonGates:output_type -> db.v1.GetDungeonGatesResponse
	185, // 230: db.v1.QuestRewardService.GetQuestRewards:output_type -> db.v1.GetQuestRewardsResponse
	188, // 231: db.v1.DropBonusService.GetDropBonus:output_type -> db.v1.GetDropBonusResponse
	191, // 232: db.v1.SpawnRateService.SpawnRateVersion:output_type -> db.v1.SpawnRateVersionResponse
	193, // 233: db.v1.SpawnRateService.GetSpawnRates:output_type -> db.v1.GetSpawnRatesResponse
	196, // 234: db.v1.CombineRateService.CombineRateVersion:output_type -> db.v1.CombineRateVersionResponse
	198, // 235: db.v1.CombineRateService.GetCombineRates:output_type -> db.v1.GetCombineRatesResponse
	202, // 236: db.v1.CombatRuleService.CombatRuleVersion:output_type -> db.v1.CombatRuleVersionResponse
	204, // 237: db.v1.CombatRuleService.GetCombatRule:output_type -> db.v1.GetCombatRuleResponse
	206, // 238: db.v1.NpcGeneratorService.GeneratorOffVersion:output_type -> db.v1.GeneratorOffVersionResponse
	208, // 239: db.v1.NpcGeneratorService.GetGeneratorsOff:output_type -> db.v1.GetGeneratorsOffResponse
	211, // 240: db.v1.NpcGeneratorService.SetGeneratorOff:output_type -> db.v1.SetGeneratorOffResponse
	213, // 241: db.v1.DropRuleService.DropRuleVersion:output_type -> db.v1.DropRuleVersionResponse
	216, // 242: db.v1.DropRuleService.ListDropRules:output_type -> db.v1.ListDropRulesResponse
	153, // [153:243] is the sub-list for method output_type
	63,  // [63:153] is the sub-list for method input_type
...
func file_api_db_v1_db_proto_init() {
	...
	file_api_db_v1_db_proto_msgTypes[136].OneofWrappers = []any{}
	file_api_db_v1_db_proto_msgTypes[147].OneofWrappers = []any{}
	file_api_db_v1_db_proto_msgTypes[197].OneofWrappers = []any{}
	type x struct{}
