...
const file_api_db_v1_db_proto_rawDesc = "" +
	...
	"\agranted\x18\x01 \x01(\bR\agranted\"m\n" +
	"\x05Guild\x12\x0e\n" +
	...
	"\x17GUILD_RELATION_KIND_WAR\x10\x022\xa3\x1b\n" +
...
var file_api_db_v1_db_proto_msgTypes = make([]protoimpl.MessageInfo, 173)
var file_api_db_v1_db_proto_goTypes = []any{
	...
	(*GuildRelation)(nil),                    // 68: db.v1.GuildRelation
	(*CreateGuildRequest)(nil),               // 69: db.v1.CreateGuildRequest
	(*CreateGuildResponse)(nil),              // 70: db.v1.CreateGuildResponse
	(*SetGuildMemberRequest)(nil),            // 71: db.v1.SetGuildMemberRequest
	(*SetGuildMemberResponse)(nil),           // 72: db.v1.SetGuildMemberResponse
	(*LeaveGuildRequest)(nil),                // 73: db.v1.LeaveGuildRequest
	(*PromoteGuildMemberRequest)(nil),        // 74: db.v1.PromoteGuildMemberRequest
	(*PromoteGuildMemberResponse)(nil),       // 75: db.v1.PromoteGuildMemberResponse
	(*TransferGuildLeaderRequest)(nil),       // 76: db.v1.TransferGuildLeaderRequest
	(*SetGuildRelationRequest)(nil),          // 77: db.v1.SetGuildRelationRequest
	(*SetGuildRelationResponse)(nil),         // 78: db.v1.SetGuildRelationResponse
	(*ListGuildsRequest)(nil),                // 79: db.v1.ListGuildsRequest
	(*ListGuildsResponse)(nil),               // 80: db.v1.ListGuildsResponse
	(*ListGuildRelationsRequest)(nil),        // 81: db.v1.ListGuildRelationsRequest
	(*ListGuildRelationsResponse)(nil),       // 82: db.v1.ListGuildRelationsResponse
	(*GuildZone)(nil),                        // 83: db.v1.GuildZone
	(*LoadGuildZonesRequest)(nil),            // 84: db.v1.LoadGuildZonesRequest
	(*LoadGuildZonesResponse)(nil),           // 85: db.v1.LoadGuildZonesResponse
	(*SaveGuildZoneRequest)(nil),             // 86: db.v1.SaveGuildZoneRequest
	(*SaveGuildZoneResponse)(nil),            // 87: db.v1.SaveGuildZoneResponse
	(*GuildTowerState)(nil),                  // 88: db.v1.GuildTowerState
	(*LoadGuildTowerStateRequest)(nil),       // 89: db.v1.LoadGuildTowerStateRequest
	(*LoadGuildTowerStateResponse)(nil),      // 90: db.v1.LoadGuildTowerStateResponse
	(*SaveGuildTowerStateRequest)(nil),       // 91: db.v1.SaveGuildTowerStateRequest
	(*SaveGuildTowerStateResponse)(nil),      // 92: db.v1.SaveGuildTowerStateResponse
	(*SaveGuildFameRequest)(nil),             // 93: db.v1.SaveGuildFameRequest
	(*SaveGuildFameResponse)(nil),            // 94: db.v1.SaveGuildFameResponse
	(*CastleQuestState)(nil),                 // 95: db.v1.CastleQuestState
	(*LoadCastleQuestStateRequest)(nil),      // 96: db.v1.LoadCastleQuestStateRequest
	(*LoadCastleQuestStateResponse)(nil),     // 97: db.v1.LoadCastleQuestStateResponse
	(*SaveCastleQuestStateRequest)(nil),      // 98: db.v1.SaveCastleQuestStateRequest
	(*SaveCastleQuestStateResponse)(nil),     // 99: db.v1.SaveCastleQuestStateResponse
	(*NpcConfigVersionRequest)(nil),          // 100: db.v1.NpcConfigVersionRequest
	(*NpcConfigVersionResponse)(nil),         // 101: db.v1.NpcConfigVersionResponse
	(*ListNpcDefinitionsRequest)(nil),        // 102: db.v1.ListNpcDefinitionsRequest
	(*ListNpcDefinitionsResponse)(nil),       // 103: db.v1.ListNpcDefinitionsResponse
	(*NpcShopItem)(nil),                      // 104: db.v1.NpcShopItem
	(*NpcDefinition)(nil),                    // 105: db.v1.NpcDefinition
	(*ItemPrice)(nil),                        // 106: db.v1.ItemPrice
	(*WorldEventConfigVersionRequest)(nil),   // 107: db.v1.WorldEventConfigVersionRequest
	(*WorldEventConfigVersionResponse)(nil),  // 108: db.v1.WorldEventConfigVersionResponse
	(*GetWorldEventConfigRequest)(nil),       // 109: db.v1.GetWorldEventConfigRequest
	(*GetWorldEventConfigResponse)(nil),      // 110: db.v1.GetWorldEventConfigResponse
	(*UpdateWorldEventProgressRequest)(nil),  // 111: db.v1.UpdateWorldEventProgressRequest
	(*UpdateWorldEventProgressResponse)(nil), // 112: db.v1.UpdateWorldEventProgressResponse
	(*SetKefraStateRequest)(nil),             // 113: db.v1.SetKefraStateRequest
	(*SetKefraStateResponse)(nil),            // 114: db.v1.SetKefraStateResponse
	(*WorldEventConfig)(nil),                 // 115: db.v1.WorldEventConfig
	(*ListMobTemplateStatsRequest)(nil),      // 116: db.v1.ListMobTemplateStatsRequest
	(*ListMobTemplateStatsResponse)(nil),     // 117: db.v1.ListMobTemplateStatsResponse
	(*MobTemplateEquipItem)(nil),             // 118: db.v1.MobTemplateEquipItem
	(*MobTemplateStat)(nil),                  // 119: db.v1.MobTemplateStat
	(*ListItemStatsRequest)(nil),             // 120: db.v1.ListItemStatsRequest
	(*ListItemStatsResponse)(nil),            // 121: db.v1.ListItemStatsResponse
	(*ItemStat)(nil),                         // 122: db.v1.ItemStat
	(*ListMountGrowthRatesRequest)(nil),      // 123: db.v1.ListMountGrowthRatesRequest
	(*ListMountGrowthRatesResponse)(nil),     // 124: db.v1.ListMountGrowthRatesResponse
	(*MountGrowthRate)(nil),                  // 125: db.v1.MountGrowthRate
	(*MountConfigVersionRequest)(nil),        // 126: db.v1.MountConfigVersionRequest
	(*MountConfigVersionResponse)(nil),       // 127: db.v1.MountConfigVersionResponse
	(*ListMountAbsorbRequest)(nil),           // 128: db.v1.ListMountAbsorbRequest
	(*ListMountAbsorbResponse)(nil),          // 129: db.v1.ListMountAbsorbResponse
	(*MountAbsorb)(nil),                      // 130: db.v1.MountAbsorb
	(*ListMountBonusRequest)(nil),            // 131: db.v1.ListMountBonusRequest
	(*ListMountBonusResponse)(nil),           // 132: db.v1.ListMountBonusResponse
	(*MountBonus)(nil),                       // 133: db.v1.MountBonus
	(*XPConfigVersionRequest)(nil),           // 134: db.v1.XPConfigVersionRequest
	(*XPConfigVersionResponse)(nil),          // 135: db.v1.XPConfigVersionResponse
	(*GetXPConfigRequest)(nil),               // 136: db.v1.GetXPConfigRequest
	(*GetXPConfigResponse)(nil),              // 137: db.v1.GetXPConfigResponse
	(*XPCut)(nil),                            // 138: db.v1.XPCut
	(*XPRule)(nil),                           // 139: db.v1.XPRule
	(*DungeonGateVersionRequest)(nil),        // 140: db.v1.DungeonGateVersionRequest
	(*DungeonGateVersionResponse)(nil),       // 141: db.v1.DungeonGateVersionResponse
	(*GetDungeonGatesRequest)(nil),           // 142: db.v1.GetDungeonGatesRequest
	(*GetDungeonGatesResponse)(nil),          // 143: db.v1.GetDungeonGatesResponse
	(*DungeonGate)(nil),                      // 144: db.v1.DungeonGate
	(*GetQuestRewardsRequest)(nil),           // 145: db.v1.GetQuestRewardsRequest
	(*GetQuestRewardsResponse)(nil),          // 146: db.v1.GetQuestRewardsResponse
	(*QuestReward)(nil),                      // 147: db.v1.QuestReward
	(*GetDropBonusRequest)(nil),              // 148: db.v1.GetDropBonusRequest
	(*GetDropBonusResponse)(nil),             // 149: db.v1.GetDropBonusResponse
	(*DropBonusBand)(nil),                    // 150: db.v1.DropBonusBand
	(*SpawnRateVersionRequest)(nil),          // 151: db.v1.SpawnRateVersionRequest
	(*SpawnRateVersionResponse)(nil),         // 152: db.v1.SpawnRateVersionResponse
	(*GetSpawnRatesRequest)(nil),             // 153: db.v1.GetSpawnRatesRequest
	(*GetSpawnRatesResponse)(nil),            // 154: db.v1.GetSpawnRatesResponse
	(*SpawnRate)(nil),                        // 155: db.v1.SpawnRate
	(*CombineRateVersionRequest)(nil),        // 156: db.v1.CombineRateVersionRequest
	(*CombineRateVersionResponse)(nil),       // 157: db.v1.CombineRateVersionResponse
	(*GetCombineRatesRequest)(nil),           // 158: db.v1.GetCombineRatesRequest
	(*GetCombineRatesResponse)(nil),          // 159: db.v1.GetCombineRatesResponse
	(*CombineRate)(nil),                      // 160: db.v1.CombineRate
	(*CombineBand)(nil),                      // 161: db.v1.CombineBand
	(*CombatRuleVersionRequest)(nil),         // 162: db.v1.CombatRuleVersionRequest
	(*CombatRuleVersionResponse)(nil),        // 163: db.v1.CombatRuleVersionResponse
	(*GetCombatRuleRequest)(nil),             // 164: db.v1.GetCombatRuleRequest
	(*GetCombatRuleResponse)(nil),            // 165: db.v1.GetCombatRuleResponse
	(*GeneratorOffVersionRequest)(nil),       // 166: db.v1.GeneratorOffVersionRequest
	(*GeneratorOffVersionResponse)(nil),      // 167: db.v1.GeneratorOffVersionResponse
	(*GetGeneratorsOffRequest)(nil),          // 168: db.v1.GetGeneratorsOffRequest
	(*GetGeneratorsOffResponse)(nil),         // 169: db.v1.GetGeneratorsOffResponse
	(*GeneratorOff)(nil),                     // 170: db.v1.GeneratorOff
	(*SetGeneratorOffRequest)(nil),           // 171: db.v1.SetGeneratorOffRequest
	(*SetGeneratorOffResponse)(nil),          // 172: db.v1.SetGeneratorOffResponse
	(*DropRuleVersionRequest)(nil),           // 173: db.v1.DropRuleVersionRequest
	(*DropRuleVersionResponse)(nil),          // 174: db.v1.DropRuleVersionResponse
	(*ListDropRulesRequest)(nil),             // 175: db.v1.ListDropRulesRequest
	(*DropRule)(nil),                         // 176: db.v1.DropRule
	(*ListDropRulesResponse)(nil),            // 177: db.v1.ListDropRulesResponse
}
var file_api_db_v1_db_proto_depIdxs = []int32{
	...
	68,  // 25: db.v1.ListGuildRelationsResponse.relations:type_name -> db.v1.GuildRelation
	83,  // 26: db.v1.LoadGuildZonesResponse.zones:type_name -> db.v1.GuildZone
	83,  // 27: db.v1.SaveGuildZoneRequest.zone:type_name -> db.v1.GuildZone
	88,  // 28: db.v1.LoadGuildTowerStateResponse.state:type_name -> db.v1.GuildTowerState
	88,  // 29: db.v1.SaveGuildTowerStateRequest.state:type_name -> db.v1.GuildTowerState
	95,  // 30: db.v1.LoadCastleQuestStateResponse.state:type_name -> db.v1.CastleQuestState
	95,  // 31: db.v1.SaveCastleQuestStateRequest.state:type_name -> db.v1.CastleQuestState
	105, // 32: db.v1.ListNpcDefinitionsResponse.definitions:type_name -> db.v1.NpcDefinition
	106, // 33: db.v1.ListNpcDefinitionsResponse.price_overrides:type_name -> db.v1.ItemPrice
	104, // 34: db.v1.NpcDefinition.shop:type_name -> db.v1.NpcShopItem
	115, // 35: db.v1.GetWorldEventConfigResponse.config:type_name -> db.v1.WorldEventConfig
	119, // 36: db.v1.ListMobTemplateStatsResponse.overrides:type_name -> db.v1.MobTemplateStat
	118, // 37: db.v1.MobTemplateStat.equip:type_name -> db.v1.MobTemplateEquipItem
	122, // 38: db.v1.ListItemStatsResponse.overrides:type_name -> db.v1.ItemStat
	125, // 39: db.v1.ListMountGrowthRatesResponse.rates:type_name -> db.v1.MountGrowthRate
	130, // 40: db.v1.ListMountAbsorbResponse.absorb:type_name -> db.v1.MountAbsorb
	133, // 41: db.v1.ListMountBonusResponse.bonus:type_name -> db.v1.MountBonus
	139, // 42: db.v1.GetXPConfigResponse.rules:type_name -> db.v1.XPRule
	138, // 43: db.v1.XPRule.cuts:type_name -> db.v1.XPCut
	144, // 44: db.v1.GetDungeonGatesResponse.gates:type_name -> db.v1.DungeonGate
	147, // 45: db.v1.GetQuestRewardsResponse.tiers:type_name -> db.v1.QuestReward
	150, // 46: db.v1.GetDropBonusResponse.faixas:type_name -> db.v1.DropBonusBand
	155, // 47: db.v1.GetSpawnRatesResponse.areas:type_name -> db.v1.SpawnRate
	160, // 48: db.v1.GetCombineRatesResponse.rates:type_name -> db.v1.CombineRate
	161, // 49: db.v1.GetCombineRatesResponse.bands:type_name -> db.v1.CombineBand
	170, // 50: db.v1.GetGeneratorsOffResponse.off:type_name -> db.v1.GeneratorOff
	176, // 51: db.v1.ListDropRulesResponse.rules:type_name -> db.v1.DropRule
	5,   // 52: db.v1.AccountService.AccountLogin:input_type -> db.v1.AccountLoginRequest
	7,   // 53: db.v1.AccountService.ListCharacters:input_type -> db.v1.ListCharactersRequest
	10,  // 54: db.v1.AccountService.LoadCharacter:input_type -> db.v1.LoadCharacterRequest
	15,  // 55: db.v1.AccountService.SaveCharacter:input_type -> db.v1.SaveCharacterRequest
	17,  // 56: db.v1.AccountService.QuoteKingdomCape:input_type -> db.v1.QuoteKingdomCapeRequest
	19,  // 57: db.v1.AccountService.PurchaseKingdomCape:input_type -> db.v1.PurchaseKingdomCapeRequest
	21,  // 58: db.v1.AccountService.TransferPlayerBalance:input_type -> db.v1.TransferPlayerBalanceRequest
	23,  // 59: db.v1.AccountService.CreateCharacter:input_type -> db.v1.CreateCharacterRequest
	25,  // 60: db.v1.AccountService.CreateArchCharacter:input_type -> db.v1.CreateArchCharacterRequest
	27,  // 61: db.v1.AccountService.DeleteCharacter:input_type -> db.v1.DeleteCharacterRequest
	29,  // 62: db.v1.AccountService.SetPin:input_type -> db.v1.SetPinRequest
	31,  // 63: db.v1.AccountService.VerifyPin:input_type -> db.v1.VerifyPinRequest
	33,  // 64: db.v1.AccountService.LoadCargo:input_type -> db.v1.LoadCargoRequest
	35,  // 65: db.v1.AccountService.SaveCargo:input_type -> db.v1.SaveCargoRequest
	38,  // 66: db.v1.AccountService.ListPendingDeliveries:input_type -> db.v1.ListPendingDeliveriesRequest
	40,  // 67: db.v1.AccountService.SaveCargoWithDeliveries:input_type -> db.v1.SaveCargoWithDeliveriesRequest
	41,  // 68: db.v1.AccountService.SetAccountBlocked:input_type -> db.v1.SetAccountBlockedRequest
	43,  // 69: db.v1.AccountService.RecordDuelResult:input_type -> db.v1.RecordDuelResultRequest
	46,  // 70: db.v1.AccountService.RecordTrade:input_type -> db.v1.RecordTradeRequest
	55,  // 71: db.v1.AccountService.RecordReport:input_type -> db.v1.RecordReportRequest
	53,  // 72: db.v1.AccountService.RecordGround:input_type -> db.v1.RecordGroundRequest
	48,  // 73: db.v1.AccountService.ReserveSerials:input_type -> db.v1.ReserveSerialsRequest
	51,  // 74: db.v1.AccountService.RecordChat:input_type -> db.v1.RecordChatRequest
	57,  // 75: db.v1.AccountService.SetCharacterPresence:input_type -> db.v1.SetCharacterPresenceRequest
	59,  // 76: db.v1.AccountService.ClearAllPresence:input_type -> db.v1.ClearAllPresenceRequest
	61,  // 77: db.v1.AccountService.AddShopPoints:input_type -> db.v1.AddShopPointsRequest
	63,  // 78: db.v1.AccountService.ShopPoints:input_type -> db.v1.ShopPointsRequest
	65,  // 79: db.v1.AccountService.ClaimNewbieKit:input_type -> db.v1.ClaimNewbieKitRequest
	69,  // 80: db.v1.AccountService.CreateGuild:input_type -> db.v1.CreateGuildRequest
	71,  // 81: db.v1.AccountService.SetGuildMember:input_type -> db.v1.SetGuildMemberRequest
	73,  // 82: db.v1.AccountService.LeaveGuild:input_type -> db.v1.LeaveGuildRequest
	74,  // 83: db.v1.AccountService.PromoteGuildMember:input_type -> db.v1.PromoteGuildMemberRequest
	76,  // 84: db.v1.AccountService.TransferGuildLeader:input_type -> db.v1.TransferGuildLeaderRequest
	77,  // 85: db.v1.AccountService.SetGuildRelation:input_type -> db.v1.SetGuildRelationRequest
	79,  // 86: db.v1.AccountService.ListGuilds:input_type -> db.v1.ListGuildsRequest
	81,  // 87: db.v1.AccountService.ListGuildRelations:input_type -> db.v1.ListGuildRelationsRequest
	84,  // 88: db.v1.AccountService.LoadGuildZones:input_type -> db.v1.LoadGuildZonesRequest
	86,  // 89: db.v1.AccountService.SaveGuildZone:input_type -> db.v1.SaveGuildZoneRequest
	89,  // 90: db.v1.AccountService.LoadGuildTowerState:input_type -> db.v1.LoadGuildTowerStateRequest
	91,  // 91: db.v1.AccountService.SaveGuildTowerState:input_type -> db.v1.SaveGuildTowerStateRequest
	93,  // 92: db.v1.AccountService.SaveGuildFame:input_type -> db.v1.SaveGuildFameRequest
	96,  // 93: db.v1.AccountService.LoadCastleQuestState:input_type -> db.v1.LoadCastleQuestStateRequest
	98,  // 94: db.v1.AccountService.SaveCastleQuestState:input_type -> db.v1.SaveCastleQuestStateRequest
	100, // 95: db.v1.NpcConfigService.NpcConfigVersion:input_type -> db.v1.NpcConfigVersionRequest
	102, // 96: db.v1.NpcConfigService.ListNpcDefinitions:input_type -> db.v1.ListNpcDefinitionsRequest
	116, // 97: db.v1.NpcConfigService.ListMobTemplateStats:input_type -> db.v1.ListMobTemplateStatsRequest
	120, // 98: db.v1.NpcConfigService.ListItemStats:input_type -> db.v1.ListItemStatsRequest
	123, // 99: db.v1.NpcConfigService.ListMountGrowthRates:input_type -> db.v1.ListMountGrowthRatesRequest
	128, // 100: db.v1.NpcConfigService.ListMountAbsorb:input_type -> db.v1.ListMountAbsorbRequest
	131, // 101: db.v1.NpcConfigService.ListMountBonus:input_type -> db.v1.ListMountBonusRequest
	126, // 102: db.v1.NpcConfigService.MountConfigVersion:input_type -> db.v1.MountConfigVersionRequest
	107, // 103: db.v1.WorldEventConfigService.WorldEventConfigVersion:input_type -> db.v1.WorldEventConfigVersionRequest
	109, // 104: db.v1.WorldEventConfigService.GetWorldEventConfig:input_type -> db.v1.GetWorldEventConfigRequest
	111, // 105: db.v1.WorldEventConfigService.UpdateWorldEventProgress:input_type -> db.v1.UpdateWorldEventProgressRequest
	113, // 106: db.v1.WorldEventConfigService.SetKefraState:input_type -> db.v1.SetKefraStateRequest
	134, // 107: db.v1.XPConfigService.XPConfigVersion:input_type -> db.v1.XPConfigVersionRequest
	136, // 108: db.v1.XPConfigService.GetXPConfig:input_type -> db.v1.GetXPConfigRequest
	140, // 109: db.v1.DungeonGateService.DungeonGateVersion:input_type -> db.v1.DungeonGateVersionRequest
	142, // 110: db.v1.DungeonGateService.GetDungeonGates:input_type -> db.v1.GetDungeonGatesRequest
	145, // 111: db.v1.QuestRewardService.GetQuestRewards:input_type -> db.v1.GetQuestRewardsRequest
	148, // 112: db.v1.DropBonusService.GetDropBonus:input_type -> db.v1.GetDropBonusRequest
	151, // 113: db.v1.SpawnRateService.SpawnRateVersion:input_type -> db.v1.SpawnRateVersionRequest
	153, // 114: db.v1.SpawnRateService.GetSpawnRates:input_type -> db.v1.GetSpawnRatesRequest
	156, // 115: db.v1.CombineRateService.CombineRateVersion:input_type -> db.v1.CombineRateVersionRequest
	158, // 116: db.v1.CombineRateService.GetCombineRates:input_type -> db.v1.GetCombineRatesRequest
	162, // 117: db.v1.CombatRuleService.CombatRuleVersion:input_type -> db.v1.CombatRuleVersionRequest
	164, // 118: db.v1.CombatRuleService.GetCombatRule:input_type -> db.v1.GetCombatRuleRequest
	166, // 119: db.v1.NpcGeneratorService.GeneratorOffVersion:input_type -> db.v1.GeneratorOffVersionRequest
	168, // 120: db.v1.NpcGeneratorService.GetGeneratorsOff:input_type -> db.v1.GetGeneratorsOffRequest
	171, // 121: db.v1.NpcGeneratorService.SetGeneratorOff:input_type -> db.v1.SetGeneratorOffRequest
	173, // 122: db.v1.DropRuleService.DropRuleVersion:input_type -> db.v1.DropRuleVersionRequest
	175, // 123: db.v1.DropRuleService.ListDropRules:input_type -> db.v1.ListDropRulesRequest
	6,   // 124: db.v1.AccountService.AccountLogin:output_type -> db.v1.AccountLoginResponse
	9,   // 125: db.v1.AccountService.ListCharacters:output_type -> db.v1.ListCharactersResponse
	14,  // 126: db.v1.AccountService.LoadCharacter:output_type -> db.v1.LoadCharacterResponse
	16,  // 127: db.v1.AccountService.SaveCharacter:output_type -> db.v1.SaveCharacterResponse
	18,  // 128: db.v1.AccountService.QuoteKingdomCape:output_type -> db.v1.QuoteKingdomCapeResponse
	20,  // 129: db.v1.AccountService.PurchaseKingdomCape:output_type -> db.v1.PurchaseKingdomCapeResponse
	22,  // 130: db.v1.AccountService.TransferPlayerBalance:output_type -> db.v1.TransferPlayerBalanceResponse
	24,  // 131: db.v1.AccountService.CreateCharacter:output_type -> db.v1.CreateCharacterResponse
	26,  // 132: db.v1.AccountService.CreateArchCharacter:output_type -> db.v1.CreateArchCharacterResponse
	28,  // 133: db.v1.AccountService.DeleteCharacter:output_type -> db.v1.DeleteCharacterResponse
	30,  // 134: db.v1.AccountService.SetPin:output_type -> db.v1.SetPinResponse
	32,  // 135: db.v1.AccountService.VerifyPin:output_type -> db.v1.VerifyPinResponse
	34,  // 136: db.v1.AccountService.LoadCargo:output_type -> db.v1.LoadCargoResponse
	36,  // 137: db.v1.AccountService.SaveCargo:output_type -> db.v1.SaveCargoResponse
	39,  // 138: db.v1.AccountService.ListPendingDeliveries:output_type -> db.v1.ListPendingDeliveriesResponse
	36,  // 139: db.v1.AccountService.SaveCargoWithDeliveries:output_type -> db.v1.SaveCargoResponse
	42,  // 140: db.v1.AccountService.SetAccountBlocked:output_type -> db.v1.SetAccountBlockedResponse
	44,  // 141: db.v1.AccountService.RecordDuelResult:output_type -> db.v1.RecordDuelResultResponse
	47,  // 142: db.v1.AccountService.RecordTrade:output_type -> db.v1.RecordTradeResponse
	56,  // 143: db.v1.AccountService.RecordReport:output_type -> db.v1.RecordReportResponse
	54,  // 144: db.v1.AccountService.RecordGround:output_type -> db.v1.RecordGroundResponse
	49,  // 145: db.v1.AccountService.ReserveSerials:output_type -> db.v1.ReserveSerialsResponse
	52,  // 146: db.v1.AccountService.RecordChat:output_type -> db.v1.RecordChatResponse
	58,  // 147: db.v1.AccountService.SetCharacterPresence:output_type -> db.v1.SetCharacterPresenceResponse
	60,  // 148: db.v1.AccountService.ClearAllPresence:output_type -> db.v1.ClearAllPresenceResponse
	62,  // 149: db.v1.AccountService.AddShopPoints:output_type -> db.v1.AddShopPointsResponse
	64,  // 150: db.v1.AccountService.ShopPoints:output_type -> db.v1.ShopPointsResponse
	66,  // 151: db.v1.AccountService.ClaimNewbieKit:output_type -> db.v1.ClaimNewbieKitResponse
	70,  // 152: db.v1.AccountService.CreateGuild:output_type -> db.v1.CreateGuildResponse
	72,  // 153: db.v1.AccountService.SetGuildMember:output_type -> db.v1.SetGuildMemberResponse
	72,  // 154: db.v1.AccountService.LeaveGuild:output_type -> db.v1.SetGuildMemberResponse
	75,  // 155: db.v1.AccountService.PromoteGuildMember:output_type -> db.v1.PromoteGuildMemberResponse
	72,  // 156: db.v1.AccountService.TransferGuildLeader:output_type -> db.v1.SetGuildMemberResponse
	78,  // 157: db.v1.AccountService.SetGuildRelation:output_type -> db.v1.SetGuildRelationResponse
	80,  // 158: db.v1.AccountService.ListGuilds:output_type -> db.v1.ListGuildsResponse
	82,  // 159: db.v1.AccountService.ListGuildRelations:output_type -> db.v1.ListGuildRelationsResponse
	85,  // 160: db.v1.AccountService.LoadGuildZones:output_type -> db.v1.LoadGuildZonesResponse
	87,  // 161: db.v1.AccountService.SaveGuildZone:output_type -> db.v1.SaveGuildZoneResponse
	90,  // 162: db.v1.AccountService.LoadGuildTowerState:output_type -> db.v1.LoadGuildTowerStateResponse
	92,  // 163: db.v1.AccountService.SaveGuildTowerState:output_type -> db.v1.SaveGuildTowerStateResponse
	94,  // 164: db.v1.AccountService.SaveGuildFame:output_type -> db.v1.SaveGuildFameResponse
	97,  // 165: db.v1.AccountService.LoadCastleQuestState:output_type -> db.v1.LoadCastleQuestStateResponse
	99,  // 166: db.v1.AccountService.SaveCastleQuestState:output_type -> db.v1.SaveCastleQuestStateResponse
	101, // 167: db.v1.NpcConfigService.NpcConfigVersion:output_type -> db.v1.NpcConfigVersionResponse
	103, // 168: db.v1.NpcConfigService.ListNpcDefinitions:output_type -> db.v1.ListNpcDefinitionsResponse
	117, // 169: db.v1.NpcConfigService.ListMobTemplateStats:output_type -> db.v1.ListMobTemplateStatsResponse
	121, // 170: db.v1.NpcConfigService.ListItemStats:output_type -> db.v1.ListItemStatsResponse
	124, // 171: db.v1.NpcConfigService.ListMountGrowthRates:output_type -> db.v1.ListMountGrowthRatesResponse
	129, // 172: db.v1.NpcConfigService.ListMountAbsorb:output_type -> db.v1.ListMountAbsorbResponse
	132, // 173: db.v1.NpcConfigService.ListMountBonus:output_type -> db.v1.ListMountBonusResponse
	127, // 174: db.v1.NpcConfigService.MountConfigVersion:output_type -> db.v1.MountConfigVersionResponse
	108, // 175: db.v1.WorldEventConfigService.WorldEventConfigVersion:output_type -> db.v1.WorldEventConfigVersionResponse
	110, // 176: db.v1.WorldEventConfigService.GetWorldEventConfig:output_type -> db.v1.GetWorldEventConfigResponse
	112, // 177: db.v1.WorldEventConfigService.UpdateWorldEventProgress:output_type -> db.v1.UpdateWorldEventProgressResponse
	114, // 178: db.v1.WorldEventConfigService.SetKefraState:output_type -> db.v1.SetKefraStateResponse
	135, // 179: db.v1.XPConfigService.XPConfigVersion:output_type -> db.v1.XPConfigVersionResponse
	137, // 180: db.v1.XPConfigService.GetXPConfig:output_type -> db.v1.GetXPConfigResponse
	141, // 181: db.v1.DungeonGateService.DungeonGateVersion:output_type -> db.v1.DungeonGateVersionResponse
	143, // 182: db.v1.DungeonGateService.GetDungeonGates:output_type -> db.v1.GetDungeonGatesResponse
	146, // 183: db.v1.QuestRewardService.GetQuestRewards:output_type -> db.v1.GetQuestRewardsResponse
	149, // 184: db.v1.DropBonusService.GetDropBonus:output_type -> db.v1.GetDropBonusResponse
	152, // 185: db.v1.SpawnRateService.SpawnRateVersion:output_type -> db.v1.SpawnRateVersionResponse
	154, // 186: db.v1.SpawnRateService.GetSpawnRates:output_type -> db.v1.GetSpawnRatesResponse
	157, // 187: db.v1.CombineRateService.CombineRateVersion:output_type -> db.v1.CombineRateVersionResponse
	159, // 188: db.v1.CombineRateService.GetCombineRates:output_type -> db.v1.GetCombineRatesResponse
	163, // 189: db.v1.CombatRuleService.CombatRuleVersion:output_type -> db.v1.CombatRuleVersionResponse
	165, // 190: db.v1.CombatRuleService.GetCombatRule:output_type -> db.v1.GetCombatRuleResponse
	167, // 191: db.v1.NpcGeneratorService.GeneratorOffVersion:output_type -> db.v1.GeneratorOffVersionResponse
	169, // 192: db.v1.NpcGeneratorService.GetGeneratorsOff:output_type -> db.v1.GetGeneratorsOffResponse
	172, // 193: db.v1.NpcGeneratorService.SetGeneratorOff:output_type -> db.v1.SetGeneratorOffResponse
	174, // 194: db.v1.DropRuleService.DropRuleVersion:output_type -> db.v1.DropRuleVersionResponse
	177, // 195: db.v1.DropRuleService.ListDropRules:output_type -> db.v1.ListDropRulesResponse
...
func file_api_db_v1_db_proto_init() {
	...
	file_api_db_v1_db_proto_msgTypes[110].OneofWrappers = []any{}
	file_api_db_v1_db_proto_msgTypes[160].OneofWrappers = []any{}
	type x struct{}
