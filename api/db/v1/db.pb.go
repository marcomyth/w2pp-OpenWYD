...
const file_api_db_v1_db_proto_rawDesc = "" +
	...
	"\x17GUILD_RELATION_KIND_WAR\x10\x022\xf1\x15\n" +
	...
	"\vRecordTrade\x12\x19.db.v1.RecordTradeRequest\x1a\x1a.db.v1.RecordTradeResponse\x12_\n" +
...
var file_api_db_v1_db_proto_msgTypes = make([]protoimpl.MessageInfo, 97)
var file_api_db_v1_db_proto_goTypes = []any{
	...
	(*SetCharacterPresenceRequest)(nil),      // 44: db.v1.SetCharacterPresenceRequest
	(*SetCharacterPresenceResponse)(nil),     // 45: db.v1.SetCharacterPresenceResponse
	(*ClearAllPresenceRequest)(nil),          // 46: db.v1.ClearAllPresenceRequest
	(*ClearAllPresenceResponse)(nil),         // 47: db.v1.ClearAllPresenceResponse
	(*Guild)(nil),                            // 48: db.v1.Guild
	(*GuildRelation)(nil),                    // 49: db.v1.GuildRelation
	(*CreateGuildRequest)(nil),               // 50: db.v1.CreateGuildRequest
	(*CreateGuildResponse)(nil),              // 51: db.v1.CreateGuildResponse
	(*SetGuildMemberRequest)(nil),            // 52: db.v1.SetGuildMemberRequest
	(*SetGuildMemberResponse)(nil),           // 53: db.v1.SetGuildMemberResponse
	(*LeaveGuildRequest)(nil),                // 54: db.v1.LeaveGuildRequest
	(*PromoteGuildMemberRequest)(nil),        // 55: db.v1.PromoteGuildMemberRequest
	(*PromoteGuildMemberResponse)(nil),       // 56: db.v1.PromoteGuildMemberResponse
	(*TransferGuildLeaderRequest)(nil),       // 57: db.v1.TransferGuildLeaderRequest
	(*SetGuildRelationRequest)(nil),          // 58: db.v1.SetGuildRelationRequest
	(*SetGuildRelationResponse)(nil),         // 59: db.v1.SetGuildRelationResponse
	(*ListGuildsRequest)(nil),                // 60: db.v1.ListGuildsRequest
	(*ListGuildsResponse)(nil),               // 61: db.v1.ListGuildsResponse
	(*ListGuildRelationsRequest)(nil),        // 62: db.v1.ListGuildRelationsRequest
	(*ListGuildRelationsResponse)(nil),       // 63: db.v1.ListGuildRelationsResponse
	(*GuildZone)(nil),                        // 64: db.v1.GuildZone
	(*LoadGuildZonesRequest)(nil),            // 65: db.v1.LoadGuildZonesRequest
	(*LoadGuildZonesResponse)(nil),           // 66: db.v1.LoadGuildZonesResponse
	(*SaveGuildZoneRequest)(nil),             // 67: db.v1.SaveGuildZoneRequest
	(*SaveGuildZoneResponse)(nil),            // 68: db.v1.SaveGuildZoneResponse
	(*GuildTowerState)(nil),                  // 69: db.v1.GuildTowerState
	(*LoadGuildTowerStateRequest)(nil),       // 70: db.v1.LoadGuildTowerStateRequest
	(*LoadGuildTowerStateResponse)(nil),      // 71: db.v1.LoadGuildTowerStateResponse
	(*SaveGuildTowerStateRequest)(nil),       // 72: db.v1.SaveGuildTowerStateRequest
	(*SaveGuildTowerStateResponse)(nil),      // 73: db.v1.SaveGuildTowerStateResponse
	(*CastleQuestState)(nil),                 // 74: db.v1.CastleQuestState
	(*LoadCastleQuestStateRequest)(nil),      // 75: db.v1.LoadCastleQuestStateRequest
	(*LoadCastleQuestStateResponse)(nil),     // 76: db.v1.LoadCastleQuestStateResponse
	(*SaveCastleQuestStateRequest)(nil),      // 77: db.v1.SaveCastleQuestStateRequest
	(*SaveCastleQuestStateResponse)(nil),     // 78: db.v1.SaveCastleQuestStateResponse
	(*NpcConfigVersionRequest)(nil),          // 79: db.v1.NpcConfigVersionRequest
	(*NpcConfigVersionResponse)(nil),         // 80: db.v1.NpcConfigVersionResponse
	(*ListNpcDefinitionsRequest)(nil),        // 81: db.v1.ListNpcDefinitionsRequest
	(*ListNpcDefinitionsResponse)(nil),       // 82: db.v1.ListNpcDefinitionsResponse
	(*NpcShopItem)(nil),                      // 83: db.v1.NpcShopItem
	(*NpcDefinition)(nil),                    // 84: db.v1.NpcDefinition
	(*ItemPrice)(nil),                        // 85: db.v1.ItemPrice
	(*WorldEventConfigVersionRequest)(nil),   // 86: db.v1.WorldEventConfigVersionRequest
	(*WorldEventConfigVersionResponse)(nil),  // 87: db.v1.WorldEventConfigVersionResponse
	(*GetWorldEventConfigRequest)(nil),       // 88: db.v1.GetWorldEventConfigRequest
	(*GetWorldEventConfigResponse)(nil),      // 89: db.v1.GetWorldEventConfigResponse
	(*UpdateWorldEventProgressRequest)(nil),  // 90: db.v1.UpdateWorldEventProgressRequest
	(*UpdateWorldEventProgressResponse)(nil), // 91: db.v1.UpdateWorldEventProgressResponse
	(*WorldEventConfig)(nil),                 // 92: db.v1.WorldEventConfig
	(*ListMobTemplateStatsRequest)(nil),      // 93: db.v1.ListMobTemplateStatsRequest
	(*ListMobTemplateStatsResponse)(nil),     // 94: db.v1.ListMobTemplateStatsResponse
	(*MobTemplateEquipItem)(nil),             // 95: db.v1.MobTemplateEquipItem
	(*MobTemplateStat)(nil),                  // 96: db.v1.MobTemplateStat
	(*ListItemStatsRequest)(nil),             // 97: db.v1.ListItemStatsRequest
	(*ListItemStatsResponse)(nil),            // 98: db.v1.ListItemStatsResponse
	(*ItemStat)(nil),                         // 99: db.v1.ItemStat
}
var file_api_db_v1_db_proto_depIdxs = []int32{
	...
	48, // 19: db.v1.CreateGuildResponse.guild:type_name -> db.v1.Guild
	2,  // 20: db.v1.SetGuildRelationRequest.kind:type_name -> db.v1.GuildRelationKind
	48, // 21: db.v1.ListGuildsResponse.guilds:type_name -> db.v1.Guild
	49, // 22: db.v1.ListGuildRelationsResponse.relations:type_name -> db.v1.GuildRelation
	64, // 23: db.v1.LoadGuildZonesResponse.zones:type_name -> db.v1.GuildZone
	64, // 24: db.v1.SaveGuildZoneRequest.zone:type_name -> db.v1.GuildZone
	69, // 25: db.v1.LoadGuildTowerStateResponse.state:type_name -> db.v1.GuildTowerState
	69, // 26: db.v1.SaveGuildTowerStateRequest.state:type_name -> db.v1.GuildTowerState
	74, // 27: db.v1.LoadCastleQuestStateResponse.state:type_name -> db.v1.CastleQuestState
	74, // 28: db.v1.SaveCastleQuestStateRequest.state:type_name -> db.v1.CastleQuestState
	84, // 29: db.v1.ListNpcDefinitionsResponse.definitions:type_name -> db.v1.NpcDefinition
	85, // 30: db.v1.ListNpcDefinitionsResponse.price_overrides:type_name -> db.v1.ItemPrice
	83, // 31: db.v1.NpcDefinition.shop:type_name -> db.v1.NpcShopItem
	92, // 32: db.v1.GetWorldEventConfigResponse.config:type_name -> db.v1.WorldEventConfig
	96, // 33: db.v1.ListMobTemplateStatsResponse.overrides:type_name -> db.v1.MobTemplateStat
	95, // 34: db.v1.MobTemplateStat.equip:type_name -> db.v1.MobTemplateEquipItem
	99, // 35: db.v1.ListItemStatsResponse.overrides:type_name -> db.v1.ItemStat
	...
	44, // 54: db.v1.AccountService.SetCharacterPresence:input_type -> db.v1.SetCharacterPresenceRequest
	46, // 55: db.v1.AccountService.ClearAllPresence:input_type -> db.v1.ClearAllPresenceRequest
	50, // 56: db.v1.AccountService.CreateGuild:input_type -> db.v1.CreateGuildRequest
	52, // 57: db.v1.AccountService.SetGuildMember:input_type -> db.v1.SetGuildMemberRequest
	54, // 58: db.v1.AccountService.LeaveGuild:input_type -> db.v1.LeaveGuildRequest
	55, // 59: db.v1.AccountService.PromoteGuildMember:input_type -> db.v1.PromoteGuildMemberRequest
	57, // 60: db.v1.AccountService.TransferGuildLeader:input_type -> db.v1.TransferGuildLeaderRequest
	58, // 61: db.v1.AccountService.SetGuildRelation:input_type -> db.v1.SetGuildRelationRequest
	60, // 62: db.v1.AccountService.ListGuilds:input_type -> db.v1.ListGuildsRequest
	62, // 63: db.v1.AccountService.ListGuildRelations:input_type -> db.v1.ListGuildRelationsRequest
	65, // 64: db.v1.AccountService.LoadGuildZones:input_type -> db.v1.LoadGuildZonesRequest
	67, // 65: db.v1.AccountService.SaveGuildZone:input_type -> db.v1.SaveGuildZoneRequest
	70, // 66: db.v1.AccountService.LoadGuildTowerState:input_type -> db.v1.LoadGuildTowerStateRequest
	72, // 67: db.v1.AccountService.SaveGuildTowerState:input_type -> db.v1.SaveGuildTowerStateRequest
	75, // 68: db.v1.AccountService.LoadCastleQuestState:input_type -> db.v1.LoadCastleQuestStateRequest
	77, // 69: db.v1.AccountService.SaveCastleQuestState:input_type -> db.v1.SaveCastleQuestStateRequest
	79, // 70: db.v1.NpcConfigService.NpcConfigVersion:input_type -> db.v1.NpcConfigVersionRequest
	81, // 71: db.v1.NpcConfigService.ListNpcDefinitions:input_type -> db.v1.ListNpcDefinitionsRequest
	93, // 72: db.v1.NpcConfigService.ListMobTemplateStats:input_type -> db.v1.ListMobTemplateStatsRequest
	97, // 73: db.v1.NpcConfigService.ListItemStats:input_type -> db.v1.ListItemStatsRequest
	86, // 74: db.v1.WorldEventConfigService.WorldEventConfigVersion:input_type -> db.v1.WorldEventConfigVersionRequest
	88, // 75: db.v1.WorldEventConfigService.GetWorldEventConfig:input_type -> db.v1.GetWorldEventConfigRequest
	90, // 76: db.v1.WorldEventConfigService.UpdateWorldEventProgress:input_type -> db.v1.UpdateWorldEventProgressRequest
	4,  // 77: db.v1.AccountService.AccountLogin:output_type -> db.v1.AccountLoginResponse
	7,  // 78: db.v1.AccountService.ListCharacters:output_type -> db.v1.ListCharactersResponse
	12, // 79: db.v1.AccountService.LoadCharacter:output_type -> db.v1.LoadCharacterResponse
	14, // 80: db.v1.AccountService.SaveCharacter:output_type -> db.v1.SaveCharacterResponse
	16, // 81: db.v1.AccountService.QuoteKingdomCape:output_type -> db.v1.QuoteKingdomCapeResponse
	18, // 82: db.v1.AccountService.PurchaseKingdomCape:output_type -> db.v1.PurchaseKingdomCapeResponse
	20, // 83: db.v1.AccountService.CreateCharacter:output_type -> db.v1.CreateCharacterResponse
	22, // 84: db.v1.AccountService.CreateArchCharacter:output_type -> db.v1.CreateArchCharacterResponse
	24, // 85: db.v1.AccountService.DeleteCharacter:output_type -> db.v1.DeleteCharacterResponse
	26, // 86: db.v1.AccountService.SetPin:output_type -> db.v1.SetPinResponse
	28, // 87: db.v1.AccountService.VerifyPin:output_type -> db.v1.VerifyPinResponse
	30, // 88: db.v1.AccountService.LoadCargo:output_type -> db.v1.LoadCargoResponse
	32, // 89: db.v1.AccountService.SaveCargo:output_type -> db.v1.SaveCargoResponse
	35, // 90: db.v1.AccountService.ListPendingDeliveries:output_type -> db.v1.ListPendingDeliveriesResponse
	32, // 91: db.v1.AccountService.SaveCargoWithDeliveries:output_type -> db.v1.SaveCargoResponse
	38, // 92: db.v1.AccountService.SetAccountBlocked:output_type -> db.v1.SetAccountBlockedResponse
	40, // 93: db.v1.AccountService.RecordDuelResult:output_type -> db.v1.RecordDuelResultResponse
	43, // 94: db.v1.AccountService.RecordTrade:output_type -> db.v1.RecordTradeResponse
	45, // 95: db.v1.AccountService.SetCharacterPresence:output_type -> db.v1.SetCharacterPresenceResponse
	47, // 96: db.v1.AccountService.ClearAllPresence:output_type -> db.v1.ClearAllPresenceResponse
	51, // 97: db.v1.AccountService.CreateGuild:output_type -> db.v1.CreateGuildResponse
	53, // 98: db.v1.AccountService.SetGuildMember:output_type -> db.v1.SetGuildMemberResponse
	53, // 99: db.v1.AccountService.LeaveGuild:output_type -> db.v1.SetGuildMemberResponse
	56, // 100: db.v1.AccountService.PromoteGuildMember:output_type -> db.v1.PromoteGuildMemberResponse
	53, // 101: db.v1.AccountService.TransferGuildLeader:output_type -> db.v1.SetGuildMemberResponse
	59, // 102: db.v1.AccountService.SetGuildRelation:output_type -> db.v1.SetGuildRelationResponse
	61, // 103: db.v1.AccountService.ListGuilds:output_type -> db.v1.ListGuildsResponse
	63, // 104: db.v1.AccountService.ListGuildRelations:output_type -> db.v1.ListGuildRelationsResponse
	66, // 105: db.v1.AccountService.LoadGuildZones:output_type -> db.v1.LoadGuildZonesResponse
	68, // 106: db.v1.AccountService.SaveGuildZone:output_type -> db.v1.SaveGuildZoneResponse
	71, // 107: db.v1.AccountService.LoadGuildTowerState:output_type -> db.v1.LoadGuildTowerStateResponse
	73, // 108: db.v1.AccountService.SaveGuildTowerState:output_type -> db.v1.SaveGuildTowerStateResponse
	76, // 109: db.v1.AccountService.LoadCastleQuestState:output_type -> db.v1.LoadCastleQuestStateResponse
	78, // 110: db.v1.AccountService.SaveCastleQuestState:output_type -> db.v1.SaveCastleQuestStateResponse
	80, // 111: db.v1.NpcConfigService.NpcConfigVersion:output_type -> db.v1.NpcConfigVersionResponse
	82, // 112: db.v1.NpcConfigService.ListNpcDefinitions:output_type -> db.v1.ListNpcDefinitionsResponse
	94, // 113: db.v1.NpcConfigService.ListMobTemplateStats:output_type -> db.v1.ListMobTemplateStatsResponse
	98, // 114: db.v1.NpcConfigService.ListItemStats:output_type -> db.v1.ListItemStatsResponse
	87, // 115: db.v1.WorldEventConfigService.WorldEventConfigVersion:output_type -> db.v1.WorldEventConfigVersionResponse
	89, // 116: db.v1.WorldEventConfigService.GetWorldEventConfig:output_type -> db.v1.GetWorldEventConfigResponse
	91, // 117: db.v1.WorldEventConfigService.UpdateWorldEventProgress:output_type -> db.v1.UpdateWorldEventProgressResponse
