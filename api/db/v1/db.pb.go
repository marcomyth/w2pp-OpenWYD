...
const file_api_db_v1_db_proto_rawDesc = "" +
	...
	"\x17GUILD_RELATION_KIND_WAR\x10\x022\x9f$\n" +
	...
	"\x11CancelRmtListings\x12\x1f.db.v1.CancelRmtListingsRequest\x1a .db.v1.CancelRmtListingsResponse\x12Z\n" +
...
var file_api_db_v1_db_proto_msgTypes = make([]protoimpl.MessageInfo, 206)
var file_api_db_v1_db_proto_goTypes = []any{
	...
	(*SaveCargoWithDeliveriesRequest)(nil),   // 47: db.v1.SaveCargoWithDeliveriesRequest
	(*SetAccountBlockedRequest)(nil),         // 48: db.v1.SetAccountBlockedRequest
	(*SetAccountBlockedResponse)(nil),        // 49: db.v1.SetAccountBlockedResponse
	(*RecordDuelResultRequest)(nil),          // 50: db.v1.RecordDuelResultRequest
	(*RecordDuelResultResponse)(nil),         // 51: db.v1.RecordDuelResultResponse
	(*TradeItem)(nil),                        // 52: db.v1.TradeItem
	(*RecordTradeRequest)(nil),               // 53: db.v1.RecordTradeRequest
	(*RecordTradeResponse)(nil),              // 54: db.v1.RecordTradeResponse
	(*ReserveSerialsRequest)(nil),            // 55: db.v1.ReserveSerialsRequest
	(*ReserveSerialsResponse)(nil),           // 56: db.v1.ReserveSerialsResponse
	(*ChatLine)(nil),                         // 57: db.v1.ChatLine
	(*RecordChatRequest)(nil),                // 58: db.v1.RecordChatRequest
	(*RecordChatResponse)(nil),               // 59: db.v1.RecordChatResponse
	(*RecordGroundRequest)(nil),              // 60: db.v1.RecordGroundRequest
	(*RecordGroundResponse)(nil),             // 61: db.v1.RecordGroundResponse
	(*RecordReportRequest)(nil),              // 62: db.v1.RecordReportRequest
	(*RecordReportResponse)(nil),             // 63: db.v1.RecordReportResponse
	(*SetCharacterPresenceRequest)(nil),      // 64: db.v1.SetCharacterPresenceRequest
	(*SetCharacterPresenceResponse)(nil),     // 65: db.v1.SetCharacterPresenceResponse
	(*ClearAllPresenceRequest)(nil),          // 66: db.v1.ClearAllPresenceRequest
	(*ClearAllPresenceResponse)(nil),         // 67: db.v1.ClearAllPresenceResponse
	(*AddShopPointsRequest)(nil),             // 68: db.v1.AddShopPointsRequest
	(*AddShopPointsResponse)(nil),            // 69: db.v1.AddShopPointsResponse
	(*ShopPointsRequest)(nil),                // 70: db.v1.ShopPointsRequest
	(*ShopPointsResponse)(nil),               // 71: db.v1.ShopPointsResponse
	(*SpendShopPointsRequest)(nil),           // 72: db.v1.SpendShopPointsRequest
	(*SpendShopPointsResponse)(nil),          // 73: db.v1.SpendShopPointsResponse
	(*ClaimNewbieKitRequest)(nil),            // 74: db.v1.ClaimNewbieKitRequest
	(*ClaimNewbieKitResponse)(nil),           // 75: db.v1.ClaimNewbieKitResponse
	(*Guild)(nil),                            // 76: db.v1.Guild
	(*GuildMember)(nil),                      // 77: db.v1.GuildMember
	(*GuildRelation)(nil),                    // 78: db.v1.GuildRelation
	(*CreateGuildRequest)(nil),               // 79: db.v1.CreateGuildRequest
	(*CreateGuildResponse)(nil),              // 80: db.v1.CreateGuildResponse
	(*SetGuildMemberRequest)(nil),            // 81: db.v1.SetGuildMemberRequest
	(*SetGuildMemberResponse)(nil),           // 82: db.v1.SetGuildMemberResponse
	(*LeaveGuildRequest)(nil),                // 83: db.v1.LeaveGuildRequest
	(*PromoteGuildMemberRequest)(nil),        // 84: db.v1.PromoteGuildMemberRequest
	(*PromoteGuildMemberResponse)(nil),       // 85: db.v1.PromoteGuildMemberResponse
	(*TransferGuildLeaderRequest)(nil),       // 86: db.v1.TransferGuildLeaderRequest
	(*SetGuildRelationRequest)(nil),          // 87: db.v1.SetGuildRelationRequest
	(*SetGuildRelationResponse)(nil),         // 88: db.v1.SetGuildRelationResponse
	(*ListGuildsRequest)(nil),                // 89: db.v1.ListGuildsRequest
	(*ListGuildsResponse)(nil),               // 90: db.v1.ListGuildsResponse
	(*ListGuildRelationsRequest)(nil),        // 91: db.v1.ListGuildRelationsRequest
	(*ListGuildRelationsResponse)(nil),       // 92: db.v1.ListGuildRelationsResponse
	(*ListGuildMembersRequest)(nil),          // 93: db.v1.ListGuildMembersRequest
	(*GuildBuff)(nil),                        // 94: db.v1.GuildBuff
	(*GuildSummary)(nil),                     // 95: db.v1.GuildSummary
	(*ListGuildSummariesRequest)(nil),        // 96: db.v1.ListGuildSummariesRequest
	(*ListGuildSummariesResponse)(nil),       // 97: db.v1.ListGuildSummariesResponse
	(*GuildSquad)(nil),                       // 98: db.v1.GuildSquad
	(*ListGuildSquadsRequest)(nil),           // 99: db.v1.ListGuildSquadsRequest
	(*ListGuildSquadsResponse)(nil),          // 100: db.v1.ListGuildSquadsResponse
	(*SetGuildSquadRequest)(nil),             // 101: db.v1.SetGuildSquadRequest
	(*SetGuildSquadResponse)(nil),            // 102: db.v1.SetGuildSquadResponse
	(*ListGuildBuffsRequest)(nil),            // 103: db.v1.ListGuildBuffsRequest
	(*ListGuildBuffsResponse)(nil),           // 104: db.v1.ListGuildBuffsResponse
	(*SaveGuildBuffRequest)(nil),             // 105: db.v1.SaveGuildBuffRequest
	(*SaveGuildBuffResponse)(nil),            // 106: db.v1.SaveGuildBuffResponse
	(*DeleteGuildBuffRequest)(nil),           // 107: db.v1.DeleteGuildBuffRequest
	(*DeleteGuildBuffResponse)(nil),          // 108: db.v1.DeleteGuildBuffResponse
	(*ListGuildMembersResponse)(nil),         // 109: db.v1.ListGuildMembersResponse
	(*SaveGuildNoticeRequest)(nil),           // 110: db.v1.SaveGuildNoticeRequest
	(*SaveGuildNoticeResponse)(nil),          // 111: db.v1.SaveGuildNoticeResponse
	(*GuildZone)(nil),                        // 112: db.v1.GuildZone
	(*LoadGuildZonesRequest)(nil),            // 113: db.v1.LoadGuildZonesRequest
	(*LoadGuildZonesResponse)(nil),           // 114: db.v1.LoadGuildZonesResponse
	(*SaveGuildZoneRequest)(nil),             // 115: db.v1.SaveGuildZoneRequest
	(*SaveGuildZoneResponse)(nil),            // 116: db.v1.SaveGuildZoneResponse
	(*GuildTowerState)(nil),                  // 117: db.v1.GuildTowerState
	(*LoadGuildTowerStateRequest)(nil),       // 118: db.v1.LoadGuildTowerStateRequest
	(*LoadGuildTowerStateResponse)(nil),      // 119: db.v1.LoadGuildTowerStateResponse
	(*SaveGuildTowerStateRequest)(nil),       // 120: db.v1.SaveGuildTowerStateRequest
	(*SaveGuildTowerStateResponse)(nil),      // 121: db.v1.SaveGuildTowerStateResponse
	(*SaveGuildFameRequest)(nil),             // 122: db.v1.SaveGuildFameRequest
	(*SaveGuildFameResponse)(nil),            // 123: db.v1.SaveGuildFameResponse
	(*CastleQuestState)(nil),                 // 124: db.v1.CastleQuestState
	(*LoadCastleQuestStateRequest)(nil),      // 125: db.v1.LoadCastleQuestStateRequest
	(*LoadCastleQuestStateResponse)(nil),     // 126: db.v1.LoadCastleQuestStateResponse
	(*SaveCastleQuestStateRequest)(nil),      // 127: db.v1.SaveCastleQuestStateRequest
	(*SaveCastleQuestStateResponse)(nil),     // 128: db.v1.SaveCastleQuestStateResponse
	(*NpcConfigVersionRequest)(nil),          // 129: db.v1.NpcConfigVersionRequest
	(*NpcConfigVersionResponse)(nil),         // 130: db.v1.NpcConfigVersionResponse
	(*ListNpcDefinitionsRequest)(nil),        // 131: db.v1.ListNpcDefinitionsRequest
	(*ListNpcDefinitionsResponse)(nil),       // 132: db.v1.ListNpcDefinitionsResponse
	(*NpcShopItem)(nil),                      // 133: db.v1.NpcShopItem
	(*NpcDefinition)(nil),                    // 134: db.v1.NpcDefinition
	(*ItemPrice)(nil),                        // 135: db.v1.ItemPrice
	(*WorldEventConfigVersionRequest)(nil),   // 136: db.v1.WorldEventConfigVersionRequest
	(*WorldEventConfigVersionResponse)(nil),  // 137: db.v1.WorldEventConfigVersionResponse
	(*GetWorldEventConfigRequest)(nil),       // 138: db.v1.GetWorldEventConfigRequest
	(*GetWorldEventConfigResponse)(nil),      // 139: db.v1.GetWorldEventConfigResponse
	(*UpdateWorldEventProgressRequest)(nil),  // 140: db.v1.UpdateWorldEventProgressRequest
	(*UpdateWorldEventProgressResponse)(nil), // 141: db.v1.UpdateWorldEventProgressResponse
	(*SetKefraStateRequest)(nil),             // 142: db.v1.SetKefraStateRequest
	(*SetKefraStateResponse)(nil),            // 143: db.v1.SetKefraStateResponse
	(*WorldEventConfig)(nil),                 // 144: db.v1.WorldEventConfig
	(*ListMobTemplateStatsRequest)(nil),      // 145: db.v1.ListMobTemplateStatsRequest
	(*ListMobTemplateStatsResponse)(nil),     // 146: db.v1.ListMobTemplateStatsResponse
	(*MobTemplateEquipItem)(nil),             // 147: db.v1.MobTemplateEquipItem
	(*MobTemplateStat)(nil),                  // 148: db.v1.MobTemplateStat
	(*ListItemStatsRequest)(nil),             // 149: db.v1.ListItemStatsRequest
	(*ListItemStatsResponse)(nil),            // 150: db.v1.ListItemStatsResponse
	(*ItemStat)(nil),                         // 151: db.v1.ItemStat
	(*ListMountGrowthRatesRequest)(nil),      // 152: db.v1.ListMountGrowthRatesRequest
	(*ListMountGrowthRatesResponse)(nil),     // 153: db.v1.ListMountGrowthRatesResponse
	(*MountGrowthRate)(nil),                  // 154: db.v1.MountGrowthRate
	(*MountConfigVersionRequest)(nil),        // 155: db.v1.MountConfigVersionRequest
	(*MountConfigVersionResponse)(nil),       // 156: db.v1.MountConfigVersionResponse
	(*ListMountAbsorbRequest)(nil),           // 157: db.v1.ListMountAbsorbRequest
	(*ListMountAbsorbResponse)(nil),          // 158: db.v1.ListMountAbsorbResponse
	(*MountAbsorb)(nil),                      // 159: db.v1.MountAbsorb
	(*ListMountBonusRequest)(nil),            // 160: db.v1.ListMountBonusRequest
	(*ListMountBonusResponse)(nil),           // 161: db.v1.ListMountBonusResponse
	(*MountBonus)(nil),                       // 162: db.v1.MountBonus
	(*XPConfigVersionRequest)(nil),           // 163: db.v1.XPConfigVersionRequest
	(*XPConfigVersionResponse)(nil),          // 164: db.v1.XPConfigVersionResponse
	(*GetXPConfigRequest)(nil),               // 165: db.v1.GetXPConfigRequest
	(*GetXPConfigResponse)(nil),              // 166: db.v1.GetXPConfigResponse
	(*XPCut)(nil),                            // 167: db.v1.XPCut
	(*XPRule)(nil),                           // 168: db.v1.XPRule
	(*DungeonGateVersionRequest)(nil),        // 169: db.v1.DungeonGateVersionRequest
	(*DungeonGateVersionResponse)(nil),       // 170: db.v1.DungeonGateVersionResponse
	(*GetDungeonGatesRequest)(nil),           // 171: db.v1.GetDungeonGatesRequest
	(*GetDungeonGatesResponse)(nil),          // 172: db.v1.GetDungeonGatesResponse
	(*DungeonGate)(nil),                      // 173: db.v1.DungeonGate
	(*GetQuestRewardsRequest)(nil),           // 174: db.v1.GetQuestRewardsRequest
	(*GetQuestRewardsResponse)(nil),          // 175: db.v1.GetQuestRewardsResponse
	(*QuestReward)(nil),                      // 176: db.v1.QuestReward
	(*GetDropBonusRequest)(nil),              // 177: db.v1.GetDropBonusRequest
	(*GetDropBonusResponse)(nil),             // 178: db.v1.GetDropBonusResponse
	(*DropBonusBand)(nil),                    // 179: db.v1.DropBonusBand
	(*SpawnRateVersionRequest)(nil),          // 180: db.v1.SpawnRateVersionRequest
	(*SpawnRateVersionResponse)(nil),         // 181: db.v1.SpawnRateVersionResponse
	(*GetSpawnRatesRequest)(nil),             // 182: db.v1.GetSpawnRatesRequest
	(*GetSpawnRatesResponse)(nil),            // 183: db.v1.GetSpawnRatesResponse
	(*SpawnRate)(nil),                        // 184: db.v1.SpawnRate
	(*CombineRateVersionRequest)(nil),        // 185: db.v1.CombineRateVersionRequest
	(*CombineRateVersionResponse)(nil),       // 186: db.v1.CombineRateVersionResponse
	(*GetCombineRatesRequest)(nil),           // 187: db.v1.GetCombineRatesRequest
	(*GetCombineRatesResponse)(nil),          // 188: db.v1.GetCombineRatesResponse
	(*CombineRate)(nil),                      // 189: db.v1.CombineRate
	(*CombineBand)(nil),                      // 190: db.v1.CombineBand
	(*CombatRuleVersionRequest)(nil),         // 191: db.v1.CombatRuleVersionRequest
	(*CombatRuleVersionResponse)(nil),        // 192: db.v1.CombatRuleVersionResponse
	(*GetCombatRuleRequest)(nil),             // 193: db.v1.GetCombatRuleRequest
	(*GetCombatRuleResponse)(nil),            // 194: db.v1.GetCombatRuleResponse
	(*GeneratorOffVersionRequest)(nil),       // 195: db.v1.GeneratorOffVersionRequest
	(*GeneratorOffVersionResponse)(nil),      // 196: db.v1.GeneratorOffVersionResponse
	(*GetGeneratorsOffRequest)(nil),          // 197: db.v1.GetGeneratorsOffRequest
	(*GetGeneratorsOffResponse)(nil),         // 198: db.v1.GetGeneratorsOffResponse
	(*GeneratorOff)(nil),                     // 199: db.v1.GeneratorOff
	(*SetGeneratorOffRequest)(nil),           // 200: db.v1.SetGeneratorOffRequest
	(*SetGeneratorOffResponse)(nil),          // 201: db.v1.SetGeneratorOffResponse
	(*DropRuleVersionRequest)(nil),           // 202: db.v1.DropRuleVersionRequest
	(*DropRuleVersionResponse)(nil),          // 203: db.v1.DropRuleVersionResponse
	(*ListDropRulesRequest)(nil),             // 204: db.v1.ListDropRulesRequest
	(*DropRule)(nil),                         // 205: db.v1.DropRule
	(*ListDropRulesResponse)(nil),            // 206: db.v1.ListDropRulesResponse
	(*CreditDonateRequest)(nil),              // 207: db.v1.CreditDonateRequest
	(*CreditDonateResponse)(nil),             // 208: db.v1.CreditDonateResponse
	(*DonateBalanceRequest)(nil),             // 209: db.v1.DonateBalanceRequest
	(*DonateBalanceResponse)(nil),            // 210: db.v1.DonateBalanceResponse
}
var file_api_db_v1_db_proto_depIdxs = []int32{
	...
	12,  // 18: db.v1.SaveCargoWithDeliveriesRequest.items:type_name -> db.v1.Item
	52,  // 19: db.v1.RecordTradeRequest.items_a:type_name -> db.v1.TradeItem
	52,  // 20: db.v1.RecordTradeRequest.items_b:type_name -> db.v1.TradeItem
	57,  // 21: db.v1.RecordChatRequest.lines:type_name -> db.v1.ChatLine
	4,   // 22: db.v1.GuildRelation.kind:type_name -> db.v1.GuildRelationKind
	76,  // 23: db.v1.CreateGuildResponse.guild:type_name -> db.v1.Guild
	4,   // 24: db.v1.SetGuildRelationRequest.kind:type_name -> db.v1.GuildRelationKind
	76,  // 25: db.v1.ListGuildsResponse.guilds:type_name -> db.v1.Guild
	78,  // 26: db.v1.ListGuildRelationsResponse.relations:type_name -> db.v1.GuildRelation
	95,  // 27: db.v1.ListGuildSummariesResponse.guilds:type_name -> db.v1.GuildSummary
	98,  // 28: db.v1.ListGuildSquadsResponse.squads:type_name -> db.v1.GuildSquad
	94,  // 29: db.v1.ListGuildBuffsResponse.buffs:type_name -> db.v1.GuildBuff
	94,  // 30: db.v1.SaveGuildBuffRequest.buff:type_name -> db.v1.GuildBuff
	77,  // 31: db.v1.ListGuildMembersResponse.members:type_name -> db.v1.GuildMember
	112, // 32: db.v1.LoadGuildZonesResponse.zones:type_name -> db.v1.GuildZone
	112, // 33: db.v1.SaveGuildZoneRequest.zone:type_name -> db.v1.GuildZone
	117, // 34: db.v1.LoadGuildTowerStateResponse.state:type_name -> db.v1.GuildTowerState
	117, // 35: db.v1.SaveGuildTowerStateRequest.state:type_name -> db.v1.GuildTowerState
	124, // 36: db.v1.LoadCastleQuestStateResponse.state:type_name -> db.v1.CastleQuestState
	124, // 37: db.v1.SaveCastleQuestStateRequest.state:type_name -> db.v1.CastleQuestState
	134, // 38: db.v1.ListNpcDefinitionsResponse.definitions:type_name -> db.v1.NpcDefinition
	135, // 39: db.v1.ListNpcDefinitionsResponse.price_overrides:type_name -> db.v1.ItemPrice
	133, // 40: db.v1.NpcDefinition.shop:type_name -> db.v1.NpcShopItem
	144, // 41: db.v1.GetWorldEventConfigResponse.config:type_name -> db.v1.WorldEventConfig
	148, // 42: db.v1.ListMobTemplateStatsResponse.overrides:type_name -> db.v1.MobTemplateStat
	147, // 43: db.v1.MobTemplateStat.equip:type_name -> db.v1.MobTemplateEquipItem
	151, // 44: db.v1.ListItemStatsResponse.overrides:type_name -> db.v1.ItemStat
	154, // 45: db.v1.ListMountGrowthRatesResponse.rates:type_name -> db.v1.MountGrowthRate
	159, // 46: db.v1.ListMountAbsorbResponse.absorb:type_name -> db.v1.MountAbsorb
	162, // 47: db.v1.ListMountBonusResponse.bonus:type_name -> db.v1.MountBonus
	168, // 48: db.v1.GetXPConfigResponse.rules:type_name -> db.v1.XPRule
	167, // 49: db.v1.XPRule.cuts:type_name -> db.v1.XPCut
	173, // 50: db.v1.GetDungeonGatesResponse.gates:type_name -> db.v1.DungeonGate
	176, // 51: db.v1.GetQuestRewardsResponse.tiers:type_name -> db.v1.QuestReward
	179, // 52: db.v1.GetDropBonusResponse.faixas:type_name -> db.v1.DropBonusBand
	184, // 53: db.v1.GetSpawnRatesResponse.areas:type_name -> db.v1.SpawnRate
	189, // 54: db.v1.GetCombineRatesResponse.rates:type_name -> db.v1.CombineRate
	190, // 55: db.v1.GetCombineRatesResponse.bands:type_name -> db.v1.CombineBand
	199, // 56: db.v1.GetGeneratorsOffResponse.off:type_name -> db.v1.GeneratorOff
	205, // 57: db.v1.ListDropRulesResponse.rules:type_name -> db.v1.DropRule
	5,   // 58: db.v1.AccountService.AccountLogin:input_type -> db.v1.AccountLoginRequest
	7,   // 59: db.v1.AccountService.ListCharacters:input_type -> db.v1.ListCharactersRequest
	10,  // 60: db.v1.AccountService.LoadCharacter:input_type -> db.v1.LoadCharacterRequest
	15,  // 61: db.v1.AccountService.SaveCharacter:input_type -> db.v1.SaveCharacterRequest
	17,  // 62: db.v1.AccountService.QuoteKingdomCape:input_type -> db.v1.QuoteKingdomCapeRequest
	19,  // 63: db.v1.AccountService.PurchaseKingdomCape:input_type -> db.v1.PurchaseKingdomCapeRequest
	21,  // 64: db.v1.AccountService.TransferPlayerBalance:input_type -> db.v1.TransferPlayerBalanceRequest
	23,  // 65: db.v1.AccountService.CreateCharacter:input_type -> db.v1.CreateCharacterRequest
	25,  // 66: db.v1.AccountService.CreateArchCharacter:input_type -> db.v1.CreateArchCharacterRequest
	27,  // 67: db.v1.AccountService.DeleteCharacter:input_type -> db.v1.DeleteCharacterRequest
	29,  // 68: db.v1.AccountService.SetPin:input_type -> db.v1.SetPinRequest
	31,  // 69: db.v1.AccountService.VerifyPin:input_type -> db.v1.VerifyPinRequest
	33,  // 70: db.v1.AccountService.LoadCargo:input_type -> db.v1.LoadCargoRequest
	35,  // 71: db.v1.AccountService.SaveCargo:input_type -> db.v1.SaveCargoRequest
	38,  // 72: db.v1.AccountService.ListPendingDeliveries:input_type -> db.v1.ListPendingDeliveriesRequest
	40,  // 73: db.v1.AccountService.ListSoldEscrowSlots:input_type -> db.v1.ListSoldEscrowSlotsRequest
	43,  // 74: db.v1.AccountService.OpenRmtListings:input_type -> db.v1.OpenRmtListingsRequest
	45,  // 75: db.v1.AccountService.CancelRmtListings:input_type -> db.v1.CancelRmtListingsRequest
	47,  // 76: db.v1.AccountService.SaveCargoWithDeliveries:input_type -> db.v1.SaveCargoWithDeliveriesRequest
	48,  // 77: db.v1.AccountService.SetAccountBlocked:input_type -> db.v1.SetAccountBlockedRequest
	50,  // 78: db.v1.AccountService.RecordDuelResult:input_type -> db.v1.RecordDuelResultRequest
	53,  // 79: db.v1.AccountService.RecordTrade:input_type -> db.v1.RecordTradeRequest
	62,  // 80: db.v1.AccountService.RecordReport:input_type -> db.v1.RecordReportRequest
	60,  // 81: db.v1.AccountService.RecordGround:input_type -> db.v1.RecordGroundRequest
	55,  // 82: db.v1.AccountService.ReserveSerials:input_type -> db.v1.ReserveSerialsRequest
	58,  // 83: db.v1.AccountService.RecordChat:input_type -> db.v1.RecordChatRequest
	64,  // 84: db.v1.AccountService.SetCharacterPresence:input_type -> db.v1.SetCharacterPresenceRequest
	66,  // 85: db.v1.AccountService.ClearAllPresence:input_type -> db.v1.ClearAllPresenceRequest
	68,  // 86: db.v1.AccountService.AddShopPoints:input_type -> db.v1.AddShopPointsRequest
	70,  // 87: db.v1.AccountService.ShopPoints:input_type -> db.v1.ShopPointsRequest
	72,  // 88: db.v1.AccountService.SpendShopPoints:input_type -> db.v1.SpendShopPointsRequest
	74,  // 89: db.v1.AccountService.ClaimNewbieKit:input_type -> db.v1.ClaimNewbieKitRequest
	207, // 90: db.v1.AccountService.CreditDonate:input_type -> db.v1.CreditDonateRequest
	209, // 91: db.v1.AccountService.DonateBalance:input_type -> db.v1.DonateBalanceRequest
	79,  // 92: db.v1.AccountService.CreateGuild:input_type -> db.v1.CreateGuildRequest
	81,  // 93: db.v1.AccountService.SetGuildMember:input_type -> db.v1.SetGuildMemberRequest
	83,  // 94: db.v1.AccountService.LeaveGuild:input_type -> db.v1.LeaveGuildRequest
	84,  // 95: db.v1.AccountService.PromoteGuildMember:input_type -> db.v1.PromoteGuildMemberRequest
	86,  // 96: db.v1.AccountService.TransferGuildLeader:input_type -> db.v1.TransferGuildLeaderRequest
	87,  // 97: db.v1.AccountService.SetGuildRelation:input_type -> db.v1.SetGuildRelationRequest
	89,  // 98: db.v1.AccountService.ListGuilds:input_type -> db.v1.ListGuildsRequest
	91,  // 99: db.v1.AccountService.ListGuildRelations:input_type -> db.v1.ListGuildRelationsRequest
	93,  // 100: db.v1.AccountService.ListGuildMembers:input_type -> db.v1.ListGuildMembersRequest
	110, // 101: db.v1.AccountService.SaveGuildNotice:input_type -> db.v1.SaveGuildNoticeRequest
	96,  // 102: db.v1.AccountService.ListGuildSummaries:input_type -> db.v1.ListGuildSummariesRequest
	99,  // 103: db.v1.AccountService.ListGuildSquads:input_type -> db.v1.ListGuildSquadsRequest
	101, // 104: db.v1.AccountService.SetGuildSquad:input_type -> db.v1.SetGuildSquadRequest
	103, // 105: db.v1.AccountService.ListGuildBuffs:input_type -> db.v1.ListGuildBuffsRequest
	105, // 106: db.v1.AccountService.SaveGuildBuff:input_type -> db.v1.SaveGuildBuffRequest
	107, // 107: db.v1.AccountService.DeleteGuildBuff:input_type -> db.v1.DeleteGuildBuffRequest
	113, // 108: db.v1.AccountService.LoadGuildZones:input_type -> db.v1.LoadGuildZonesRequest
	115, // 109: db.v1.AccountService.SaveGuildZone:input_type -> db.v1.SaveGuildZoneRequest
	118, // 110: db.v1.AccountService.LoadGuildTowerState:input_type -> db.v1.LoadGuildTowerStateRequest
	120, // 111: db.v1.AccountService.SaveGuildTowerState:input_type -> db.v1.SaveGuildTowerStateRequest
	122, // 112: db.v1.AccountService.SaveGuildFame:input_type -> db.v1.SaveGuildFameRequest
	125, // 113: db.v1.AccountService.LoadCastleQuestState:input_type -> db.v1.LoadCastleQuestStateRequest
	127, // 114: db.v1.AccountService.SaveCastleQuestState:input_type -> db.v1.SaveCastleQuestStateRequest
	129, // 115: db.v1.NpcConfigService.NpcConfigVersion:input_type -> db.v1.NpcConfigVersionRequest
	131, // 116: db.v1.NpcConfigService.ListNpcDefinitions:input_type -> db.v1.ListNpcDefinitionsRequest
	145, // 117: db.v1.NpcConfigService.ListMobTemplateStats:input_type -> db.v1.ListMobTemplateStatsRequest
	149, // 118: db.v1.NpcConfigService.ListItemStats:input_type -> db.v1.ListItemStatsRequest
	152, // 119: db.v1.NpcConfigService.ListMountGrowthRates:input_type -> db.v1.ListMountGrowthRatesRequest
	157, // 120: db.v1.NpcConfigService.ListMountAbsorb:input_type -> db.v1.ListMountAbsorbRequest
	160, // 121: db.v1.NpcConfigService.ListMountBonus:input_type -> db.v1.ListMountBonusRequest
	155, // 122: db.v1.NpcConfigService.MountConfigVersion:input_type -> db.v1.MountConfigVersionRequest
	136, // 123: db.v1.WorldEventConfigService.WorldEventConfigVersion:input_type -> db.v1.WorldEventConfigVersionRequest
	138, // 124: db.v1.WorldEventConfigService.GetWorldEventConfig:input_type -> db.v1.GetWorldEventConfigRequest
	140, // 125: db.v1.WorldEventConfigService.UpdateWorldEventProgress:input_type -> db.v1.UpdateWorldEventProgressRequest
	142, // 126: db.v1.WorldEventConfigService.SetKefraState:input_type -> db.v1.SetKefraStateRequest
	163, // 127: db.v1.XPConfigService.XPConfigVersion:input_type -> db.v1.XPConfigVersionRequest
	165, // 128: db.v1.XPConfigService.GetXPConfig:input_type -> db.v1.GetXPConfigRequest
	169, // 129: db.v1.DungeonGateService.DungeonGateVersion:input_type -> db.v1.DungeonGateVersionRequest
	171, // 130: db.v1.DungeonGateService.GetDungeonGates:input_type -> db.v1.GetDungeonGatesRequest
	174, // 131: db.v1.QuestRewardService.GetQuestRewards:input_type -> db.v1.GetQuestRewardsRequest
	177, // 132: db.v1.DropBonusService.GetDropBonus:input_type -> db.v1.GetDropBonusRequest
	180, // 133: db.v1.SpawnRateService.SpawnRateVersion:input_type -> db.v1.SpawnRateVersionRequest
	182, // 134: db.v1.SpawnRateService.GetSpawnRates:input_type -> db.v1.GetSpawnRatesRequest
	185, // 135: db.v1.CombineRateService.CombineRateVersion:input_type -> db.v1.CombineRateVersionRequest
	187, // 136: db.v1.CombineRateService.GetCombineRates:input_type -> db.v1.GetCombineRatesRequest
	191, // 137: db.v1.CombatRuleService.CombatRuleVersion:input_type -> db.v1.CombatRuleVersionRequest
	193, // 138: db.v1.CombatRuleService.GetCombatRule:input_type -> db.v1.GetCombatRuleRequest
	195, // 139: db.v1.NpcGeneratorService.GeneratorOffVersion:input_type -> db.v1.GeneratorOffVersionRequest
	197, // 140: db.v1.NpcGeneratorService.GetGeneratorsOff:input_type -> db.v1.GetGeneratorsOffRequest
	200, // 141: db.v1.NpcGeneratorService.SetGeneratorOff:input_type -> db.v1.SetGeneratorOffRequest
	202, // 142: db.v1.DropRuleService.DropRuleVersion:input_type -> db.v1.DropRuleVersionRequest
	204, // 143: db.v1.DropRuleService.ListDropRules:input_type -> db.v1.ListDropRulesRequest
	6,   // 144: db.v1.AccountService.AccountLogin:output_type -> db.v1.AccountLoginResponse
	9,   // 145: db.v1.AccountService.ListCharacters:output_type -> db.v1.ListCharactersResponse
	14,  // 146: db.v1.AccountService.LoadCharacter:output_type -> db.v1.LoadCharacterResponse
	16,  // 147: db.v1.AccountService.SaveCharacter:output_type -> db.v1.SaveCharacterResponse
	18,  // 148: db.v1.AccountService.QuoteKingdomCape:output_type -> db.v1.QuoteKingdomCapeResponse
	20,  // 149: db.v1.AccountService.PurchaseKingdomCape:output_type -> db.v1.PurchaseKingdomCapeResponse
	22,  // 150: db.v1.AccountService.TransferPlayerBalance:output_type -> db.v1.TransferPlayerBalanceResponse
	24,  // 151: db.v1.AccountService.CreateCharacter:output_type -> db.v1.CreateCharacterResponse
	26,  // 152: db.v1.AccountService.CreateArchCharacter:output_type -> db.v1.CreateArchCharacterResponse
	28,  // 153: db.v1.AccountService.DeleteCharacter:output_type -> db.v1.DeleteCharacterResponse
	30,  // 154: db.v1.AccountService.SetPin:output_type -> db.v1.SetPinResponse
	32,  // 155: db.v1.AccountService.VerifyPin:output_type -> db.v1.VerifyPinResponse
	34,  // 156: db.v1.AccountService.LoadCargo:output_type -> db.v1.LoadCargoResponse
	36,  // 157: db.v1.AccountService.SaveCargo:output_type -> db.v1.SaveCargoResponse
	39,  // 158: db.v1.AccountService.ListPendingDeliveries:output_type -> db.v1.ListPendingDeliveriesResponse
	41,  // 159: db.v1.AccountService.ListSoldEscrowSlots:output_type -> db.v1.ListSoldEscrowSlotsResponse
	44,  // 160: db.v1.AccountService.OpenRmtListings:output_type -> db.v1.OpenRmtListingsResponse
	46,  // 161: db.v1.AccountService.CancelRmtListings:output_type -> db.v1.CancelRmtListingsResponse
	36,  // 162: db.v1.AccountService.SaveCargoWithDeliveries:output_type -> db.v1.SaveCargoResponse
	49,  // 163: db.v1.AccountService.SetAccountBlocked:output_type -> db.v1.SetAccountBlockedResponse
	51,  // 164: db.v1.AccountService.RecordDuelResult:output_type -> db.v1.RecordDuelResultResponse
	54,  // 165: db.v1.AccountService.RecordTrade:output_type -> db.v1.RecordTradeResponse
	63,  // 166: db.v1.AccountService.RecordReport:output_type -> db.v1.RecordReportResponse
	61,  // 167: db.v1.AccountService.RecordGround:output_type -> db.v1.RecordGroundResponse
	56,  // 168: db.v1.AccountService.ReserveSerials:output_type -> db.v1.ReserveSerialsResponse
	59,  // 169: db.v1.AccountService.RecordChat:output_type -> db.v1.RecordChatResponse
	65,  // 170: db.v1.AccountService.SetCharacterPresence:output_type -> db.v1.SetCharacterPresenceResponse
	67,  // 171: db.v1.AccountService.ClearAllPresence:output_type -> db.v1.ClearAllPresenceResponse
	69,  // 172: db.v1.AccountService.AddShopPoints:output_type -> db.v1.AddShopPointsResponse
	71,  // 173: db.v1.AccountService.ShopPoints:output_type -> db.v1.ShopPointsResponse
	73,  // 174: db.v1.AccountService.SpendShopPoints:output_type -> db.v1.SpendShopPointsResponse
	75,  // 175: db.v1.AccountService.ClaimNewbieKit:output_type -> db.v1.ClaimNewbieKitResponse
	208, // 176: db.v1.AccountService.CreditDonate:output_type -> db.v1.CreditDonateResponse
	210, // 177: db.v1.AccountService.DonateBalance:output_type -> db.v1.DonateBalanceResponse
	80,  // 178: db.v1.AccountService.CreateGuild:output_type -> db.v1.CreateGuildResponse
	82,  // 179: db.v1.AccountService.SetGuildMember:output_type -> db.v1.SetGuildMemberResponse
	82,  // 180: db.v1.AccountService.LeaveGuild:output_type -> db.v1.SetGuildMemberResponse
	85,  // 181: db.v1.AccountService.PromoteGuildMember:output_type -> db.v1.PromoteGuildMemberResponse
	82,  // 182: db.v1.AccountService.TransferGuildLeader:output_type -> db.v1.SetGuildMemberResponse
	88,  // 183: db.v1.AccountService.SetGuildRelation:output_type -> db.v1.SetGuildRelationResponse
	90,  // 184: db.v1.AccountService.ListGuilds:output_type -> db.v1.ListGuildsResponse
	92,  // 185: db.v1.AccountService.ListGuildRelations:output_type -> db.v1.ListGuildRelationsResponse
	109, // 186: db.v1.AccountService.ListGuildMembers:output_type -> db.v1.ListGuildMembersResponse
	111, // 187: db.v1.AccountService.SaveGuildNotice:output_type -> db.v1.SaveGuildNoticeResponse
	97,  // 188: db.v1.AccountService.ListGuildSummaries:output_type -> db.v1.ListGuildSummariesResponse
	100, // 189: db.v1.AccountService.ListGuildSquads:output_type -> db.v1.ListGuildSquadsResponse
	102, // 190: db.v1.AccountService.SetGuildSquad:output_type -> db.v1.SetGuildSquadResponse
	104, // 191: db.v1.AccountService.ListGuildBuffs:output_type -> db.v1.ListGuildBuffsResponse
	106, // 192: db.v1.AccountService.SaveGuildBuff:output_type -> db.v1.SaveGuildBuffResponse
	108, // 193: db.v1.AccountService.DeleteGuildBuff:output_type -> db.v1.DeleteGuildBuffResponse
	114, // 194: db.v1.AccountService.LoadGuildZones:output_type -> db.v1.LoadGuildZonesResponse
	116, // 195: db.v1.AccountService.SaveGuildZone:output_type -> db.v1.SaveGuildZoneResponse
	119, // 196: db.v1.AccountService.LoadGuildTowerState:output_type -> db.v1.LoadGuildTowerStateResponse
	121, // 197: db.v1.AccountService.SaveGuildTowerState:output_type -> db.v1.SaveGuildTowerStateResponse
	123, // 198: db.v1.AccountService.SaveGuildFame:output_type -> db.v1.SaveGuildFameResponse
	126, // 199: db.v1.AccountService.LoadCastleQuestState:output_type -> db.v1.LoadCastleQuestStateResponse
	128, // 200: db.v1.AccountService.SaveCastleQuestState:output_type -> db.v1.SaveCastleQuestStateResponse
	130, // 201: db.v1.NpcConfigService.NpcConfigVersion:output_type -> db.v1.NpcConfigVersionResponse
	132, // 202: db.v1.NpcConfigService.ListNpcDefinitions:output_type -> db.v1.ListNpcDefinitionsResponse
	146, // 203: db.v1.NpcConfigService.ListMobTemplateStats:output_type -> db.v1.ListMobTemplateStatsResponse
	150, // 204: db.v1.NpcConfigService.ListItemStats:output_type -> db.v1.ListItemStatsResponse
	153, // 205: db.v1.NpcConfigService.ListMountGrowthRates:output_type -> db.v1.ListMountGrowthRatesResponse
	158, // 206: db.v1.NpcConfigService.ListMountAbsorb:output_type -> db.v1.ListMountAbsorbResponse
	161, // 207: db.v1.NpcConfigService.ListMountBonus:output_type -> db.v1.ListMountBonusResponse
	156, // 208: db.v1.NpcConfigService.MountConfigVersion:output_type -> db.v1.MountConfigVersionResponse
	137, // 209: db.v1.WorldEventConfigService.WorldEventConfigVersion:output_type -> db.v1.WorldEventConfigVersionResponse
	139, // 210: db.v1.WorldEventConfigService.GetWorldEventConfig:output_type -> db.v1.GetWorldEventConfigResponse
	141, // 211: db.v1.WorldEventConfigService.UpdateWorldEventProgress:output_type -> db.v1.UpdateWorldEventProgressResponse
	143, // 212: db.v1.WorldEventConfigService.SetKefraState:output_type -> db.v1.SetKefraStateResponse
	164, // 213: db.v1.XPConfigService.XPConfigVersion:output_type -> db.v1.XPConfigVersionResponse
	166, // 214: db.v1.XPConfigService.GetXPConfig:output_type -> db.v1.GetXPConfigResponse
	170, // 215: db.v1.DungeonGateService.DungeonGateVersion:output_type -> db.v1.DungeonGateVersionResponse
	172, // 216: db.v1.DungeonGateService.GetDungeonGates:output_type -> db.v1.GetDungeonGatesResponse
	175, // 217: db.v1.QuestRewardService.GetQuestRewards:output_type -> db.v1.GetQuestRewardsResponse
	178, // 218: db.v1.DropBonusService.GetDropBonus:output_type -> db.v1.GetDropBonusResponse
	181, // 219: db.v1.SpawnRateService.SpawnRateVersion:output_type -> db.v1.SpawnRateVersionResponse
	183, // 220: db.v1.SpawnRateService.GetSpawnRates:output_type -> db.v1.GetSpawnRatesResponse
	186, // 221: db.v1.CombineRateService.CombineRateVersion:output_type -> db.v1.CombineRateVersionResponse
	188, // 222: db.v1.CombineRateService.GetCombineRates:output_type -> db.v1.GetCombineRatesResponse
	192, // 223: db.v1.CombatRuleService.CombatRuleVersion:output_type -> db.v1.CombatRuleVersionResponse
	194, // 224: db.v1.CombatRuleService.GetCombatRule:output_type -> db.v1.GetCombatRuleResponse
	196, // 225: db.v1.NpcGeneratorService.GeneratorOffVersion:output_type -> db.v1.GeneratorOffVersionResponse
	198, // 226: db.v1.NpcGeneratorService.GetGeneratorsOff:output_type -> db.v1.GetGeneratorsOffResponse
	201, // 227: db.v1.NpcGeneratorService.SetGeneratorOff:output_type -> db.v1.SetGeneratorOffResponse
	203, // 228: db.v1.DropRuleService.DropRuleVersion:output_type -> db.v1.DropRuleVersionResponse
	206, // 229: db.v1.DropRuleService.ListDropRules:output_type -> db.v1.ListDropRulesResponse
	144, // [144:230] is the sub-list for method output_type
	58,  // [58:144] is the sub-list for method input_type
...
func file_api_db_v1_db_proto_init() {
	...
	file_api_db_v1_db_proto_msgTypes[128].OneofWrappers = []any{}
	file_api_db_v1_db_proto_msgTypes[139].OneofWrappers = []any{}
	file_api_db_v1_db_proto_msgTypes[189].OneofWrappers = []any{}
	type x struct{}
