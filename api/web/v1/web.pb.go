...
const (
	...
	// CANCELED: closed without payment, because the buyer LEFT THE GAME.
	//
	// This one will happen for real, and often: people leave the game to pay on
...
const file_api_web_v1_web_proto_rawDesc = "" +
	...
	"\x04role\x18\x04 \x01(\tR\x04role\"\x83\x01\n" +
	...
	"\x12payout_wait_reason\x18\a \x01(\x0e2\x18.web.v1.PayoutWaitReasonR\x10payoutWaitReason\"=\n" +
	...
	"\frefund_state\x18\v \x01(\x0e2\x13.web.v1.RefundStateR\vrefundState\"\xba\x01\n" +
	...
	"\x13PIX_KEY_TYPE_RANDOM\x10\x04*\xc8\x01\n" +
	...
	"\x1dPIX_KEY_RESULT_INVALID_TAX_ID\x10\x05*\x7f\n" +
	...
	"\x12MARKET_SORT_NEWEST\x10\x03*\xa7\x01\n" +
	...
	"\x1aSYNCPAY_EVENT_KIND_CASHOUT\x10\x02*\xb2\x01\n" +
	...
	"\x11VerifyCredentials\x12 .web.v1.VerifyCredentialsRequest\x1a!.web.v1.VerifyCredentialsResponse2\xd9\x02\n" +
	"\rRmtWebService\x12C\n" +
	"\n" +
	"SavePixKey\x12\x19.web.v1.SavePixKeyRequest\x1a\x1a.web.v1.SavePixKeyResponse\x12@\n" +
	"\tGetPixKey\x12\x18.web.v1.GetPixKeyRequest\x1a\x19.web.v1.GetPixKeyResponse\x12d\n" +
...
var file_api_web_v1_web_proto_enumTypes = make([]protoimpl.EnumInfo, 19)
var file_api_web_v1_web_proto_msgTypes = make([]protoimpl.MessageInfo, 164)
var file_api_web_v1_web_proto_goTypes = []any{
	...
	(MarketCurrency)(0),                   // 3: web.v1.MarketCurrency
	(MarketSort)(0),                       // 4: web.v1.MarketSort
	(PayoutWaitReason)(0),                 // 5: web.v1.PayoutWaitReason
	(PixChargeState)(0),                   // 6: web.v1.PixChargeState
	(RefundState)(0),                      // 7: web.v1.RefundState
	(SyncpayEventKind)(0),                 // 8: web.v1.SyncpayEventKind
	(AdminResult)(0),                      // 9: web.v1.AdminResult
	(AttributeMapTransformOperation)(0),   // 10: web.v1.AttributeMapTransformOperation
	(BuyResult)(0),                        // 11: web.v1.BuyResult
	(ClaimResult)(0),                      // 12: web.v1.ClaimResult
	(PaymentMethod)(0),                    // 13: web.v1.PaymentMethod
	(TopupResult)(0),                      // 14: web.v1.TopupResult
	(AttachResult)(0),                     // 15: web.v1.AttachResult
	(TopupStatus)(0),                      // 16: web.v1.TopupStatus
	(RevenueBucket)(0),                    // 17: web.v1.RevenueBucket
	(DonateLedgerAction)(0),               // 18: web.v1.DonateLedgerAction
	(*CreateAccountRequest)(nil),          // 19: web.v1.CreateAccountRequest
	(*CreateAccountResponse)(nil),         // 20: web.v1.CreateAccountResponse
	(*VerifyCredentialsRequest)(nil),      // 21: web.v1.VerifyCredentialsRequest
	(*VerifyCredentialsResponse)(nil),     // 22: web.v1.VerifyCredentialsResponse
	(*SavePixKeyRequest)(nil),             // 23: web.v1.SavePixKeyRequest
	(*SavePixKeyResponse)(nil),            // 24: web.v1.SavePixKeyResponse
	(*ListMarketListingsRequest)(nil),     // 25: web.v1.ListMarketListingsRequest
	(*MarketListing)(nil),                 // 26: web.v1.MarketListing
	(*ListMarketListingsResponse)(nil),    // 27: web.v1.ListMarketListingsResponse
	(*GetPixKeyRequest)(nil),              // 28: web.v1.GetPixKeyRequest
	(*GetPixKeyResponse)(nil),             // 29: web.v1.GetPixKeyResponse
	(*GetMyCurrentPixChargeRequest)(nil),  // 30: web.v1.GetMyCurrentPixChargeRequest
	(*GetMyCurrentPixChargeResponse)(nil), // 31: web.v1.GetMyCurrentPixChargeResponse
	(*NotifySyncpayEventRequest)(nil),     // 32: web.v1.NotifySyncpayEventRequest
	(*NotifySyncpayEventResponse)(nil),    // 33: web.v1.NotifySyncpayEventResponse
	(*ListExpRankingRequest)(nil),         // 34: web.v1.ListExpRankingRequest
	(*RankingEntry)(nil),                  // 35: web.v1.RankingEntry
	(*ListExpRankingResponse)(nil),        // 36: web.v1.ListExpRankingResponse
	(*ListDuelRankingRequest)(nil),        // 37: web.v1.ListDuelRankingRequest
	(*DuelRankingEntry)(nil),              // 38: web.v1.DuelRankingEntry
	(*ListDuelRankingResponse)(nil),       // 39: web.v1.ListDuelRankingResponse
	(*ListMyCharactersRequest)(nil),       // 40: web.v1.ListMyCharactersRequest
	(*WebCharacterSummary)(nil),           // 41: web.v1.WebCharacterSummary
	(*ListMyCharactersResponse)(nil),      // 42: web.v1.ListMyCharactersResponse
	(*ListItemsRequest)(nil),              // 43: web.v1.ListItemsRequest
	(*ListItemsResponse)(nil),             // 44: web.v1.ListItemsResponse
	(*AdminAck)(nil),                      // 45: web.v1.AdminAck
	(*AdminNpcShopItem)(nil),              // 46: web.v1.AdminNpcShopItem
	(*AdminNpc)(nil),                      // 47: web.v1.AdminNpc
	(*ListNpcsRequest)(nil),               // 48: web.v1.ListNpcsRequest
	(*ListNpcsResponse)(nil),              // 49: web.v1.ListNpcsResponse
	(*GetNpcRequest)(nil),                 // 50: web.v1.GetNpcRequest
	(*GetNpcResponse)(nil),                // 51: web.v1.GetNpcResponse
	(*UpsertNpcRequest)(nil),              // 52: web.v1.UpsertNpcRequest
	(*UpsertNpcResponse)(nil),             // 53: web.v1.UpsertNpcResponse
	(*SetNpcVisibilityRequest)(nil),       // 54: web.v1.SetNpcVisibilityRequest
	(*SetNpcShopRequest)(nil),             // 55: web.v1.SetNpcShopRequest
	(*SetItemPriceRequest)(nil),           // 56: web.v1.SetItemPriceRequest
	(*DeleteNpcRequest)(nil),              // 57: web.v1.DeleteNpcRequest
	(*MerchantTemplate)(nil),              // 58: web.v1.MerchantTemplate
	(*ListMerchantTemplatesRequest)(nil),  // 59: web.v1.ListMerchantTemplatesRequest
	(*ListMerchantTemplatesResponse)(nil), // 60: web.v1.ListMerchantTemplatesResponse
	(*ItemCatalogEntry)(nil),              // 61: web.v1.ItemCatalogEntry
	(*ListItemCatalogRequest)(nil),        // 62: web.v1.ListItemCatalogRequest
	(*ListItemCatalogResponse)(nil),       // 63: web.v1.ListItemCatalogResponse
	(*DropItemMob)(nil),                   // 64: web.v1.DropItemMob
	(*DropItemEntry)(nil),                 // 65: web.v1.DropItemEntry
	(*ListDropItemsRequest)(nil),          // 66: web.v1.ListDropItemsRequest
	(*ListDropItemsResponse)(nil),         // 67: web.v1.ListDropItemsResponse
	(*MobDropItem)(nil),                   // 68: web.v1.MobDropItem
	(*MobDropEntry)(nil),                  // 69: web.v1.MobDropEntry
	(*ListMobDropsRequest)(nil),           // 70: web.v1.ListMobDropsRequest
	(*ListMobDropsResponse)(nil),          // 71: web.v1.ListMobDropsResponse
	(*ItemPrice)(nil),                     // 72: web.v1.ItemPrice
	(*ListItemPricesRequest)(nil),         // 73: web.v1.ListItemPricesRequest
	(*ListItemPricesResponse)(nil),        // 74: web.v1.ListItemPricesResponse
	(*MapZone)(nil),                       // 75: web.v1.MapZone
	(*ListMapZonesRequest)(nil),           // 76: web.v1.ListMapZonesRequest
	(*ListMapZonesResponse)(nil),          // 77: web.v1.ListMapZonesResponse
	(*MobTemplateFile)(nil),               // 78: web.v1.MobTemplateFile
	(*ListMobTemplatesRequest)(nil),       // 79: web.v1.ListMobTemplatesRequest
	(*ListMobTemplatesResponse)(nil),      // 80: web.v1.ListMobTemplatesResponse
	(*AdminMobTemplateEquipItem)(nil),     // 81: web.v1.AdminMobTemplateEquipItem
	(*AdminMobTemplateStat)(nil),          // 82: web.v1.AdminMobTemplateStat
	(*GetMobTemplateStatRequest)(nil),     // 83: web.v1.GetMobTemplateStatRequest
	(*GetMobTemplateStatResponse)(nil),    // 84: web.v1.GetMobTemplateStatResponse
	(*AdminMobOrigin)(nil),                // 85: web.v1.AdminMobOrigin
	(*UpsertMobTemplateStatRequest)(nil),  // 86: web.v1.UpsertMobTemplateStatRequest
	(*UpsertMobTemplateStatResponse)(nil), // 87: web.v1.UpsertMobTemplateStatResponse
	(*SetMobTemplateEquipRequest)(nil),    // 88: web.v1.SetMobTemplateEquipRequest
	(*DeleteMobTemplateStatRequest)(nil),  // 89: web.v1.DeleteMobTemplateStatRequest
	(*GetAttributeMapInfoRequest)(nil),    // 90: web.v1.GetAttributeMapInfoRequest
	(*GetAttributeMapInfoResponse)(nil),   // 91: web.v1.GetAttributeMapInfoResponse
	(*AttributeMapInfo)(nil),              // 92: web.v1.AttributeMapInfo
	(*AttributeMapValueCount)(nil),        // 93: web.v1.AttributeMapValueCount
	(*AttributeMapMeaning)(nil),           // 94: web.v1.AttributeMapMeaning
	(*AttributeMapRect)(nil),              // 95: web.v1.AttributeMapRect
	(*AttributeMapTransformFilter)(nil),   // 96: web.v1.AttributeMapTransformFilter
	(*TransformAttributeMapRequest)(nil),  // 97: web.v1.TransformAttributeMapRequest
	(*TransformAttributeMapResponse)(nil), // 98: web.v1.TransformAttributeMapResponse
	(*DonateShopItem)(nil),                // 99: web.v1.DonateShopItem
	(*ListShopItemsRequest)(nil),          // 100: web.v1.ListShopItemsRequest
	(*ListShopItemsResponse)(nil),         // 101: web.v1.ListShopItemsResponse
	(*UpsertShopItemRequest)(nil),         // 102: web.v1.UpsertShopItemRequest
	(*UpsertShopItemResponse)(nil),        // 103: web.v1.UpsertShopItemResponse
	(*SetShopItemEnabledRequest)(nil),     // 104: web.v1.SetShopItemEnabledRequest
	(*DeleteShopItemRequest)(nil),         // 105: web.v1.DeleteShopItemRequest
	(*CreditDonateBalanceRequest)(nil),    // 106: web.v1.CreditDonateBalanceRequest
	(*CreditDonateBalanceResponse)(nil),   // 107: web.v1.CreditDonateBalanceResponse
	(*ListStoreItemsRequest)(nil),         // 108: web.v1.ListStoreItemsRequest
	(*ListStoreItemsResponse)(nil),        // 109: web.v1.ListStoreItemsResponse
	(*GetBalanceRequest)(nil),             // 110: web.v1.GetBalanceRequest
	(*GetBalanceResponse)(nil),            // 111: web.v1.GetBalanceResponse
	(*BuyRequest)(nil),                    // 112: web.v1.BuyRequest
	(*BuyResponse)(nil),                   // 113: web.v1.BuyResponse
	(*DailyRewardItem)(nil),               // 114: web.v1.DailyRewardItem
	(*ListRewardItemsRequest)(nil),        // 115: web.v1.ListRewardItemsRequest
	(*ListRewardItemsResponse)(nil),       // 116: web.v1.ListRewardItemsResponse
	(*UpsertRewardItemRequest)(nil),       // 117: web.v1.UpsertRewardItemRequest
	(*UpsertRewardItemResponse)(nil),      // 118: web.v1.UpsertRewardItemResponse
	(*SetRewardItemEnabledRequest)(nil),   // 119: web.v1.SetRewardItemEnabledRequest
	(*DeleteRewardItemRequest)(nil),       // 120: web.v1.DeleteRewardItemRequest
	(*WorldEventConfig)(nil),              // 121: web.v1.WorldEventConfig
	(*GetWorldEventConfigRequest)(nil),    // 122: web.v1.GetWorldEventConfigRequest
	(*GetWorldEventConfigResponse)(nil),   // 123: web.v1.GetWorldEventConfigResponse
	(*SetWorldEventConfigRequest)(nil),    // 124: web.v1.SetWorldEventConfigRequest
	(*ListRewardsRequest)(nil),            // 125: web.v1.ListRewardsRequest
	(*ListRewardsResponse)(nil),           // 126: web.v1.ListRewardsResponse
	(*GetClaimStatusRequest)(nil),         // 127: web.v1.GetClaimStatusRequest
	(*GetClaimStatusResponse)(nil),        // 128: web.v1.GetClaimStatusResponse
	(*ClaimRequest)(nil),                  // 129: web.v1.ClaimRequest
	(*ClaimResponse)(nil),                 // 130: web.v1.ClaimResponse
	(*AttachTopupChargeRequest)(nil),      // 131: web.v1.AttachTopupChargeRequest
	(*AttachTopupChargeResponse)(nil),     // 132: web.v1.AttachTopupChargeResponse
	(*GetPayerProfileRequest)(nil),        // 133: web.v1.GetPayerProfileRequest
	(*GetPayerProfileResponse)(nil),       // 134: web.v1.GetPayerProfileResponse
	(*SavePayerProfileRequest)(nil),       // 135: web.v1.SavePayerProfileRequest
	(*SavePayerProfileResponse)(nil),      // 136: web.v1.SavePayerProfileResponse
	(*CreateTopupOrderRequest)(nil),       // 137: web.v1.CreateTopupOrderRequest
	(*CreateTopupOrderResponse)(nil),      // 138: web.v1.CreateTopupOrderResponse
	(*ConfirmTopupOrderRequest)(nil),      // 139: web.v1.ConfirmTopupOrderRequest
	(*ConfirmTopupOrderResponse)(nil),     // 140: web.v1.ConfirmTopupOrderResponse
	(*GetTopupOrderRequest)(nil),          // 141: web.v1.GetTopupOrderRequest
	(*GetTopupOrderResponse)(nil),         // 142: web.v1.GetTopupOrderResponse
	(*RevenueWindow)(nil),                 // 143: web.v1.RevenueWindow
	(*RevenueTotals)(nil),                 // 144: web.v1.RevenueTotals
	(*RevenueByMethod)(nil),               // 145: web.v1.RevenueByMethod
	(*RevenuePoint)(nil),                  // 146: web.v1.RevenuePoint
	(*GetRevenueSummaryRequest)(nil),      // 147: web.v1.GetRevenueSummaryRequest
	(*GetRevenueSummaryResponse)(nil),     // 148: web.v1.GetRevenueSummaryResponse
	(*TopupOrderRow)(nil),                 // 149: web.v1.TopupOrderRow
	(*ListTopupOrdersRequest)(nil),        // 150: web.v1.ListTopupOrdersRequest
	(*ListTopupOrdersResponse)(nil),       // 151: web.v1.ListTopupOrdersResponse
	(*TopBuyerRow)(nil),                   // 152: web.v1.TopBuyerRow
	(*ListTopBuyersRequest)(nil),          // 153: web.v1.ListTopBuyersRequest
	(*ListTopBuyersResponse)(nil),         // 154: web.v1.ListTopBuyersResponse
	(*DonateLedgerRow)(nil),               // 155: web.v1.DonateLedgerRow
	(*ListDonateSpendRequest)(nil),        // 156: web.v1.ListDonateSpendRequest
	(*ListDonateSpendResponse)(nil),       // 157: web.v1.ListDonateSpendResponse
	(*AccountSummary)(nil),                // 158: web.v1.AccountSummary
	(*SearchAccountsRequest)(nil),         // 159: web.v1.SearchAccountsRequest
	(*SearchAccountsResponse)(nil),        // 160: web.v1.SearchAccountsResponse
	(*AdminItemStat)(nil),                 // 161: web.v1.AdminItemStat
	(*GetItemStatRequest)(nil),            // 162: web.v1.GetItemStatRequest
	(*GetItemStatResponse)(nil),           // 163: web.v1.GetItemStatResponse
	(*UpsertItemStatRequest)(nil),         // 164: web.v1.UpsertItemStatRequest
	(*DeleteItemStatRequest)(nil),         // 165: web.v1.DeleteItemStatRequest
	(*AdminMountGrowthCurve)(nil),         // 166: web.v1.AdminMountGrowthCurve
	(*ListMountGrowthCurvesRequest)(nil),  // 167: web.v1.ListMountGrowthCurvesRequest
	(*ListMountGrowthCurvesResponse)(nil), // 168: web.v1.ListMountGrowthCurvesResponse
	(*SetMountGrowthCurveRequest)(nil),    // 169: web.v1.SetMountGrowthCurveRequest
	(*ClearMountGrowthCurveRequest)(nil),  // 170: web.v1.ClearMountGrowthCurveRequest
	(*AdminMountAbsorb)(nil),              // 171: web.v1.AdminMountAbsorb
	(*MountConfigVersionRequest)(nil),     // 172: web.v1.MountConfigVersionRequest
	(*MountConfigVersionResponse)(nil),    // 173: web.v1.MountConfigVersionResponse
	(*ListMountAbsorbRequest)(nil),        // 174: web.v1.ListMountAbsorbRequest
	(*ListMountAbsorbResponse)(nil),       // 175: web.v1.ListMountAbsorbResponse
	(*SetMountAbsorbRequest)(nil),         // 176: web.v1.SetMountAbsorbRequest
	(*ClearMountAbsorbRequest)(nil),       // 177: web.v1.ClearMountAbsorbRequest
	(*AdminMountBonus)(nil),               // 178: web.v1.AdminMountBonus
	(*ListMountBonusRequest)(nil),         // 179: web.v1.ListMountBonusRequest
	(*ListMountBonusResponse)(nil),        // 180: web.v1.ListMountBonusResponse
	(*SetMountBonusRequest)(nil),          // 181: web.v1.SetMountBonusRequest
	(*ClearMountBonusRequest)(nil),        // 182: web.v1.ClearMountBonusRequest
}
var file_api_web_v1_web_proto_depIdxs = []int32{
	0,   // 0: web.v1.CreateAccountResponse.result:type_name -> web.v1.CreateResult
	1,   // 1: web.v1.SavePixKeyRequest.type:type_name -> web.v1.PixKeyType
	2,   // 2: web.v1.SavePixKeyResponse.result:type_name -> web.v1.PixKeyResult
	3,   // 3: web.v1.ListMarketListingsRequest.currency:type_name -> web.v1.MarketCurrency
	4,   // 4: web.v1.ListMarketListingsRequest.sort:type_name -> web.v1.MarketSort
	3,   // 5: web.v1.MarketListing.currency:type_name -> web.v1.MarketCurrency
	26,  // 6: web.v1.ListMarketListingsResponse.listings:type_name -> web.v1.MarketListing
	1,   // 7: web.v1.GetPixKeyResponse.type:type_name -> web.v1.PixKeyType
	5,   // 8: web.v1.GetPixKeyResponse.payout_wait_reason:type_name -> web.v1.PayoutWaitReason
	6,   // 9: web.v1.GetMyCurrentPixChargeResponse.state:type_name -> web.v1.PixChargeState
	7,   // 10: web.v1.GetMyCurrentPixChargeResponse.refund_state:type_name -> web.v1.RefundState
	8,   // 11: web.v1.NotifySyncpayEventRequest.kind:type_name -> web.v1.SyncpayEventKind
	35,  // 12: web.v1.ListExpRankingResponse.entries:type_name -> web.v1.RankingEntry
	38,  // 13: web.v1.ListDuelRankingResponse.entries:type_name -> web.v1.DuelRankingEntry
	41,  // 14: web.v1.ListMyCharactersResponse.characters:type_name -> web.v1.WebCharacterSummary
	61,  // 15: web.v1.ListItemsResponse.items:type_name -> web.v1.ItemCatalogEntry
	9,   // 16: web.v1.AdminAck.result:type_name -> web.v1.AdminResult
	46,  // 17: web.v1.AdminNpc.shop:type_name -> web.v1.AdminNpcShopItem
	9,   // 18: web.v1.ListNpcsResponse.result:type_name -> web.v1.AdminResult
	47,  // 19: web.v1.ListNpcsResponse.npcs:type_name -> web.v1.AdminNpc
	9,   // 20: web.v1.GetNpcResponse.result:type_name -> web.v1.AdminResult
	47,  // 21: web.v1.GetNpcResponse.npc:type_name -> web.v1.AdminNpc
	9,   // 22: web.v1.UpsertNpcResponse.result:type_name -> web.v1.AdminResult
	46,  // 23: web.v1.SetNpcShopRequest.items:type_name -> web.v1.AdminNpcShopItem
	9,   // 24: web.v1.ListMerchantTemplatesResponse.result:type_name -> web.v1.AdminResult
	58,  // 25: web.v1.ListMerchantTemplatesResponse.templates:type_name -> web.v1.MerchantTemplate
	9,   // 26: web.v1.ListItemCatalogResponse.result:type_name -> web.v1.AdminResult
	61,  // 27: web.v1.ListItemCatalogResponse.items:type_name -> web.v1.ItemCatalogEntry
	85,  // 28: web.v1.DropItemMob.origins:type_name -> web.v1.AdminMobOrigin
	64,  // 29: web.v1.DropItemEntry.mobs:type_name -> web.v1.DropItemMob
	9,   // 30: web.v1.ListDropItemsResponse.result:type_name -> web.v1.AdminResult
	65,  // 31: web.v1.ListDropItemsResponse.items:type_name -> web.v1.DropItemEntry
	68,  // 32: web.v1.MobDropEntry.items:type_name -> web.v1.MobDropItem
	9,   // 33: web.v1.ListMobDropsResponse.result:type_name -> web.v1.AdminResult
	69,  // 34: web.v1.ListMobDropsResponse.mobs:type_name -> web.v1.MobDropEntry
	9,   // 35: web.v1.ListItemPricesResponse.result:type_name -> web.v1.AdminResult
	72,  // 36: web.v1.ListItemPricesResponse.prices:type_name -> web.v1.ItemPrice
	9,   // 37: web.v1.ListMapZonesResponse.result:type_name -> web.v1.AdminResult
	75,  // 38: web.v1.ListMapZonesResponse.zones:type_name -> web.v1.MapZone
	9,   // 39: web.v1.ListMobTemplatesResponse.result:type_name -> web.v1.AdminResult
	78,  // 40: web.v1.ListMobTemplatesResponse.templates:type_name -> web.v1.MobTemplateFile
	81,  // 41: web.v1.AdminMobTemplateStat.equip:type_name -> web.v1.AdminMobTemplateEquipItem
	9,   // 42: web.v1.GetMobTemplateStatResponse.result:type_name -> web.v1.AdminResult
	82,  // 43: web.v1.GetMobTemplateStatResponse.stat:type_name -> web.v1.AdminMobTemplateStat
	82,  // 44: web.v1.GetMobTemplateStatResponse.file_stat:type_name -> web.v1.AdminMobTemplateStat
	85,  // 45: web.v1.GetMobTemplateStatResponse.origins:type_name -> web.v1.AdminMobOrigin
	82,  // 46: web.v1.UpsertMobTemplateStatRequest.stat:type_name -> web.v1.AdminMobTemplateStat
	9,   // 47: web.v1.UpsertMobTemplateStatResponse.result:type_name -> web.v1.AdminResult
	81,  // 48: web.v1.SetMobTemplateEquipRequest.items:type_name -> web.v1.AdminMobTemplateEquipItem
	9,   // 49: web.v1.GetAttributeMapInfoResponse.result:type_name -> web.v1.AdminResult
	92,  // 50: web.v1.GetAttributeMapInfoResponse.info:type_name -> web.v1.AttributeMapInfo
	93,  // 51: web.v1.AttributeMapInfo.histogram:type_name -> web.v1.AttributeMapValueCount
	94,  // 52: web.v1.AttributeMapInfo.meanings:type_name -> web.v1.AttributeMapMeaning
	10,  // 53: web.v1.TransformAttributeMapRequest.operation:type_name -> web.v1.AttributeMapTransformOperation
	95,  // 54: web.v1.TransformAttributeMapRequest.rect:type_name -> web.v1.AttributeMapRect
	96,  // 55: web.v1.TransformAttributeMapRequest.filter:type_name -> web.v1.AttributeMapTransformFilter
	9,   // 56: web.v1.TransformAttributeMapResponse.result:type_name -> web.v1.AdminResult
	93,  // 57: web.v1.TransformAttributeMapResponse.before_histogram:type_name -> web.v1.AttributeMapValueCount
	93,  // 58: web.v1.TransformAttributeMapResponse.after_histogram:type_name -> web.v1.AttributeMapValueCount
	9,   // 59: web.v1.ListShopItemsResponse.result:type_name -> web.v1.AdminResult
	99,  // 60: web.v1.ListShopItemsResponse.items:type_name -> web.v1.DonateShopItem
	99,  // 61: web.v1.UpsertShopItemRequest.item:type_name -> web.v1.DonateShopItem
	9,   // 62: web.v1.UpsertShopItemResponse.result:type_name -> web.v1.AdminResult
	9,   // 63: web.v1.CreditDonateBalanceResponse.result:type_name -> web.v1.AdminResult
	99,  // 64: web.v1.ListStoreItemsResponse.items:type_name -> web.v1.DonateShopItem
	11,  // 65: web.v1.BuyResponse.result:type_name -> web.v1.BuyResult
	9,   // 66: web.v1.ListRewardItemsResponse.result:type_name -> web.v1.AdminResult
	114, // 67: web.v1.ListRewardItemsResponse.items:type_name -> web.v1.DailyRewardItem
	114, // 68: web.v1.UpsertRewardItemRequest.item:type_name -> web.v1.DailyRewardItem
	9,   // 69: web.v1.UpsertRewardItemResponse.result:type_name -> web.v1.AdminResult
	9,   // 70: web.v1.GetWorldEventConfigResponse.result:type_name -> web.v1.AdminResult
	121, // 71: web.v1.GetWorldEventConfigResponse.config:type_name -> web.v1.WorldEventConfig
	121, // 72: web.v1.SetWorldEventConfigRequest.config:type_name -> web.v1.WorldEventConfig
	114, // 73: web.v1.ListRewardsResponse.items:type_name -> web.v1.DailyRewardItem
	12,  // 74: web.v1.ClaimResponse.result:type_name -> web.v1.ClaimResult
	15,  // 75: web.v1.AttachTopupChargeResponse.result:type_name -> web.v1.AttachResult
	9,   // 76: web.v1.SavePayerProfileResponse.result:type_name -> web.v1.AdminResult
	13,  // 77: web.v1.CreateTopupOrderRequest.payment_method:type_name -> web.v1.PaymentMethod
	9,   // 78: web.v1.CreateTopupOrderResponse.result:type_name -> web.v1.AdminResult
	14,  // 79: web.v1.ConfirmTopupOrderResponse.result:type_name -> web.v1.TopupResult
	16,  // 80: web.v1.GetTopupOrderResponse.status:type_name -> web.v1.TopupStatus
	13,  // 81: web.v1.RevenueByMethod.payment_method:type_name -> web.v1.PaymentMethod
	143, // 82: web.v1.GetRevenueSummaryRequest.window:type_name -> web.v1.RevenueWindow
	17,  // 83: web.v1.GetRevenueSummaryRequest.bucket:type_name -> web.v1.RevenueBucket
	9,   // 84: web.v1.GetRevenueSummaryResponse.result:type_name -> web.v1.AdminResult
	144, // 85: web.v1.GetRevenueSummaryResponse.totals:type_name -> web.v1.RevenueTotals
	145, // 86: web.v1.GetRevenueSummaryResponse.by_method:type_name -> web.v1.RevenueByMethod
	146, // 87: web.v1.GetRevenueSummaryResponse.series:type_name -> web.v1.RevenuePoint
	13,  // 88: web.v1.TopupOrderRow.payment_method:type_name -> web.v1.PaymentMethod
	16,  // 89: web.v1.TopupOrderRow.status:type_name -> web.v1.TopupStatus
	143, // 90: web.v1.ListTopupOrdersRequest.window:type_name -> web.v1.RevenueWindow
	16,  // 91: web.v1.ListTopupOrdersRequest.status:type_name -> web.v1.TopupStatus
	13,  // 92: web.v1.ListTopupOrdersRequest.payment_method:type_name -> web.v1.PaymentMethod
	9,   // 93: web.v1.ListTopupOrdersResponse.result:type_name -> web.v1.AdminResult
	149, // 94: web.v1.ListTopupOrdersResponse.orders:type_name -> web.v1.TopupOrderRow
	143, // 95: web.v1.ListTopBuyersRequest.window:type_name -> web.v1.RevenueWindow
	9,   // 96: web.v1.ListTopBuyersResponse.result:type_name -> web.v1.AdminResult
	152, // 97: web.v1.ListTopBuyersResponse.buyers:type_name -> web.v1.TopBuyerRow
	18,  // 98: web.v1.DonateLedgerRow.action:type_name -> web.v1.DonateLedgerAction
	143, // 99: web.v1.ListDonateSpendRequest.window:type_name -> web.v1.RevenueWindow
	18,  // 100: web.v1.ListDonateSpendRequest.action:type_name -> web.v1.DonateLedgerAction
	9,   // 101: web.v1.ListDonateSpendResponse.result:type_name -> web.v1.AdminResult
	155, // 102: web.v1.ListDonateSpendResponse.entries:type_name -> web.v1.DonateLedgerRow
	9,   // 103: web.v1.SearchAccountsResponse.result:type_name -> web.v1.AdminResult
	158, // 104: web.v1.SearchAccountsResponse.accounts:type_name -> web.v1.AccountSummary
	9,   // 105: web.v1.GetItemStatResponse.result:type_name -> web.v1.AdminResult
	161, // 106: web.v1.GetItemStatResponse.stat:type_name -> web.v1.AdminItemStat
	161, // 107: web.v1.UpsertItemStatRequest.stat:type_name -> web.v1.AdminItemStat
	166, // 108: web.v1.ListMountGrowthCurvesResponse.curves:type_name -> web.v1.AdminMountGrowthCurve
	171, // 109: web.v1.ListMountAbsorbResponse.absorb:type_name -> web.v1.AdminMountAbsorb
	178, // 110: web.v1.ListMountBonusResponse.bonus:type_name -> web.v1.AdminMountBonus
	19,  // 111: web.v1.AccountWebService.CreateAccount:input_type -> web.v1.CreateAccountRequest
	21,  // 112: web.v1.AccountWebService.VerifyCredentials:input_type -> web.v1.VerifyCredentialsRequest
	23,  // 113: web.v1.RmtWebService.SavePixKey:input_type -> web.v1.SavePixKeyRequest
	28,  // 114: web.v1.RmtWebService.GetPixKey:input_type -> web.v1.GetPixKeyRequest
	30,  // 115: web.v1.RmtWebService.GetMyCurrentPixCharge:input_type -> web.v1.GetMyCurrentPixChargeRequest
	25,  // 116: web.v1.RmtWebService.ListMarketListings:input_type -> web.v1.ListMarketListingsRequest
	32,  // 117: web.v1.RmtSystemService.NotifySyncpayEvent:input_type -> web.v1.NotifySyncpayEventRequest
	34,  // 118: web.v1.RankingWebService.ListExpRanking:input_type -> web.v1.ListExpRankingRequest
	37,  // 119: web.v1.RankingWebService.ListDuelRanking:input_type -> web.v1.ListDuelRankingRequest
	40,  // 120: web.v1.CharacterWebService.ListMyCharacters:input_type -> web.v1.ListMyCharactersRequest
	43,  // 121: web.v1.ItemCatalogService.ListItems:input_type -> web.v1.ListItemsRequest
	48,  // 122: web.v1.NpcAdminService.ListNpcs:input_type -> web.v1.ListNpcsRequest
	50,  // 123: web.v1.NpcAdminService.GetNpc:input_type -> web.v1.GetNpcRequest
	52,  // 124: web.v1.NpcAdminService.UpsertNpc:input_type -> web.v1.UpsertNpcRequest
	54,  // 125: web.v1.NpcAdminService.SetNpcVisibility:input_type -> web.v1.SetNpcVisibilityRequest
	55,  // 126: web.v1.NpcAdminService.SetNpcShop:input_type -> web.v1.SetNpcShopRequest
	56,  // 127: web.v1.NpcAdminService.SetItemPrice:input_type -> web.v1.SetItemPriceRequest
	57,  // 128: web.v1.NpcAdminService.DeleteNpc:input_type -> web.v1.DeleteNpcRequest
	59,  // 129: web.v1.NpcAdminService.ListMerchantTemplates:input_type -> web.v1.ListMerchantTemplatesRequest
	62,  // 130: web.v1.NpcAdminService.ListItemCatalog:input_type -> web.v1.ListItemCatalogRequest
	66,  // 131: web.v1.NpcAdminService.ListDropItems:input_type -> web.v1.ListDropItemsRequest
	70,  // 132: web.v1.NpcAdminService.ListMobDrops:input_type -> web.v1.ListMobDropsRequest
	73,  // 133: web.v1.NpcAdminService.ListItemPrices:input_type -> web.v1.ListItemPricesRequest
	76,  // 134: web.v1.NpcAdminService.ListMapZones:input_type -> web.v1.ListMapZonesRequest
	79,  // 135: web.v1.MobTemplateAdminService.ListMobTemplates:input_type -> web.v1.ListMobTemplatesRequest
	83,  // 136: web.v1.MobTemplateAdminService.GetMobTemplateStat:input_type -> web.v1.GetMobTemplateStatRequest
	86,  // 137: web.v1.MobTemplateAdminService.UpsertMobTemplateStat:input_type -> web.v1.UpsertMobTemplateStatRequest
	88,  // 138: web.v1.MobTemplateAdminService.SetMobTemplateEquip:input_type -> web.v1.SetMobTemplateEquipRequest
	89,  // 139: web.v1.MobTemplateAdminService.DeleteMobTemplateStat:input_type -> web.v1.DeleteMobTemplateStatRequest
	90,  // 140: web.v1.AttributeMapAdminService.GetAttributeMapInfo:input_type -> web.v1.GetAttributeMapInfoRequest
	97,  // 141: web.v1.AttributeMapAdminService.TransformAttributeMap:input_type -> web.v1.TransformAttributeMapRequest
	100, // 142: web.v1.DonateAdminService.ListShopItems:input_type -> web.v1.ListShopItemsRequest
	102, // 143: web.v1.DonateAdminService.UpsertShopItem:input_type -> web.v1.UpsertShopItemRequest
	104, // 144: web.v1.DonateAdminService.SetShopItemEnabled:input_type -> web.v1.SetShopItemEnabledRequest
	105, // 145: web.v1.DonateAdminService.DeleteShopItem:input_type -> web.v1.DeleteShopItemRequest
	106, // 146: web.v1.DonateAdminService.CreditDonateBalance:input_type -> web.v1.CreditDonateBalanceRequest
	108, // 147: web.v1.DonateShopService.ListShopItems:input_type -> web.v1.ListStoreItemsRequest
	110, // 148: web.v1.DonateShopService.GetBalance:input_type -> web.v1.GetBalanceRequest
	112, // 149: web.v1.DonateShopService.Buy:input_type -> web.v1.BuyRequest
	115, // 150: web.v1.DailyRewardAdminService.ListRewardItems:input_type -> web.v1.ListRewardItemsRequest
	117, // 151: web.v1.DailyRewardAdminService.UpsertRewardItem:input_type -> web.v1.UpsertRewardItemRequest
	119, // 152: web.v1.DailyRewardAdminService.SetRewardItemEnabled:input_type -> web.v1.SetRewardItemEnabledRequest
	120, // 153: web.v1.DailyRewardAdminService.DeleteRewardItem:input_type -> web.v1.DeleteRewardItemRequest
	122, // 154: web.v1.WorldEventAdminService.GetWorldEventConfig:input_type -> web.v1.GetWorldEventConfigRequest
	124, // 155: web.v1.WorldEventAdminService.SetWorldEventConfig:input_type -> web.v1.SetWorldEventConfigRequest
	125, // 156: web.v1.DailyRewardService.ListRewards:input_type -> web.v1.ListRewardsRequest
	127, // 157: web.v1.DailyRewardService.GetClaimStatus:input_type -> web.v1.GetClaimStatusRequest
	129, // 158: web.v1.DailyRewardService.Claim:input_type -> web.v1.ClaimRequest
	133, // 159: web.v1.DonateTopupService.GetPayerProfile:input_type -> web.v1.GetPayerProfileRequest
	135, // 160: web.v1.DonateTopupService.SavePayerProfile:input_type -> web.v1.SavePayerProfileRequest
	137, // 161: web.v1.DonateTopupService.CreateTopupOrder:input_type -> web.v1.CreateTopupOrderRequest
	139, // 162: web.v1.DonateTopupService.ConfirmTopupOrder:input_type -> web.v1.ConfirmTopupOrderRequest
	141, // 163: web.v1.DonateTopupService.GetTopupOrder:input_type -> web.v1.GetTopupOrderRequest
	131, // 164: web.v1.DonateTopupService.AttachTopupCharge:input_type -> web.v1.AttachTopupChargeRequest
	147, // 165: web.v1.DonateRevenueAdminService.GetRevenueSummary:input_type -> web.v1.GetRevenueSummaryRequest
	150, // 166: web.v1.DonateRevenueAdminService.ListTopupOrders:input_type -> web.v1.ListTopupOrdersRequest
	153, // 167: web.v1.DonateRevenueAdminService.ListTopBuyers:input_type -> web.v1.ListTopBuyersRequest
	156, // 168: web.v1.DonateRevenueAdminService.ListDonateSpend:input_type -> web.v1.ListDonateSpendRequest
	159, // 169: web.v1.DonateRevenueAdminService.SearchAccounts:input_type -> web.v1.SearchAccountsRequest
	162, // 170: web.v1.ItemStatAdminService.GetItemStat:input_type -> web.v1.GetItemStatRequest
	164, // 171: web.v1.ItemStatAdminService.UpsertItemStat:input_type -> web.v1.UpsertItemStatRequest
	165, // 172: web.v1.ItemStatAdminService.DeleteItemStat:input_type -> web.v1.DeleteItemStatRequest
	167, // 173: web.v1.MountGrowthAdminService.ListMountGrowthCurves:input_type -> web.v1.ListMountGrowthCurvesRequest
	169, // 174: web.v1.MountGrowthAdminService.SetMountGrowthCurve:input_type -> web.v1.SetMountGrowthCurveRequest
	170, // 175: web.v1.MountGrowthAdminService.ClearMountGrowthCurve:input_type -> web.v1.ClearMountGrowthCurveRequest
	174, // 176: web.v1.MountGrowthAdminService.ListMountAbsorb:input_type -> web.v1.ListMountAbsorbRequest
	176, // 177: web.v1.MountGrowthAdminService.SetMountAbsorb:input_type -> web.v1.SetMountAbsorbRequest
	177, // 178: web.v1.MountGrowthAdminService.ClearMountAbsorb:input_type -> web.v1.ClearMountAbsorbRequest
	179, // 179: web.v1.MountGrowthAdminService.ListMountBonus:input_type -> web.v1.ListMountBonusRequest
	181, // 180: web.v1.MountGrowthAdminService.SetMountBonus:input_type -> web.v1.SetMountBonusRequest
	182, // 181: web.v1.MountGrowthAdminService.ClearMountBonus:input_type -> web.v1.ClearMountBonusRequest
	172, // 182: web.v1.MountGrowthAdminService.MountConfigVersion:input_type -> web.v1.MountConfigVersionRequest
	20,  // 183: web.v1.AccountWebService.CreateAccount:output_type -> web.v1.CreateAccountResponse
	22,  // 184: web.v1.AccountWebService.VerifyCredentials:output_type -> web.v1.VerifyCredentialsResponse
	24,  // 185: web.v1.RmtWebService.SavePixKey:output_type -> web.v1.SavePixKeyResponse
	29,  // 186: web.v1.RmtWebService.GetPixKey:output_type -> web.v1.GetPixKeyResponse
	31,  // 187: web.v1.RmtWebService.GetMyCurrentPixCharge:output_type -> web.v1.GetMyCurrentPixChargeResponse
	27,  // 188: web.v1.RmtWebService.ListMarketListings:output_type -> web.v1.ListMarketListingsResponse
	33,  // 189: web.v1.RmtSystemService.NotifySyncpayEvent:output_type -> web.v1.NotifySyncpayEventResponse
	36,  // 190: web.v1.RankingWebService.ListExpRanking:output_type -> web.v1.ListExpRankingResponse
	39,  // 191: web.v1.RankingWebService.ListDuelRanking:output_type -> web.v1.ListDuelRankingResponse
	42,  // 192: web.v1.CharacterWebService.ListMyCharacters:output_type -> web.v1.ListMyCharactersResponse
	44,  // 193: web.v1.ItemCatalogService.ListItems:output_type -> web.v1.ListItemsResponse
	49,  // 194: web.v1.NpcAdminService.ListNpcs:output_type -> web.v1.ListNpcsResponse
	51,  // 195: web.v1.NpcAdminService.GetNpc:output_type -> web.v1.GetNpcResponse
	53,  // 196: web.v1.NpcAdminService.UpsertNpc:output_type -> web.v1.UpsertNpcResponse
	45,  // 197: web.v1.NpcAdminService.SetNpcVisibility:output_type -> web.v1.AdminAck
	45,  // 198: web.v1.NpcAdminService.SetNpcShop:output_type -> web.v1.AdminAck
	45,  // 199: web.v1.NpcAdminService.SetItemPrice:output_type -> web.v1.AdminAck
	45,  // 200: web.v1.NpcAdminService.DeleteNpc:output_type -> web.v1.AdminAck
	60,  // 201: web.v1.NpcAdminService.ListMerchantTemplates:output_type -> web.v1.ListMerchantTemplatesResponse
	63,  // 202: web.v1.NpcAdminService.ListItemCatalog:output_type -> web.v1.ListItemCatalogResponse
	67,  // 203: web.v1.NpcAdminService.ListDropItems:output_type -> web.v1.ListDropItemsResponse
	71,  // 204: web.v1.NpcAdminService.ListMobDrops:output_type -> web.v1.ListMobDropsResponse
	74,  // 205: web.v1.NpcAdminService.ListItemPrices:output_type -> web.v1.ListItemPricesResponse
	77,  // 206: web.v1.NpcAdminService.ListMapZones:output_type -> web.v1.ListMapZonesResponse
	80,  // 207: web.v1.MobTemplateAdminService.ListMobTemplates:output_type -> web.v1.ListMobTemplatesResponse
	84,  // 208: web.v1.MobTemplateAdminService.GetMobTemplateStat:output_type -> web.v1.GetMobTemplateStatResponse
	87,  // 209: web.v1.MobTemplateAdminService.UpsertMobTemplateStat:output_type -> web.v1.UpsertMobTemplateStatResponse
	45,  // 210: web.v1.MobTemplateAdminService.SetMobTemplateEquip:output_type -> web.v1.AdminAck
	45,  // 211: web.v1.MobTemplateAdminService.DeleteMobTemplateStat:output_type -> web.v1.AdminAck
	91,  // 212: web.v1.AttributeMapAdminService.GetAttributeMapInfo:output_type -> web.v1.GetAttributeMapInfoResponse
	98,  // 213: web.v1.AttributeMapAdminService.TransformAttributeMap:output_type -> web.v1.TransformAttributeMapResponse
	101, // 214: web.v1.DonateAdminService.ListShopItems:output_type -> web.v1.ListShopItemsResponse
	103, // 215: web.v1.DonateAdminService.UpsertShopItem:output_type -> web.v1.UpsertShopItemResponse
	45,  // 216: web.v1.DonateAdminService.SetShopItemEnabled:output_type -> web.v1.AdminAck
	45,  // 217: web.v1.DonateAdminService.DeleteShopItem:output_type -> web.v1.AdminAck
	107, // 218: web.v1.DonateAdminService.CreditDonateBalance:output_type -> web.v1.CreditDonateBalanceResponse
	109, // 219: web.v1.DonateShopService.ListShopItems:output_type -> web.v1.ListStoreItemsResponse
	111, // 220: web.v1.DonateShopService.GetBalance:output_type -> web.v1.GetBalanceResponse
	113, // 221: web.v1.DonateShopService.Buy:output_type -> web.v1.BuyResponse
	116, // 222: web.v1.DailyRewardAdminService.ListRewardItems:output_type -> web.v1.ListRewardItemsResponse
	118, // 223: web.v1.DailyRewardAdminService.UpsertRewardItem:output_type -> web.v1.UpsertRewardItemResponse
	45,  // 224: web.v1.DailyRewardAdminService.SetRewardItemEnabled:output_type -> web.v1.AdminAck
	45,  // 225: web.v1.DailyRewardAdminService.DeleteRewardItem:output_type -> web.v1.AdminAck
	123, // 226: web.v1.WorldEventAdminService.GetWorldEventConfig:output_type -> web.v1.GetWorldEventConfigResponse
	45,  // 227: web.v1.WorldEventAdminService.SetWorldEventConfig:output_type -> web.v1.AdminAck
	126, // 228: web.v1.DailyRewardService.ListRewards:output_type -> web.v1.ListRewardsResponse
	128, // 229: web.v1.DailyRewardService.GetClaimStatus:output_type -> web.v1.GetClaimStatusResponse
	130, // 230: web.v1.DailyRewardService.Claim:output_type -> web.v1.ClaimResponse
	134, // 231: web.v1.DonateTopupService.GetPayerProfile:output_type -> web.v1.GetPayerProfileResponse
	136, // 232: web.v1.DonateTopupService.SavePayerProfile:output_type -> web.v1.SavePayerProfileResponse
	138, // 233: web.v1.DonateTopupService.CreateTopupOrder:output_type -> web.v1.CreateTopupOrderResponse
	140, // 234: web.v1.DonateTopupService.ConfirmTopupOrder:output_type -> web.v1.ConfirmTopupOrderResponse
	142, // 235: web.v1.DonateTopupService.GetTopupOrder:output_type -> web.v1.GetTopupOrderResponse
	132, // 236: web.v1.DonateTopupService.AttachTopupCharge:output_type -> web.v1.AttachTopupChargeResponse
	148, // 237: web.v1.DonateRevenueAdminService.GetRevenueSummary:output_type -> web.v1.GetRevenueSummaryResponse
	151, // 238: web.v1.DonateRevenueAdminService.ListTopupOrders:output_type -> web.v1.ListTopupOrdersResponse
	154, // 239: web.v1.DonateRevenueAdminService.ListTopBuyers:output_type -> web.v1.ListTopBuyersResponse
	157, // 240: web.v1.DonateRevenueAdminService.ListDonateSpend:output_type -> web.v1.ListDonateSpendResponse
	160, // 241: web.v1.DonateRevenueAdminService.SearchAccounts:output_type -> web.v1.SearchAccountsResponse
	163, // 242: web.v1.ItemStatAdminService.GetItemStat:output_type -> web.v1.GetItemStatResponse
	45,  // 243: web.v1.ItemStatAdminService.UpsertItemStat:output_type -> web.v1.AdminAck
	45,  // 244: web.v1.ItemStatAdminService.DeleteItemStat:output_type -> web.v1.AdminAck
	168, // 245: web.v1.MountGrowthAdminService.ListMountGrowthCurves:output_type -> web.v1.ListMountGrowthCurvesResponse
	45,  // 246: web.v1.MountGrowthAdminService.SetMountGrowthCurve:output_type -> web.v1.AdminAck
	45,  // 247: web.v1.MountGrowthAdminService.ClearMountGrowthCurve:output_type -> web.v1.AdminAck
	175, // 248: web.v1.MountGrowthAdminService.ListMountAbsorb:output_type -> web.v1.ListMountAbsorbResponse
	45,  // 249: web.v1.MountGrowthAdminService.SetMountAbsorb:output_type -> web.v1.AdminAck
	45,  // 250: web.v1.MountGrowthAdminService.ClearMountAbsorb:output_type -> web.v1.AdminAck
	180, // 251: web.v1.MountGrowthAdminService.ListMountBonus:output_type -> web.v1.ListMountBonusResponse
	45,  // 252: web.v1.MountGrowthAdminService.SetMountBonus:output_type -> web.v1.AdminAck
	45,  // 253: web.v1.MountGrowthAdminService.ClearMountBonus:output_type -> web.v1.AdminAck
	173, // 254: web.v1.MountGrowthAdminService.MountConfigVersion:output_type -> web.v1.MountConfigVersionResponse
...
func file_api_web_v1_web_proto_init() {
	...
	file_api_web_v1_web_proto_msgTypes[27].OneofWrappers = []any{}
	file_api_web_v1_web_proto_msgTypes[102].OneofWrappers = []any{}
	type x struct{}
