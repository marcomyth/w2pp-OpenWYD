...
type DiscordLinkResult int32

const (
	DiscordLinkResult_DISCORD_LINK_RESULT_UNSPECIFIED DiscordLinkResult = 0
	DiscordLinkResult_DISCORD_LINK_RESULT_OK          DiscordLinkResult = 1
	...
	DiscordLinkResult_DISCORD_LINK_RESULT_ALREADY_LINKED_ELSEWHERE DiscordLinkResult = 2
	// INVALID: nao e um snowflake numerico.
	DiscordLinkResult_DISCORD_LINK_RESULT_INVALID DiscordLinkResult = 3
	// ACCOUNT_HAS_ANOTHER: esta conta ja tem OUTRO Discord. So a staff desfaz.
	DiscordLinkResult_DISCORD_LINK_RESULT_ACCOUNT_HAS_ANOTHER DiscordLinkResult = 4
)

// Enum value maps for DiscordLinkResult.
var (
	DiscordLinkResult_name = map[int32]string{
		0: "DISCORD_LINK_RESULT_UNSPECIFIED",
		1: "DISCORD_LINK_RESULT_OK",
		2: "DISCORD_LINK_RESULT_ALREADY_LINKED_ELSEWHERE",
		3: "DISCORD_LINK_RESULT_INVALID",
		4: "DISCORD_LINK_RESULT_ACCOUNT_HAS_ANOTHER",
	}
	DiscordLinkResult_value = map[string]int32{
...
func (x DiscordLinkResult) Enum() *DiscordLinkResult {
	p := new(DiscordLinkResult)
	*p = x
	return p
}

func (x DiscordLinkResult) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DiscordLinkResult) Descriptor() protoreflect.EnumDescriptor {
	return file_api_web_v1_web_proto_enumTypes[1].Descriptor()
}

func (DiscordLinkResult) Type() protoreflect.EnumType {
	return &file_api_web_v1_web_proto_enumTypes[1]
}

func (x DiscordLinkResult) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DiscordLinkResult.Descriptor instead.
func (DiscordLinkResult) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	PixKeyType_PIX_KEY_TYPE_EMAIL       PixKeyType = 2
	PixKeyType_PIX_KEY_TYPE_PHONE       PixKeyType = 3
	PixKeyType_PIX_KEY_TYPE_RANDOM      PixKeyType = 4
)
...
var (
	PixKeyType_name = map[int32]string{
		...
		1: "PIX_KEY_TYPE_CPF",
		2: "PIX_KEY_TYPE_EMAIL",
		3: "PIX_KEY_TYPE_PHONE",
		4: "PIX_KEY_TYPE_RANDOM",
	}
...
type PixKeyResult int32

const (
	PixKeyResult_PIX_KEY_RESULT_UNSPECIFIED PixKeyResult = 0
	PixKeyResult_PIX_KEY_RESULT_OK          PixKeyResult = 1
	// The key does not have the shape of the declared type (a CPF without eleven
	// digits, an e-mail without an at sign, and so on).
	PixKeyResult_PIX_KEY_RESULT_INVALID PixKeyResult = 2
	// A charge is open against one of this seller's listings. Changing the key now
	// would divert a payment already under way.
	PixKeyResult_PIX_KEY_RESULT_SALE_IN_PROGRESS PixKeyResult = 3
	// The account does not exist.
	PixKeyResult_PIX_KEY_RESULT_NO_ACCOUNT PixKeyResult = 4
	...
	PixKeyResult_PIX_KEY_RESULT_INVALID_TAX_ID PixKeyResult = 5
	...
	PixKeyResult_PIX_KEY_RESULT_PAYOUT_PENDING PixKeyResult = 6
)

// Enum value maps for PixKeyResult.
var (
	PixKeyResult_name = map[int32]string{
		0: "PIX_KEY_RESULT_UNSPECIFIED",
		1: "PIX_KEY_RESULT_OK",
		2: "PIX_KEY_RESULT_INVALID",
		3: "PIX_KEY_RESULT_SALE_IN_PROGRESS",
		4: "PIX_KEY_RESULT_NO_ACCOUNT",
		5: "PIX_KEY_RESULT_INVALID_TAX_ID",
		6: "PIX_KEY_RESULT_PAYOUT_PENDING",
	}
	PixKeyResult_value = map[string]int32{
...
func (x PixKeyResult) Enum() *PixKeyResult {
	p := new(PixKeyResult)
	*p = x
	return p
}

func (x PixKeyResult) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PixKeyResult) Descriptor() protoreflect.EnumDescriptor {
	return file_api_web_v1_web_proto_enumTypes[3].Descriptor()
}

func (PixKeyResult) Type() protoreflect.EnumType {
	return &file_api_web_v1_web_proto_enumTypes[3]
}

func (x PixKeyResult) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PixKeyResult.Descriptor instead.
func (PixKeyResult) EnumDescriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{3}
}

// MarketCurrency is what a shelf is priced in.
type MarketCurrency int32

const (
	MarketCurrency_MARKET_CURRENCY_UNSPECIFIED MarketCurrency = 0
	MarketCurrency_MARKET_CURRENCY_GOLD        MarketCurrency = 1
	MarketCurrency_MARKET_CURRENCY_CASH        MarketCurrency = 2
	MarketCurrency_MARKET_CURRENCY_REAL        MarketCurrency = 3
)

// Enum value maps for MarketCurrency.
var (
	MarketCurrency_name = map[int32]string{
		0: "MARKET_CURRENCY_UNSPECIFIED",
		1: "MARKET_CURRENCY_GOLD",
		2: "MARKET_CURRENCY_CASH",
		3: "MARKET_CURRENCY_REAL",
	}
	MarketCurrency_value = map[string]int32{
...
func (x MarketCurrency) Enum() *MarketCurrency {
	p := new(MarketCurrency)
	*p = x
	return p
}

func (x MarketCurrency) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MarketCurrency) Descriptor() protoreflect.EnumDescriptor {
	return file_api_web_v1_web_proto_enumTypes[4].Descriptor()
}

func (MarketCurrency) Type() protoreflect.EnumType {
	return &file_api_web_v1_web_proto_enumTypes[4]
}

func (x MarketCurrency) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MarketCurrency.Descriptor instead.
func (MarketCurrency) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	MarketSort_MARKET_SORT_UNSPECIFIED MarketSort = 0
	MarketSort_MARKET_SORT_PRICE_ASC   MarketSort = 1
	MarketSort_MARKET_SORT_PRICE_DESC  MarketSort = 2
	// NEWEST is the stall that went up most recently, which is the smallest
	// open_for_seconds.
	MarketSort_MARKET_SORT_NEWEST MarketSort = 3
)

// Enum value maps for MarketSort.
var (
	MarketSort_name = map[int32]string{
		0: "MARKET_SORT_UNSPECIFIED",
		1: "MARKET_SORT_PRICE_ASC",
		2: "MARKET_SORT_PRICE_DESC",
		3: "MARKET_SORT_NEWEST",
	}
	MarketSort_value = map[string]int32{
...
func (x MarketSort) Enum() *MarketSort {
	p := new(MarketSort)
	*p = x
	return p
}
...
func (MarketSort) Descriptor() protoreflect.EnumDescriptor {
	return file_api_web_v1_web_proto_enumTypes[5].Descriptor()
}

func (MarketSort) Type() protoreflect.EnumType {
	return &file_api_web_v1_web_proto_enumTypes[5]
}

func (x MarketSort) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MarketSort.Descriptor instead.
func (MarketSort) EnumDescriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{5}
}

// PixKeyDeleteResult e por que o apagar passou ou nao.
type PixKeyDeleteResult int32

const (
	PixKeyDeleteResult_PIX_KEY_DELETE_RESULT_UNSPECIFIED PixKeyDeleteResult = 0
	PixKeyDeleteResult_PIX_KEY_DELETE_RESULT_OK          PixKeyDeleteResult = 1
	...
	PixKeyDeleteResult_PIX_KEY_DELETE_RESULT_NO_KEY PixKeyDeleteResult = 2
	// SALE_IN_PROGRESS: ha cobranca ABERTA de um anuncio deste vendedor.
	PixKeyDeleteResult_PIX_KEY_DELETE_RESULT_SALE_IN_PROGRESS PixKeyDeleteResult = 3
	// PAYOUT_PENDING: ha repasse a caminho -- pendente, enviado, incerto ou
	// segurado por taxa desconhecida. Recusado e pago nao travam.
	PixKeyDeleteResult_PIX_KEY_DELETE_RESULT_PAYOUT_PENDING PixKeyDeleteResult = 4
)

// Enum value maps for PixKeyDeleteResult.
var (
	PixKeyDeleteResult_name = map[int32]string{
		0: "PIX_KEY_DELETE_RESULT_UNSPECIFIED",
		1: "PIX_KEY_DELETE_RESULT_OK",
		2: "PIX_KEY_DELETE_RESULT_NO_KEY",
		3: "PIX_KEY_DELETE_RESULT_SALE_IN_PROGRESS",
		4: "PIX_KEY_DELETE_RESULT_PAYOUT_PENDING",
	}
	PixKeyDeleteResult_value = map[string]int32{
...
func (x PixKeyDeleteResult) Enum() *PixKeyDeleteResult {
	p := new(PixKeyDeleteResult)
	*p = x
	return p
}

func (x PixKeyDeleteResult) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PixKeyDeleteResult) Descriptor() protoreflect.EnumDescriptor {
	return file_api_web_v1_web_proto_enumTypes[6].Descriptor()
}

func (PixKeyDeleteResult) Type() protoreflect.EnumType {
	return &file_api_web_v1_web_proto_enumTypes[6]
}

func (x PixKeyDeleteResult) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PixKeyDeleteResult.Descriptor instead.
func (PixKeyDeleteResult) EnumDescriptor() ([]byte, []int) {
...
type PayoutWaitReason int32

const (
	PayoutWaitReason_PAYOUT_WAIT_REASON_UNSPECIFIED PayoutWaitReason = 0
	...
	PayoutWaitReason_PAYOUT_WAIT_REASON_NO_KEY_OR_TAX_ID PayoutWaitReason = 1
	...
	PayoutWaitReason_PAYOUT_WAIT_REASON_IN_PROGRESS PayoutWaitReason = 2
	...
	PayoutWaitReason_PAYOUT_WAIT_REASON_NEEDS_STAFF PayoutWaitReason = 3
)

// Enum value maps for PayoutWaitReason.
var (
	PayoutWaitReason_name = map[int32]string{
		0: "PAYOUT_WAIT_REASON_UNSPECIFIED",
		1: "PAYOUT_WAIT_REASON_NO_KEY_OR_TAX_ID",
		2: "PAYOUT_WAIT_REASON_IN_PROGRESS",
		3: "PAYOUT_WAIT_REASON_NEEDS_STAFF",
	}
	PayoutWaitReason_value = map[string]int32{
...
func (x PayoutWaitReason) Enum() *PayoutWaitReason {
	p := new(PayoutWaitReason)
	*p = x
	return p
}

func (x PayoutWaitReason) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PayoutWaitReason) Descriptor() protoreflect.EnumDescriptor {
	return file_api_web_v1_web_proto_enumTypes[7].Descriptor()
}

func (PayoutWaitReason) Type() protoreflect.EnumType {
	return &file_api_web_v1_web_proto_enumTypes[7]
}

func (x PayoutWaitReason) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PayoutWaitReason.Descriptor instead.
func (PayoutWaitReason) EnumDescriptor() ([]byte, []int) {
...
// them.
type PixChargeState int32

const (
	PixChargeState_PIX_CHARGE_STATE_UNSPECIFIED PixChargeState = 0
	// OPEN: the code is good and the deadline has not passed. Pay it.
	PixChargeState_PIX_CHARGE_STATE_OPEN PixChargeState = 1
	// EXPIRED: the deadline passed. The sweep may not have closed the row yet, and
	// that does not change what the page says.
	PixChargeState_PIX_CHARGE_STATE_EXPIRED PixChargeState = 2
	...
	PixChargeState_PIX_CHARGE_STATE_PAID PixChargeState = 3
...
// Enum value maps for PixChargeState.
var (
	PixChargeState_name = map[int32]string{
		0: "PIX_CHARGE_STATE_UNSPECIFIED",
		1: "PIX_CHARGE_STATE_OPEN",
		2: "PIX_CHARGE_STATE_EXPIRED",
		3: "PIX_CHARGE_STATE_PAID",
		4: "PIX_CHARGE_STATE_CANCELED",
		5: "PIX_CHARGE_STATE_PAID_LATE",
	}
	PixChargeState_value = map[string]int32{
...
func (x PixChargeState) Enum() *PixChargeState {
	p := new(PixChargeState)
	*p = x
	return p
}

func (x PixChargeState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PixChargeState) Descriptor() protoreflect.EnumDescriptor {
	return file_api_web_v1_web_proto_enumTypes[8].Descriptor()
}

func (PixChargeState) Type() protoreflect.EnumType {
	return &file_api_web_v1_web_proto_enumTypes[8]
}

func (x PixChargeState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PixChargeState.Descriptor instead.
func (PixChargeState) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	// imediata.
	DeliveryState_DELIVERY_STATE_WAITING DeliveryState = 1
	// HELD: esta na fila E o bau da conta nao tem espaco livre.
	DeliveryState_DELIVERY_STATE_HELD DeliveryState = 2
	...
	DeliveryState_DELIVERY_STATE_LOST DeliveryState = 4
)
...
var (
	DeliveryState_name = map[int32]string{
		...
		1: "DELIVERY_STATE_WAITING",
		2: "DELIVERY_STATE_HELD",
		3: "DELIVERY_STATE_DELIVERED",
		4: "DELIVERY_STATE_LOST",
	}
...
type SyncpayEventKind int32

const (
	SyncpayEventKind_SYNCPAY_EVENT_KIND_UNSPECIFIED SyncpayEventKind = 0
	// CASHIN: a buyer paid. NOTHING in the notice is believed — the server queries
	// the processor and decides from the answer.
	SyncpayEventKind_SYNCPAY_EVENT_KIND_CASHIN SyncpayEventKind = 1
	...
	SyncpayEventKind_SYNCPAY_EVENT_KIND_CASHOUT SyncpayEventKind = 2
)

// Enum value maps for SyncpayEventKind.
var (
	SyncpayEventKind_name = map[int32]string{
		0: "SYNCPAY_EVENT_KIND_UNSPECIFIED",
		1: "SYNCPAY_EVENT_KIND_CASHIN",
		2: "SYNCPAY_EVENT_KIND_CASHOUT",
	}
	SyncpayEventKind_value = map[string]int32{
...
func (x SyncpayEventKind) Enum() *SyncpayEventKind {
	p := new(SyncpayEventKind)
	*p = x
	return p
}

func (x SyncpayEventKind) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SyncpayEventKind) Descriptor() protoreflect.EnumDescriptor {
	return file_api_web_v1_web_proto_enumTypes[11].Descriptor()
}

func (SyncpayEventKind) Type() protoreflect.EnumType {
	return &file_api_web_v1_web_proto_enumTypes[11]
}

func (x SyncpayEventKind) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SyncpayEventKind.Descriptor instead.
func (SyncpayEventKind) EnumDescriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{11}
}

// GuildEmblemResult e por que a troca passou ou nao.
type GuildEmblemResult int32

const (
	GuildEmblemResult_GUILD_EMBLEM_RESULT_UNSPECIFIED GuildEmblemResult = 0
	GuildEmblemResult_GUILD_EMBLEM_RESULT_OK          GuildEmblemResult = 1
	// NOT_LEADER: nenhum personagem desta conta lidera a guilda pedida.
	GuildEmblemResult_GUILD_EMBLEM_RESULT_NOT_LEADER GuildEmblemResult = 2
	// INVALID_IMAGE: o BMP nao bate com o formato descrito em SetMyGuildEmblem.
	GuildEmblemResult_GUILD_EMBLEM_RESULT_INVALID_IMAGE GuildEmblemResult = 3
	...
	// membros.
	GuildEmblemResult_GUILD_EMBLEM_RESULT_RATE_LIMITED GuildEmblemResult = 4
)

// Enum value maps for GuildEmblemResult.
var (
	GuildEmblemResult_name = map[int32]string{
		0: "GUILD_EMBLEM_RESULT_UNSPECIFIED",
		1: "GUILD_EMBLEM_RESULT_OK",
		2: "GUILD_EMBLEM_RESULT_NOT_LEADER",
		3: "GUILD_EMBLEM_RESULT_INVALID_IMAGE",
		4: "GUILD_EMBLEM_RESULT_RATE_LIMITED",
	}
	GuildEmblemResult_value = map[string]int32{
...
func (x GuildEmblemResult) Enum() *GuildEmblemResult {
	p := new(GuildEmblemResult)
	*p = x
	return p
}

func (x GuildEmblemResult) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GuildEmblemResult) Descriptor() protoreflect.EnumDescriptor {
	return file_api_web_v1_web_proto_enumTypes[12].Descriptor()
}

func (GuildEmblemResult) Type() protoreflect.EnumType {
	return &file_api_web_v1_web_proto_enumTypes[12]
}

func (x GuildEmblemResult) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GuildEmblemResult.Descriptor instead.
func (GuildEmblemResult) EnumDescriptor() ([]byte, []int) {
...
func (AttributeMapTransformOperation) Descriptor() protoreflect.EnumDescriptor {
	return file_api_web_v1_web_proto_enumTypes[14].Descriptor()
}

func (AttributeMapTransformOperation) Type() protoreflect.EnumType {
	return &file_api_web_v1_web_proto_enumTypes[14]
}
...
func (BuyResult) Descriptor() protoreflect.EnumDescriptor {
	return file_api_web_v1_web_proto_enumTypes[15].Descriptor()
}

func (BuyResult) Type() protoreflect.EnumType {
	return &file_api_web_v1_web_proto_enumTypes[15]
}
...
func (ClaimResult) Descriptor() protoreflect.EnumDescriptor {
	return file_api_web_v1_web_proto_enumTypes[16].Descriptor()
}

func (ClaimResult) Type() protoreflect.EnumType {
	return &file_api_web_v1_web_proto_enumTypes[16]
}
...
func (PaymentMethod) Descriptor() protoreflect.EnumDescriptor {
	return file_api_web_v1_web_proto_enumTypes[17].Descriptor()
}

func (PaymentMethod) Type() protoreflect.EnumType {
	return &file_api_web_v1_web_proto_enumTypes[17]
}
...
func (TopupResult) Descriptor() protoreflect.EnumDescriptor {
	return file_api_web_v1_web_proto_enumTypes[18].Descriptor()
}

func (TopupResult) Type() protoreflect.EnumType {
	return &file_api_web_v1_web_proto_enumTypes[18]
}
...
type AttachResult int32

const (
	AttachResult_ATTACH_RESULT_UNSPECIFIED AttachResult = 0
	// ATTACHED: stored now.
	AttachResult_ATTACH_RESULT_ATTACHED AttachResult = 1
	// ALREADY: this order already had exactly this id. A retry, and not a problem.
	AttachResult_ATTACH_RESULT_ALREADY AttachResult = 2
	...
	AttachResult_ATTACH_RESULT_CONFLICT_ORDER AttachResult = 3
	...
	AttachResult_ATTACH_RESULT_CONFLICT_IDENTIFIER AttachResult = 4
	// NOT_FOUND: no order with that reference.
	AttachResult_ATTACH_RESULT_NOT_FOUND AttachResult = 5
	...
	AttachResult_ATTACH_RESULT_ALREADY_PAID AttachResult = 6
)

// Enum value maps for AttachResult.
var (
	AttachResult_name = map[int32]string{
		0: "ATTACH_RESULT_UNSPECIFIED",
		1: "ATTACH_RESULT_ATTACHED",
		2: "ATTACH_RESULT_ALREADY",
		3: "ATTACH_RESULT_CONFLICT_ORDER",
		4: "ATTACH_RESULT_CONFLICT_IDENTIFIER",
		5: "ATTACH_RESULT_NOT_FOUND",
		6: "ATTACH_RESULT_ALREADY_PAID",
	}
	AttachResult_value = map[string]int32{
...
func (x AttachResult) Enum() *AttachResult {
	p := new(AttachResult)
	*p = x
	return p
}
...
func (AttachResult) Descriptor() protoreflect.EnumDescriptor {
	return file_api_web_v1_web_proto_enumTypes[19].Descriptor()
}

func (AttachResult) Type() protoreflect.EnumType {
	return &file_api_web_v1_web_proto_enumTypes[19]
}

func (x AttachResult) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use AttachResult.Descriptor instead.
func (AttachResult) EnumDescriptor() ([]byte, []int) {
...
func (TopupStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_api_web_v1_web_proto_enumTypes[20].Descriptor()
}

func (TopupStatus) Type() protoreflect.EnumType {
	return &file_api_web_v1_web_proto_enumTypes[20]
}
...
func (RevenueBucket) Descriptor() protoreflect.EnumDescriptor {
	return file_api_web_v1_web_proto_enumTypes[21].Descriptor()
}

func (RevenueBucket) Type() protoreflect.EnumType {
	return &file_api_web_v1_web_proto_enumTypes[21]
}
...
func (DonateLedgerAction) Descriptor() protoreflect.EnumDescriptor {
	return file_api_web_v1_web_proto_enumTypes[22].Descriptor()
}

func (DonateLedgerAction) Type() protoreflect.EnumType {
	return &file_api_web_v1_web_proto_enumTypes[22]
}
...
func (x *VerifyCredentialsResponse) GetDiscordId() string {
	if x != nil {
		return x.DiscordId
	}
	return ""
...
type SetMyDiscordLinkRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *SetMyDiscordLinkRequest) Reset() {
	*x = SetMyDiscordLinkRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SetMyDiscordLinkRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetMyDiscordLinkRequest) ProtoMessage() {}

func (x *SetMyDiscordLinkRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetMyDiscordLinkRequest.ProtoReflect.Descriptor instead.
func (*SetMyDiscordLinkRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{4}
}

func (x *SetMyDiscordLinkRequest) GetAccountId() int64 {
	if x != nil {
		return x.AccountId
	}
	return 0
...
func (x *SetMyDiscordLinkRequest) GetDiscordId() string {
	if x != nil {
		return x.DiscordId
	}
	return ""
...
type SetMyDiscordLinkResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Result        DiscordLinkResult      `protobuf:"varint,1,opt,name=result,proto3,enum=web.v1.DiscordLinkResult" json:"result,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SetMyDiscordLinkResponse) Reset() {
	*x = SetMyDiscordLinkResponse{}
	mi := &file_api_web_v1_web_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SetMyDiscordLinkResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetMyDiscordLinkResponse) ProtoMessage() {}

func (x *SetMyDiscordLinkResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetMyDiscordLinkResponse.ProtoReflect.Descriptor instead.
func (*SetMyDiscordLinkResponse) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{5}
}

func (x *SetMyDiscordLinkResponse) GetResult() DiscordLinkResult {
	if x != nil {
		return x.Result
	}
	return DiscordLinkResult_DISCORD_LINK_RESULT_UNSPECIFIED
}

type SavePixKeyRequest struct {
	state     protoimpl.MessageState `protogen:"open.v1"`
	AccountId int64                  `protobuf:"varint,1,opt,name=account_id,json=accountId,proto3" json:"account_id,omitempty"`
	Key       string                 `protobuf:"bytes,2,opt,name=key,proto3" json:"key,omitempty"`
	Type      PixKeyType             `protobuf:"varint,3,opt,name=type,proto3,enum=web.v1.PixKeyType" json:"type,omitempty"`
...
func (x *SavePixKeyRequest) Reset() {
	*x = SavePixKeyRequest{}
...
func (x *SavePixKeyRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SavePixKeyRequest) ProtoMessage() {}

func (x *SavePixKeyRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SavePixKeyRequest.ProtoReflect.Descriptor instead.
func (*SavePixKeyRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{6}
}

func (x *SavePixKeyRequest) GetAccountId() int64 {
	if x != nil {
		return x.AccountId
	}
	return 0
...
func (x *SavePixKeyRequest) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *SavePixKeyRequest) GetType() PixKeyType {
	if x != nil {
		return x.Type
	}
	return PixKeyType_PIX_KEY_TYPE_UNSPECIFIED
}

func (x *SavePixKeyRequest) GetTaxId() string {
	if x != nil {
		return x.TaxId
	}
	return ""
...
type SavePixKeyResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Result        PixKeyResult           `protobuf:"varint,1,opt,name=result,proto3,enum=web.v1.PixKeyResult" json:"result,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SavePixKeyResponse) Reset() {
	*x = SavePixKeyResponse{}
	mi := &file_api_web_v1_web_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SavePixKeyResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SavePixKeyResponse) ProtoMessage() {}

func (x *SavePixKeyResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SavePixKeyResponse.ProtoReflect.Descriptor instead.
func (*SavePixKeyResponse) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{7}
}

func (x *SavePixKeyResponse) GetResult() PixKeyResult {
	if x != nil {
		return x.Result
	}
	return PixKeyResult_PIX_KEY_RESULT_UNSPECIFIED
}

type ListMarketListingsRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	Currency MarketCurrency `protobuf:"varint,1,opt,name=currency,proto3,enum=web.v1.MarketCurrency" json:"currency,omitempty"`
	...
	Sort MarketSort `protobuf:"varint,3,opt,name=sort,proto3,enum=web.v1.MarketSort" json:"sort,omitempty"`
...
func (x *ListMarketListingsRequest) Reset() {
	*x = ListMarketListingsRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListMarketListingsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListMarketListingsRequest) ProtoMessage() {}

func (x *ListMarketListingsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListMarketListingsRequest.ProtoReflect.Descriptor instead.
func (*ListMarketListingsRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{8}
}

func (x *ListMarketListingsRequest) GetCurrency() MarketCurrency {
	if x != nil {
		return x.Currency
	}
	return MarketCurrency_MARKET_CURRENCY_UNSPECIFIED
}

func (x *ListMarketListingsRequest) GetPage() int32 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *ListMarketListingsRequest) GetSort() MarketSort {
	if x != nil {
		return x.Sort
	}
	return MarketSort_MARKET_SORT_UNSPECIFIED
}

func (x *ListMarketListingsRequest) GetItemIndex() int32 {
	if x != nil {
		return x.ItemIndex
	}
	return 0
...
type MarketListing struct {
	...
	OpenForSeconds int64 `protobuf:"varint,8,opt,name=open_for_seconds,json=openForSeconds,proto3" json:"open_for_seconds,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *MarketListing) Reset() {
	*x = MarketListing{}
...
func (x *MarketListing) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MarketListing) ProtoMessage() {}

func (x *MarketListing) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MarketListing.ProtoReflect.Descriptor instead.
func (*MarketListing) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{9}
}

func (x *MarketListing) GetItemIndex() int32 {
	if x != nil {
		return x.ItemIndex
	}
	return 0
...
func (x *MarketListing) GetRefine() int32 {
	if x != nil {
		return x.Refine
	}
	return 0
...
func (x *MarketListing) GetAmount() int32 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *MarketListing) GetCurrency() MarketCurrency {
	if x != nil {
		return x.Currency
	}
	return MarketCurrency_MARKET_CURRENCY_UNSPECIFIED
...
func (x *MarketListing) GetPrice() int64 {
	if x != nil {
		return x.Price
	}
	return 0
...
func (x *MarketListing) GetSellerCharacter() string {
	if x != nil {
		return x.SellerCharacter
	}
	return ""
}

func (x *MarketListing) GetVillage() string {
	if x != nil {
		return x.Village
	}
	return ""
...
func (x *MarketListing) GetOpenForSeconds() int64 {
	if x != nil {
		return x.OpenForSeconds
	}
	return 0
}
...
type ListMarketListingsResponse struct {
	state    protoimpl.MessageState `protogen:"open.v1"`
	Listings []*MarketListing       `protobuf:"bytes,1,rep,name=listings,proto3" json:"listings,omitempty"`
...
func (x *ListMarketListingsResponse) Reset() {
	*x = ListMarketListingsResponse{}
	mi := &file_api_web_v1_web_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListMarketListingsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListMarketListingsResponse) ProtoMessage() {}

func (x *ListMarketListingsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListMarketListingsResponse.ProtoReflect.Descriptor instead.
func (*ListMarketListingsResponse) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{10}
}

func (x *ListMarketListingsResponse) GetListings() []*MarketListing {
	if x != nil {
		return x.Listings
	}
	return nil
...
func (x *ListMarketListingsResponse) GetTotal() int32 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *ListMarketListingsResponse) GetCachedForSeconds() int32 {
	if x != nil {
		return x.CachedForSeconds
	}
	return 0
}
...
func (x *GetPixKeyRequest) GetAccountId() int64 {
	if x != nil {
		return x.AccountId
	}
	return 0
...
type GetPixKeyResponse struct {
	...
	// this field existed.
	MaskedTaxId string `protobuf:"bytes,5,opt,name=masked_tax_id,json=maskedTaxId,proto3" json:"masked_tax_id,omitempty"`
...
func (x *GetPixKeyResponse) GetHasKey() bool {
	if x != nil {
		return x.HasKey
	}
	return false
...
func (x *GetPixKeyResponse) GetMaskedKey() string {
	if x != nil {
		return x.MaskedKey
	}
	return ""
...
func (x *GetPixKeyResponse) GetType() PixKeyType {
	if x != nil {
		return x.Type
	}
	return PixKeyType_PIX_KEY_TYPE_UNSPECIFIED
...
func (x *GetPixKeyResponse) GetVerified() bool {
	if x != nil {
		return x.Verified
	}
	return false
...
func (x *GetPixKeyResponse) GetMaskedTaxId() string {
	if x != nil {
		return x.MaskedTaxId
	}
	return ""
}

func (x *GetPixKeyResponse) GetPendingPayoutCents() int64 {
	if x != nil {
		return x.PendingPayoutCents
	}
	return 0
}

func (x *GetPixKeyResponse) GetPayoutWaitReason() PayoutWaitReason {
	if x != nil {
		return x.PayoutWaitReason
	}
	return PayoutWaitReason_PAYOUT_WAIT_REASON_UNSPECIFIED
}
...
func (x *DeletePixKeyRequest) GetAccountId() int64 {
	if x != nil {
		return x.AccountId
	}
	return 0
...
type DeletePixKeyResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Result        PixKeyDeleteResult     `protobuf:"varint,1,opt,name=result,proto3,enum=web.v1.PixKeyDeleteResult" json:"result,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DeletePixKeyResponse) GetResult() PixKeyDeleteResult {
	if x != nil {
		return x.Result
	}
	return PixKeyDeleteResult_PIX_KEY_DELETE_RESULT_UNSPECIFIED
}

type GetMyCurrentPixChargeRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetMyCurrentPixChargeRequest) Reset() {
	*x = GetMyCurrentPixChargeRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetMyCurrentPixChargeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetMyCurrentPixChargeRequest) ProtoMessage() {}

func (x *GetMyCurrentPixChargeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetMyCurrentPixChargeRequest.ProtoReflect.Descriptor instead.
func (*GetMyCurrentPixChargeRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{15}
}

func (x *GetMyCurrentPixChargeRequest) GetAccountId() int64 {
	if x != nil {
		return x.AccountId
	}
	return 0
...
type GetMyCurrentPixChargeResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// has_charge false means there is nothing to show. Every field below is then
	// empty, and the page shows its ordinary state.
	HasCharge bool `protobuf:"varint,1,opt,name=has_charge,json=hasCharge,proto3" json:"has_charge,omitempty"`
	...
	PixCode string `protobuf:"bytes,2,opt,name=pix_code,json=pixCode,proto3" json:"pix_code,omitempty"`
	...
	State     PixChargeState `protobuf:"varint,5,opt,name=state,proto3,enum=web.v1.PixChargeState" json:"state,omitempty"`
	...
	ItemIndex int32 `protobuf:"varint,6,opt,name=item_index,json=itemIndex,proto3" json:"item_index,omitempty"`
	...
	RefineLevel int32 `protobuf:"varint,7,opt,name=refine_level,json=refineLevel,proto3" json:"refine_level,omitempty"`
	StackSize   int32 `protobuf:"varint,8,opt,name=stack_size,json=stackSize,proto3" json:"stack_size,omitempty"`
	...
	DeliveryState DeliveryState `protobuf:"varint,12,opt,name=delivery_state,json=deliveryState,proto3,enum=web.v1.DeliveryState" json:"delivery_state,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetMyCurrentPixChargeResponse) Reset() {
	*x = GetMyCurrentPixChargeResponse{}
	mi := &file_api_web_v1_web_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetMyCurrentPixChargeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetMyCurrentPixChargeResponse) ProtoMessage() {}

func (x *GetMyCurrentPixChargeResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetMyCurrentPixChargeResponse.ProtoReflect.Descriptor instead.
func (*GetMyCurrentPixChargeResponse) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{16}
}

func (x *GetMyCurrentPixChargeResponse) GetHasCharge() bool {
	if x != nil {
		return x.HasCharge
	}
	return false
...
func (x *GetMyCurrentPixChargeResponse) GetPixCode() string {
	if x != nil {
		return x.PixCode
	}
	return ""
...
func (x *GetMyCurrentPixChargeResponse) GetAmountCents() int64 {
	if x != nil {
...
func (x *GetMyCurrentPixChargeResponse) GetExpiresAt() int64 {
	if x != nil {
		return x.ExpiresAt
	}
	return 0
...
func (x *GetMyCurrentPixChargeResponse) GetState() PixChargeState {
	if x != nil {
		return x.State
	}
	return PixChargeState_PIX_CHARGE_STATE_UNSPECIFIED
}

func (x *GetMyCurrentPixChargeResponse) GetItemIndex() int32 {
	if x != nil {
		return x.ItemIndex
	}
	return 0
...
func (x *GetMyCurrentPixChargeResponse) GetRefineLevel() int32 {
	if x != nil {
...
func (x *GetMyCurrentPixChargeResponse) GetStackSize() int32 {
	if x != nil {
		return x.StackSize
	}
	return 0
...
func (x *GetMyCurrentPixChargeResponse) GetSellerName() string {
	if x != nil {
		return x.SellerName
	}
	return ""
...
func (x *GetMyCurrentPixChargeResponse) GetDeliveryState() DeliveryState {
	if x != nil {
...
type NotifySyncpayEventRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	Kind  SyncpayEventKind       `protobuf:"varint,1,opt,name=kind,proto3,enum=web.v1.SyncpayEventKind" json:"kind,omitempty"`
	...
	AmountCents      int64 `protobuf:"varint,3,opt,name=amount_cents,json=amountCents,proto3" json:"amount_cents,omitempty"`
	FinalAmountCents int64 `protobuf:"varint,4,opt,name=final_amount_cents,json=finalAmountCents,proto3" json:"final_amount_cents,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}

func (x *NotifySyncpayEventRequest) Reset() {
	*x = NotifySyncpayEventRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *NotifySyncpayEventRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NotifySyncpayEventRequest) ProtoMessage() {}

func (x *NotifySyncpayEventRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NotifySyncpayEventRequest.ProtoReflect.Descriptor instead.
func (*NotifySyncpayEventRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{17}
}

func (x *NotifySyncpayEventRequest) GetKind() SyncpayEventKind {
	if x != nil {
		return x.Kind
	}
	return SyncpayEventKind_SYNCPAY_EVENT_KIND_UNSPECIFIED
}

func (x *NotifySyncpayEventRequest) GetIdentifier() string {
	if x != nil {
		return x.Identifier
	}
	return ""
...
func (x *NotifySyncpayEventRequest) GetAmountCents() int64 {
	if x != nil {
		return x.AmountCents
	}
	return 0
...
func (x *NotifySyncpayEventRequest) GetFinalAmountCents() int64 {
	if x != nil {
		return x.FinalAmountCents
	}
	return 0
}

type NotifySyncpayEventResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *NotifySyncpayEventResponse) Reset() {
	*x = NotifySyncpayEventResponse{}
	mi := &file_api_web_v1_web_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *NotifySyncpayEventResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NotifySyncpayEventResponse) ProtoMessage() {}

func (x *NotifySyncpayEventResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NotifySyncpayEventResponse.ProtoReflect.Descriptor instead.
func (*NotifySyncpayEventResponse) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{18}
}

func (x *NotifySyncpayEventResponse) GetHandled() bool {
	if x != nil {
		return x.Handled
	}
	return false
...
type ListMyLedGuildsRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ListMyLedGuildsRequest) Reset() {
	*x = ListMyLedGuildsRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListMyLedGuildsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListMyLedGuildsRequest) ProtoMessage() {}

func (x *ListMyLedGuildsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[25]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListMyLedGuildsRequest.ProtoReflect.Descriptor instead.
func (*ListMyLedGuildsRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{25}
}

func (x *ListMyLedGuildsRequest) GetAccountId() int64 {
	if x != nil {
		return x.AccountId
	}
	return 0
...
type ListMyLedGuildsResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	Guilds        []*LedGuild `protobuf:"bytes,1,rep,name=guilds,proto3" json:"guilds,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ListMyLedGuildsResponse) Reset() {
	*x = ListMyLedGuildsResponse{}
	mi := &file_api_web_v1_web_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListMyLedGuildsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListMyLedGuildsResponse) ProtoMessage() {}

func (x *ListMyLedGuildsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[26]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListMyLedGuildsResponse.ProtoReflect.Descriptor instead.
func (*ListMyLedGuildsResponse) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{26}
}

func (x *ListMyLedGuildsResponse) GetGuilds() []*LedGuild {
	if x != nil {
		return x.Guilds
	}
	return nil
...
type LedGuild struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	GuildId       int32                  `protobuf:"varint,1,opt,name=guild_id,json=guildId,proto3" json:"guild_id,omitempty"`
	Name          string                 `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	HasEmblem     bool                   `protobuf:"varint,3,opt,name=has_emblem,json=hasEmblem,proto3" json:"has_emblem,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *LedGuild) Reset() {
	*x = LedGuild{}
...
func (x *LedGuild) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LedGuild) ProtoMessage() {}

func (x *LedGuild) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[27]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LedGuild.ProtoReflect.Descriptor instead.
func (*LedGuild) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{27}
}

func (x *LedGuild) GetGuildId() int32 {
	if x != nil {
		return x.GuildId
	}
	return 0
...
func (x *LedGuild) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *LedGuild) GetHasEmblem() bool {
	if x != nil {
		return x.HasEmblem
	}
	return false
...
type SetMyGuildEmblemRequest struct {
	state     protoimpl.MessageState `protogen:"open.v1"`
	AccountId int64                  `protobuf:"varint,1,opt,name=account_id,json=accountId,proto3" json:"account_id,omitempty"`
...
func (x *SetMyGuildEmblemRequest) Reset() {
	*x = SetMyGuildEmblemRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SetMyGuildEmblemRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetMyGuildEmblemRequest) ProtoMessage() {}

func (x *SetMyGuildEmblemRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[28]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetMyGuildEmblemRequest.ProtoReflect.Descriptor instead.
func (*SetMyGuildEmblemRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{28}
}

func (x *SetMyGuildEmblemRequest) GetAccountId() int64 {
	if x != nil {
		return x.AccountId
	}
	return 0
...
func (x *SetMyGuildEmblemRequest) GetGuildId() int32 {
	if x != nil {
		return x.GuildId
	}
	return 0
...
func (x *SetMyGuildEmblemRequest) GetImage() []byte {
	if x != nil {
		return x.Image
	}
	return nil
...
type SetMyGuildEmblemResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Result        GuildEmblemResult      `protobuf:"varint,1,opt,name=result,proto3,enum=web.v1.GuildEmblemResult" json:"result,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SetMyGuildEmblemResponse) Reset() {
	*x = SetMyGuildEmblemResponse{}
	mi := &file_api_web_v1_web_proto_msgTypes[29]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SetMyGuildEmblemResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetMyGuildEmblemResponse) ProtoMessage() {}

func (x *SetMyGuildEmblemResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[29]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetMyGuildEmblemResponse.ProtoReflect.Descriptor instead.
func (*SetMyGuildEmblemResponse) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{29}
}

func (x *SetMyGuildEmblemResponse) GetResult() GuildEmblemResult {
	if x != nil {
		return x.Result
	}
	return GuildEmblemResult_GUILD_EMBLEM_RESULT_UNSPECIFIED
}

type ClearMyGuildEmblemRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AccountId     int64                  `protobuf:"varint,1,opt,name=account_id,json=accountId,proto3" json:"account_id,omitempty"`
	GuildId       int32                  `protobuf:"varint,2,opt,name=guild_id,json=guildId,proto3" json:"guild_id,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *ClearMyGuildEmblemRequest) Reset() {
	*x = ClearMyGuildEmblemRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[30]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ClearMyGuildEmblemRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClearMyGuildEmblemRequest) ProtoMessage() {}

func (x *ClearMyGuildEmblemRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[30]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClearMyGuildEmblemRequest.ProtoReflect.Descriptor instead.
func (*ClearMyGuildEmblemRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{30}
}

func (x *ClearMyGuildEmblemRequest) GetAccountId() int64 {
	if x != nil {
		return x.AccountId
	}
	return 0
...
func (x *ClearMyGuildEmblemRequest) GetGuildId() int32 {
	if x != nil {
		return x.GuildId
	}
	return 0
...
type ClearMyGuildEmblemResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Result        GuildEmblemResult      `protobuf:"varint,1,opt,name=result,proto3,enum=web.v1.GuildEmblemResult" json:"result,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *ClearMyGuildEmblemResponse) Reset() {
	*x = ClearMyGuildEmblemResponse{}
	mi := &file_api_web_v1_web_proto_msgTypes[31]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ClearMyGuildEmblemResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClearMyGuildEmblemResponse) ProtoMessage() {}

func (x *ClearMyGuildEmblemResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[31]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClearMyGuildEmblemResponse.ProtoReflect.Descriptor instead.
func (*ClearMyGuildEmblemResponse) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{31}
}

func (x *ClearMyGuildEmblemResponse) GetResult() GuildEmblemResult {
	if x != nil {
		return x.Result
	}
	return GuildEmblemResult_GUILD_EMBLEM_RESULT_UNSPECIFIED
...
type GetGuildEmblemRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	GuildId       int32                  `protobuf:"varint,1,opt,name=guild_id,json=guildId,proto3" json:"guild_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetGuildEmblemRequest) Reset() {
	*x = GetGuildEmblemRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[32]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetGuildEmblemRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetGuildEmblemRequest) ProtoMessage() {}

func (x *GetGuildEmblemRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[32]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetGuildEmblemRequest.ProtoReflect.Descriptor instead.
func (*GetGuildEmblemRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{32}
}

func (x *GetGuildEmblemRequest) GetGuildId() int32 {
	if x != nil {
		return x.GuildId
	}
	return 0
...
type GetGuildEmblemResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	// um aviso.
	HasEmblem bool   `protobuf:"varint,1,opt,name=has_emblem,json=hasEmblem,proto3" json:"has_emblem,omitempty"`
...
func (x *GetGuildEmblemResponse) Reset() {
	*x = GetGuildEmblemResponse{}
	mi := &file_api_web_v1_web_proto_msgTypes[33]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetGuildEmblemResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetGuildEmblemResponse) ProtoMessage() {}

func (x *GetGuildEmblemResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[33]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetGuildEmblemResponse.ProtoReflect.Descriptor instead.
func (*GetGuildEmblemResponse) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{33}
}

func (x *GetGuildEmblemResponse) GetHasEmblem() bool {
	if x != nil {
		return x.HasEmblem
	}
	return false
...
func (x *GetGuildEmblemResponse) GetImage() []byte {
	if x != nil {
		return x.Image
	}
	return nil
...
func (x *GetGuildEmblemResponse) GetUpdatedAtUnix() int64 {
	if x != nil {
...
type AttachTopupChargeRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	GatewayIdentifier string `protobuf:"bytes,2,opt,name=gateway_identifier,json=gatewayIdentifier,proto3" json:"gateway_identifier,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}

func (x *AttachTopupChargeRequest) Reset() {
	*x = AttachTopupChargeRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[125]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AttachTopupChargeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AttachTopupChargeRequest) ProtoMessage() {}

func (x *AttachTopupChargeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[125]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AttachTopupChargeRequest.ProtoReflect.Descriptor instead.
func (*AttachTopupChargeRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{125}
}

func (x *AttachTopupChargeRequest) GetExternalReference() string {
	if x != nil {
...
func (x *AttachTopupChargeRequest) GetGatewayIdentifier() string {
	if x != nil {
...
type AttachTopupChargeResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Result        AttachResult           `protobuf:"varint,1,opt,name=result,proto3,enum=web.v1.AttachResult" json:"result,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AttachTopupChargeResponse) Reset() {
	*x = AttachTopupChargeResponse{}
	mi := &file_api_web_v1_web_proto_msgTypes[126]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AttachTopupChargeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AttachTopupChargeResponse) ProtoMessage() {}

func (x *AttachTopupChargeResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_web_v1_web_proto_msgTypes[126]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AttachTopupChargeResponse.ProtoReflect.Descriptor instead.
func (*AttachTopupChargeResponse) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{126}
}

func (x *AttachTopupChargeResponse) GetResult() AttachResult {
	if x != nil {
		return x.Result
	}
	return AttachResult_ATTACH_RESULT_UNSPECIFIED
}
...
func (x *ListDonateSpendResponse) Reset() {
	*x = ListDonateSpendResponse{}
	mi := &file_api_web_v1_web_proto_msgTypes[151]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListDonateSpendResponse) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{151}
}
...
func (x *AccountSummary) Reset() {
	*x = AccountSummary{}
	mi := &file_api_web_v1_web_proto_msgTypes[152]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AccountSummary) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{152}
}
...
func (x *SearchAccountsRequest) Reset() {
	*x = SearchAccountsRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[153]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SearchAccountsRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{153}
}
...
func (x *SearchAccountsResponse) Reset() {
	*x = SearchAccountsResponse{}
	mi := &file_api_web_v1_web_proto_msgTypes[154]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SearchAccountsResponse) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{154}
}
...
func (x *AdminItemStat) Reset() {
	*x = AdminItemStat{}
	mi := &file_api_web_v1_web_proto_msgTypes[155]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdminItemStat) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{155}
}
...
func (x *GetItemStatRequest) Reset() {
	*x = GetItemStatRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[156]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetItemStatRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{156}
}
...
func (x *GetItemStatResponse) Reset() {
	*x = GetItemStatResponse{}
	mi := &file_api_web_v1_web_proto_msgTypes[157]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetItemStatResponse) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{157}
}
...
func (x *UpsertItemStatRequest) Reset() {
	*x = UpsertItemStatRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[158]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpsertItemStatRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{158}
}
...
func (x *DeleteItemStatRequest) Reset() {
	*x = DeleteItemStatRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[159]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteItemStatRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{159}
}
...
func (x *AdminMountGrowthCurve) Reset() {
	*x = AdminMountGrowthCurve{}
	mi := &file_api_web_v1_web_proto_msgTypes[160]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdminMountGrowthCurve) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{160}
}
...
func (x *ListMountGrowthCurvesRequest) Reset() {
	*x = ListMountGrowthCurvesRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[161]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListMountGrowthCurvesRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{161}
}
...
func (x *ListMountGrowthCurvesResponse) Reset() {
	*x = ListMountGrowthCurvesResponse{}
	mi := &file_api_web_v1_web_proto_msgTypes[162]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListMountGrowthCurvesResponse) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{162}
}
...
func (x *SetMountGrowthCurveRequest) Reset() {
	*x = SetMountGrowthCurveRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[163]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetMountGrowthCurveRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{163}
}
...
func (x *ClearMountGrowthCurveRequest) Reset() {
	*x = ClearMountGrowthCurveRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[164]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClearMountGrowthCurveRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{164}
}
...
func (x *AdminMountAbsorb) Reset() {
	*x = AdminMountAbsorb{}
	mi := &file_api_web_v1_web_proto_msgTypes[165]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdminMountAbsorb) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{165}
}
...
func (x *MountConfigVersionRequest) Reset() {
	*x = MountConfigVersionRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[166]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MountConfigVersionRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{166}
}
...
func (x *MountConfigVersionResponse) Reset() {
	*x = MountConfigVersionResponse{}
	mi := &file_api_web_v1_web_proto_msgTypes[167]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MountConfigVersionResponse) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{167}
}
...
func (x *ListMountAbsorbRequest) Reset() {
	*x = ListMountAbsorbRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[168]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListMountAbsorbRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{168}
}
...
func (x *ListMountAbsorbResponse) Reset() {
	*x = ListMountAbsorbResponse{}
	mi := &file_api_web_v1_web_proto_msgTypes[169]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListMountAbsorbResponse) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{169}
}
...
func (x *SetMountAbsorbRequest) Reset() {
	*x = SetMountAbsorbRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[170]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetMountAbsorbRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{170}
}
...
func (x *ClearMountAbsorbRequest) Reset() {
	*x = ClearMountAbsorbRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[171]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClearMountAbsorbRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{171}
}
...
func (x *AdminMountBonus) Reset() {
	*x = AdminMountBonus{}
	mi := &file_api_web_v1_web_proto_msgTypes[172]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdminMountBonus) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{172}
}
...
func (x *ListMountBonusRequest) Reset() {
	*x = ListMountBonusRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[173]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListMountBonusRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{173}
}
...
func (x *ListMountBonusResponse) Reset() {
	*x = ListMountBonusResponse{}
	mi := &file_api_web_v1_web_proto_msgTypes[174]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListMountBonusResponse) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{174}
}
...
func (x *SetMountBonusRequest) Reset() {
	*x = SetMountBonusRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[175]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetMountBonusRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{175}
}
...
func (x *ClearMountBonusRequest) Reset() {
	*x = ClearMountBonusRequest{}
	mi := &file_api_web_v1_web_proto_msgTypes[176]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClearMountBonusRequest) Descriptor() ([]byte, []int) {
	return file_api_web_v1_web_proto_rawDescGZIP(), []int{176}
}
...
const file_api_web_v1_web_proto_rawDesc = "" +
	...
	"\n" +
	"discord_id\x18\x05 \x01(\tR\tdiscordId\"W\n" +
	"\x17SetMyDiscordLinkRequest\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\x03R\taccountId\x12\x1d\n" +
	"\n" +
	"discord_id\x18\x02 \x01(\tR\tdiscordId\"M\n" +
	"\x18SetMyDiscordLinkResponse\x121\n" +
	"\x06result\x18\x01 \x01(\x0e2\x19.web.v1.DiscordLinkResultR\x06result\"\x83\x01\n" +
	"\x11SavePixKeyRequest\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\x03R\taccountId\x12\x10\n" +
	"\x03key\x18\x02 \x01(\tR\x03key\x12&\n" +
	"\x04type\x18\x03 \x01(\x0e2\x12.web.v1.PixKeyTypeR\x04type\x12\x15\n" +
	"\x06tax_id\x18\x04 \x01(\tR\x05taxId\"B\n" +
	"\x12SavePixKeyResponse\x12,\n" +
	"\x06result\x18\x01 \x01(\x0e2\x14.web.v1.PixKeyResultR\x06result\"\xaa\x01\n" +
	"\x19ListMarketListingsRequest\x122\n" +
	"\bcurrency\x18\x01 \x01(\x0e2\x16.web.v1.MarketCurrencyR\bcurrency\x12\x12\n" +
	"\x04page\x18\x02 \x01(\x05R\x04page\x12&\n" +
	"\x04sort\x18\x03 \x01(\x0e2\x12.web.v1.MarketSortR\x04sort\x12\x1d\n" +
	"\n" +
	"item_index\x18\x04 \x01(\x05R\titemIndex\"\x97\x02\n" +
	"\rMarketListing\x12\x1d\n" +
	"\n" +
	"item_index\x18\x01 \x01(\x05R\titemIndex\x12\x16\n" +
	"\x06refine\x18\x02 \x01(\x05R\x06refine\x12\x16\n" +
	"\x06amount\x18\x03 \x01(\x05R\x06amount\x122\n" +
	"\bcurrency\x18\x04 \x01(\x0e2\x16.web.v1.MarketCurrencyR\bcurrency\x12\x14\n" +
	"\x05price\x18\x05 \x01(\x03R\x05price\x12)\n" +
	"\x10seller_character\x18\x06 \x01(\tR\x0fsellerCharacter\x12\x18\n" +
	"\avillage\x18\a \x01(\tR\avillage\x12(\n" +
	"\x10open_for_seconds\x18\b \x01(\x03R\x0eopenForSeconds\"\x93\x01\n" +
	"\x1aListMarketListingsResponse\x121\n" +
	"\blistings\x18\x01 \x03(\v2\x15.web.v1.MarketListingR\blistings\x12\x14\n" +
	"\x05total\x18\x02 \x01(\x05R\x05total\x12,\n" +
	"\x12cached_for_seconds\x18\x03 \x01(\x05R\x10cachedForSeconds\"1\n" +
	"\x10GetPixKeyRequest\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\x03R\taccountId\"\xad\x02\n" +
	"\x11GetPixKeyResponse\x12\x17\n" +
	"\ahas_key\x18\x01 \x01(\bR\x06hasKey\x12\x1d\n" +
	"\n" +
	"masked_key\x18\x02 \x01(\tR\tmaskedKey\x12&\n" +
	"\x04type\x18\x03 \x01(\x0e2\x12.web.v1.PixKeyTypeR\x04type\x12\x1a\n" +
	"\bverified\x18\x04 \x01(\bR\bverified\x12\"\n" +
	"\rmasked_tax_id\x18\x05 \x01(\tR\vmaskedTaxId\x120\n" +
	"\x14pending_payout_cents\x18\x06 \x01(\x03R\x12pendingPayoutCents\x12F\n" +
	"\x12payout_wait_reason\x18\a \x01(\x0e2\x18.web.v1.PayoutWaitReasonR\x10payoutWaitReason\"4\n" +
	"\x13DeletePixKeyRequest\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\x03R\taccountId\"J\n" +
	"\x14DeletePixKeyResponse\x122\n" +
	"\x06result\x18\x01 \x01(\x0e2\x1a.web.v1.PixKeyDeleteResultR\x06result\"=\n" +
	"\x1cGetMyCurrentPixChargeRequest\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\x03R\taccountId\"\xf1\x03\n" +
	"\x1dGetMyCurrentPixChargeResponse\x12\x1d\n" +
	"\n" +
	"has_charge\x18\x01 \x01(\bR\thasCharge\x12\x19\n" +
	"\bpix_code\x18\x02 \x01(\tR\apixCode\x12!\n" +
	"\famount_cents\x18\x03 \x01(\x03R\vamountCents\x12\x1d\n" +
	"\n" +
	"expires_at\x18\x04 \x01(\x03R\texpiresAt\x12,\n" +
	"\x05state\x18\x05 \x01(\x0e2\x16.web.v1.PixChargeStateR\x05state\x12\x1d\n" +
	"\n" +
	"item_index\x18\x06 \x01(\x05R\titemIndex\x12!\n" +
	"\frefine_level\x18\a \x01(\x05R\vrefineLevel\x12\x1d\n" +
	"\n" +
	...
	"\frefund_state\x18\v \x01(\x0e2\x13.web.v1.RefundStateR\vrefundState\x12<\n" +
	"\x0edelivery_state\x18\f \x01(\x0e2\x15.web.v1.DeliveryStateR\rdeliveryState\"\xba\x01\n" +
	"\x19NotifySyncpayEventRequest\x12,\n" +
	"\x04kind\x18\x01 \x01(\x0e2\x18.web.v1.SyncpayEventKindR\x04kind\x12\x1e\n" +
	"\n" +
	"identifier\x18\x02 \x01(\tR\n" +
	"identifier\x12!\n" +
	"\famount_cents\x18\x03 \x01(\x03R\vamountCents\x12,\n" +
	"\x12final_amount_cents\x18\x04 \x01(\x03R\x10finalAmountCents\"6\n" +
	"\x1aNotifySyncpayEventResponse\x12\x18\n" +
	"\ahandled\x18\x01 \x01(\bR\ahandled\"E\n" +
	...
	"\vtotal_count\x18\x02 \x01(\x05R\n" +
	"totalCount\"7\n" +
	"\x16ListMyLedGuildsRequest\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\x03R\taccountId\"C\n" +
	"\x17ListMyLedGuildsResponse\x12(\n" +
	"\x06guilds\x18\x01 \x03(\v2\x10.web.v1.LedGuildR\x06guilds\"X\n" +
	"\bLedGuild\x12\x19\n" +
	"\bguild_id\x18\x01 \x01(\x05R\aguildId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1d\n" +
	"\n" +
	"has_emblem\x18\x03 \x01(\bR\thasEmblem\"i\n" +
	"\x17SetMyGuildEmblemRequest\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\x03R\taccountId\x12\x19\n" +
	"\bguild_id\x18\x02 \x01(\x05R\aguildId\x12\x14\n" +
	"\x05image\x18\x03 \x01(\fR\x05image\"M\n" +
	"\x18SetMyGuildEmblemResponse\x121\n" +
	"\x06result\x18\x01 \x01(\x0e2\x19.web.v1.GuildEmblemResultR\x06result\"U\n" +
	"\x19ClearMyGuildEmblemRequest\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\x03R\taccountId\x12\x19\n" +
	"\bguild_id\x18\x02 \x01(\x05R\aguildId\"O\n" +
	"\x1aClearMyGuildEmblemResponse\x121\n" +
	"\x06result\x18\x01 \x01(\x0e2\x19.web.v1.GuildEmblemResultR\x06result\"2\n" +
	"\x15GetGuildEmblemRequest\x12\x19\n" +
	"\bguild_id\x18\x01 \x01(\x05R\aguildId\"u\n" +
	"\x16GetGuildEmblemResponse\x12\x1d\n" +
	"\n" +
	"has_emblem\x18\x01 \x01(\bR\thasEmblem\x12\x14\n" +
	"\x05image\x18\x02 \x01(\fR\x05image\x12&\n" +
	"\x0fupdated_at_unix\x18\x03 \x01(\x03R\rupdatedAtUnix\"8\n" +
	...
	"\rClaimResponse\x12+\n" +
	"\x06result\x18\x01 \x01(\x0e2\x13.web.v1.ClaimResultR\x06result\"x\n" +
	"\x18AttachTopupChargeRequest\x12-\n" +
	"\x12external_reference\x18\x01 \x01(\tR\x11externalReference\x12-\n" +
	"\x12gateway_identifier\x18\x02 \x01(\tR\x11gatewayIdentifier\"I\n" +
	"\x19AttachTopupChargeResponse\x12,\n" +
	"\x06result\x18\x01 \x01(\x0e2\x14.web.v1.AttachResultR\x06result\"7\n" +
	...
	"\x14CREATE_RESULT_CLOSED\x10\x04*\xd4\x01\n" +
	"\x11DiscordLinkResult\x12#\n" +
	"\x1fDISCORD_LINK_RESULT_UNSPECIFIED\x10\x00\x12\x1a\n" +
	"\x16DISCORD_LINK_RESULT_OK\x10\x01\x120\n" +
	",DISCORD_LINK_RESULT_ALREADY_LINKED_ELSEWHERE\x10\x02\x12\x1f\n" +
	"\x1bDISCORD_LINK_RESULT_INVALID\x10\x03\x12+\n" +
	"'DISCORD_LINK_RESULT_ACCOUNT_HAS_ANOTHER\x10\x04*\x89\x01\n" +
	"\n" +
	"PixKeyType\x12\x1c\n" +
	"\x18PIX_KEY_TYPE_UNSPECIFIED\x10\x00\x12\x14\n" +
	"\x10PIX_KEY_TYPE_CPF\x10\x01\x12\x16\n" +
	"\x12PIX_KEY_TYPE_EMAIL\x10\x02\x12\x16\n" +
	"\x12PIX_KEY_TYPE_PHONE\x10\x03\x12\x17\n" +
	"\x13PIX_KEY_TYPE_RANDOM\x10\x04*\xeb\x01\n" +
	"\fPixKeyResult\x12\x1e\n" +
	"\x1aPIX_KEY_RESULT_UNSPECIFIED\x10\x00\x12\x15\n" +
	"\x11PIX_KEY_RESULT_OK\x10\x01\x12\x1a\n" +
	"\x16PIX_KEY_RESULT_INVALID\x10\x02\x12#\n" +
	"\x1fPIX_KEY_RESULT_SALE_IN_PROGRESS\x10\x03\x12\x1d\n" +
	"\x19PIX_KEY_RESULT_NO_ACCOUNT\x10\x04\x12!\n" +
	"\x1dPIX_KEY_RESULT_INVALID_TAX_ID\x10\x05\x12!\n" +
	"\x1dPIX_KEY_RESULT_PAYOUT_PENDING\x10\x06*\x7f\n" +
	"\x0eMarketCurrency\x12\x1f\n" +
	"\x1bMARKET_CURRENCY_UNSPECIFIED\x10\x00\x12\x18\n" +
	"\x14MARKET_CURRENCY_GOLD\x10\x01\x12\x18\n" +
	"\x14MARKET_CURRENCY_CASH\x10\x02\x12\x18\n" +
	"\x14MARKET_CURRENCY_REAL\x10\x03*x\n" +
	"\n" +
	"MarketSort\x12\x1b\n" +
	"\x17MARKET_SORT_UNSPECIFIED\x10\x00\x12\x19\n" +
	"\x15MARKET_SORT_PRICE_ASC\x10\x01\x12\x1a\n" +
	"\x16MARKET_SORT_PRICE_DESC\x10\x02\x12\x16\n" +
	"\x12MARKET_SORT_NEWEST\x10\x03*\xd1\x01\n" +
	"\x12PixKeyDeleteResult\x12%\n" +
	"!PIX_KEY_DELETE_RESULT_UNSPECIFIED\x10\x00\x12\x1c\n" +
	"\x18PIX_KEY_DELETE_RESULT_OK\x10\x01\x12 \n" +
	"\x1cPIX_KEY_DELETE_RESULT_NO_KEY\x10\x02\x12*\n" +
	"&PIX_KEY_DELETE_RESULT_SALE_IN_PROGRESS\x10\x03\x12(\n" +
	"$PIX_KEY_DELETE_RESULT_PAYOUT_PENDING\x10\x04*\xa7\x01\n" +
	"\x10PayoutWaitReason\x12\"\n" +
	"\x1ePAYOUT_WAIT_REASON_UNSPECIFIED\x10\x00\x12'\n" +
	"#PAYOUT_WAIT_REASON_NO_KEY_OR_TAX_ID\x10\x01\x12\"\n" +
	"\x1ePAYOUT_WAIT_REASON_IN_PROGRESS\x10\x02\x12\"\n" +
	"\x1ePAYOUT_WAIT_REASON_NEEDS_STAFF\x10\x03*\xc5\x01\n" +
	"\x0ePixChargeState\x12 \n" +
	"\x1cPIX_CHARGE_STATE_UNSPECIFIED\x10\x00\x12\x19\n" +
	"\x15PIX_CHARGE_STATE_OPEN\x10\x01\x12\x1c\n" +
	...
	"\x1aPIX_CHARGE_STATE_PAID_LATE\x10\x05*\x9b\x01\n" +
	"\rDeliveryState\x12\x1e\n" +
	"\x1aDELIVERY_STATE_UNSPECIFIED\x10\x00\x12\x1a\n" +
	"\x16DELIVERY_STATE_WAITING\x10\x01\x12\x17\n" +
	"\x13DELIVERY_STATE_HELD\x10\x02\x12\x1c\n" +
	"\x18DELIVERY_STATE_DELIVERED\x10\x03\x12\x17\n" +
	"\x13DELIVERY_STATE_LOST\x10\x04*\x95\x01\n" +
	...
	"\x13REFUND_STATE_FAILED\x10\x04*u\n" +
	"\x10SyncpayEventKind\x12\"\n" +
	"\x1eSYNCPAY_EVENT_KIND_UNSPECIFIED\x10\x00\x12\x1d\n" +
	"\x19SYNCPAY_EVENT_KIND_CASHIN\x10\x01\x12\x1e\n" +
	"\x1aSYNCPAY_EVENT_KIND_CASHOUT\x10\x02*\xc5\x01\n" +
	"\x11GuildEmblemResult\x12#\n" +
	"\x1fGUILD_EMBLEM_RESULT_UNSPECIFIED\x10\x00\x12\x1a\n" +
	"\x16GUILD_EMBLEM_RESULT_OK\x10\x01\x12\"\n" +
	"\x1eGUILD_EMBLEM_RESULT_NOT_LEADER\x10\x02\x12%\n" +
	"!GUILD_EMBLEM_RESULT_INVALID_IMAGE\x10\x03\x12$\n" +
	" GUILD_EMBLEM_RESULT_RATE_LIMITED\x10\x04*\xb2\x01\n" +
	...
	"\x16TOPUP_RESULT_NOT_FOUND\x10\x03*\xea\x01\n" +
	"\fAttachResult\x12\x1d\n" +
	"\x19ATTACH_RESULT_UNSPECIFIED\x10\x00\x12\x1a\n" +
	"\x16ATTACH_RESULT_ATTACHED\x10\x01\x12\x19\n" +
	"\x15ATTACH_RESULT_ALREADY\x10\x02\x12 \n" +
	"\x1cATTACH_RESULT_CONFLICT_ORDER\x10\x03\x12%\n" +
	"!ATTACH_RESULT_CONFLICT_IDENTIFIER\x10\x04\x12\x1b\n" +
	"\x17ATTACH_RESULT_NOT_FOUND\x10\x05\x12\x1e\n" +
	"\x1aATTACH_RESULT_ALREADY_PAID\x10\x06*\\\n" +
	...
	"\x1bDONATE_LEDGER_ACTION_CREDIT\x10\x022\x92\x02\n" +
	"\x11AccountWebService\x12L\n" +
	"\rCreateAccount\x12\x1c.web.v1.CreateAccountRequest\x1a\x1d.web.v1.CreateAccountResponse\x12X\n" +
	"\x11VerifyCredentials\x12 .web.v1.VerifyCredentialsRequest\x1a!.web.v1.VerifyCredentialsResponse\x12U\n" +
	"\x10SetMyDiscordLink\x12\x1f.web.v1.SetMyDiscordLinkRequest\x1a .web.v1.SetMyDiscordLinkResponse2\xa4\x03\n" +
	"\rRmtWebService\x12C\n" +
	"\n" +
	"SavePixKey\x12\x19.web.v1.SavePixKeyRequest\x1a\x1a.web.v1.SavePixKeyResponse\x12@\n" +
	"\tGetPixKey\x12\x18.web.v1.GetPixKeyRequest\x1a\x19.web.v1.GetPixKeyResponse\x12I\n" +
	"\fDeletePixKey\x12\x1b.web.v1.DeletePixKeyRequest\x1a\x1c.web.v1.DeletePixKeyResponse\x12d\n" +
	"\x15GetMyCurrentPixCharge\x12$.web.v1.GetMyCurrentPixChargeRequest\x1a%.web.v1.GetMyCurrentPixChargeResponse\x12[\n" +
	"\x12ListMarketListings\x12!.web.v1.ListMarketListingsRequest\x1a\".web.v1.ListMarketListingsResponse2o\n" +
	"\x10RmtSystemService\x12[\n" +
	"\x12NotifySyncpayEvent\x12!.web.v1.NotifySyncpayEventRequest\x1a\".web.v1.NotifySyncpayEventResponse2\xb8\x01\n" +
	...
	"\x0fListDuelRanking\x12\x1e.web.v1.ListDuelRankingRequest\x1a\x1f.web.v1.ListDuelRankingResponse2\xc5\x03\n" +
	"\x13CharacterWebService\x12U\n" +
	"\x10ListMyCharacters\x12\x1f.web.v1.ListMyCharactersRequest\x1a .web.v1.ListMyCharactersResponse\x12R\n" +
	"\x0fListMyLedGuilds\x12\x1e.web.v1.ListMyLedGuildsRequest\x1a\x1f.web.v1.ListMyLedGuildsResponse\x12U\n" +
	"\x10SetMyGuildEmblem\x12\x1f.web.v1.SetMyGuildEmblemRequest\x1a .web.v1.SetMyGuildEmblemResponse\x12[\n" +
	"\x12ClearMyGuildEmblem\x12!.web.v1.ClearMyGuildEmblemRequest\x1a\".web.v1.ClearMyGuildEmblemResponse\x12O\n" +
	"\x0eGetGuildEmblem\x12\x1d.web.v1.GetGuildEmblemRequest\x1a\x1e.web.v1.GetGuildEmblemResponse2V\n" +
	...
	"\x05Claim\x12\x14.web.v1.ClaimRequest\x1a\x15.web.v1.ClaimResponse2\x98\x04\n" +
	...
	"\rGetTopupOrder\x12\x1c.web.v1.GetTopupOrderRequest\x1a\x1d.web.v1.GetTopupOrderResponse\x12X\n" +
	"\x11AttachTopupCharge\x12 .web.v1.AttachTopupChargeRequest\x1a!.web.v1.AttachTopupChargeResponse2\xbc\x03\n" +
...
var file_api_web_v1_web_proto_enumTypes = make([]protoimpl.EnumInfo, 23)
var file_api_web_v1_web_proto_msgTypes = make([]protoimpl.MessageInfo, 177)
var file_api_web_v1_web_proto_goTypes = []any{
	(CreateResult)(0),                     // 0: web.v1.CreateResult
	(DiscordLinkResult)(0),                // 1: web.v1.DiscordLinkResult
	(PixKeyType)(0),                       // 2: web.v1.PixKeyType
	(PixKeyResult)(0),                     // 3: web.v1.PixKeyResult
	(MarketCurrency)(0),                   // 4: web.v1.MarketCurrency
	(MarketSort)(0),                       // 5: web.v1.MarketSort
	(PixKeyDeleteResult)(0),               // 6: web.v1.PixKeyDeleteResult
	(PayoutWaitReason)(0),                 // 7: web.v1.PayoutWaitReason
	(PixChargeState)(0),                   // 8: web.v1.PixChargeState
	(DeliveryState)(0),                    // 9: web.v1.DeliveryState
	(RefundState)(0),                      // 10: web.v1.RefundState
	(SyncpayEventKind)(0),                 // 11: web.v1.SyncpayEventKind
	(GuildEmblemResult)(0),                // 12: web.v1.GuildEmblemResult
	(AdminResult)(0),                      // 13: web.v1.AdminResult
	(AttributeMapTransformOperation)(0),   // 14: web.v1.AttributeMapTransformOperation
	(BuyResult)(0),                        // 15: web.v1.BuyResult
	(ClaimResult)(0),                      // 16: web.v1.ClaimResult
	(PaymentMethod)(0),                    // 17: web.v1.PaymentMethod
	(TopupResult)(0),                      // 18: web.v1.TopupResult
	(AttachResult)(0),                     // 19: web.v1.AttachResult
	(TopupStatus)(0),                      // 20: web.v1.TopupStatus
	(RevenueBucket)(0),                    // 21: web.v1.RevenueBucket
	(DonateLedgerAction)(0),               // 22: web.v1.DonateLedgerAction
	(*CreateAccountRequest)(nil),          // 23: web.v1.CreateAccountRequest
	(*CreateAccountResponse)(nil),         // 24: web.v1.CreateAccountResponse
	(*VerifyCredentialsRequest)(nil),      // 25: web.v1.VerifyCredentialsRequest
	(*VerifyCredentialsResponse)(nil),     // 26: web.v1.VerifyCredentialsResponse
	(*SetMyDiscordLinkRequest)(nil),       // 27: web.v1.SetMyDiscordLinkRequest
	(*SetMyDiscordLinkResponse)(nil),      // 28: web.v1.SetMyDiscordLinkResponse
	(*SavePixKeyRequest)(nil),             // 29: web.v1.SavePixKeyRequest
	(*SavePixKeyResponse)(nil),            // 30: web.v1.SavePixKeyResponse
	(*ListMarketListingsRequest)(nil),     // 31: web.v1.ListMarketListingsRequest
	(*MarketListing)(nil),                 // 32: web.v1.MarketListing
	(*ListMarketListingsResponse)(nil),    // 33: web.v1.ListMarketListingsResponse
	(*GetPixKeyRequest)(nil),              // 34: web.v1.GetPixKeyRequest
	(*GetPixKeyResponse)(nil),             // 35: web.v1.GetPixKeyResponse
	(*DeletePixKeyRequest)(nil),           // 36: web.v1.DeletePixKeyRequest
	(*DeletePixKeyResponse)(nil),          // 37: web.v1.DeletePixKeyResponse
	(*GetMyCurrentPixChargeRequest)(nil),  // 38: web.v1.GetMyCurrentPixChargeRequest
	(*GetMyCurrentPixChargeResponse)(nil), // 39: web.v1.GetMyCurrentPixChargeResponse
	(*NotifySyncpayEventRequest)(nil),     // 40: web.v1.NotifySyncpayEventRequest
	(*NotifySyncpayEventResponse)(nil),    // 41: web.v1.NotifySyncpayEventResponse
	(*ListExpRankingRequest)(nil),         // 42: web.v1.ListExpRankingRequest
	(*RankingEntry)(nil),                  // 43: web.v1.RankingEntry
	(*ListExpRankingResponse)(nil),        // 44: web.v1.ListExpRankingResponse
	(*ListDuelRankingRequest)(nil),        // 45: web.v1.ListDuelRankingRequest
	(*DuelRankingEntry)(nil),              // 46: web.v1.DuelRankingEntry
	(*ListDuelRankingResponse)(nil),       // 47: web.v1.ListDuelRankingResponse
	(*ListMyLedGuildsRequest)(nil),        // 48: web.v1.ListMyLedGuildsRequest
	(*ListMyLedGuildsResponse)(nil),       // 49: web.v1.ListMyLedGuildsResponse
	(*LedGuild)(nil),                      // 50: web.v1.LedGuild
	(*SetMyGuildEmblemRequest)(nil),       // 51: web.v1.SetMyGuildEmblemRequest
	(*SetMyGuildEmblemResponse)(nil),      // 52: web.v1.SetMyGuildEmblemResponse
	(*ClearMyGuildEmblemRequest)(nil),     // 53: web.v1.ClearMyGuildEmblemRequest
	(*ClearMyGuildEmblemResponse)(nil),    // 54: web.v1.ClearMyGuildEmblemResponse
	(*GetGuildEmblemRequest)(nil),         // 55: web.v1.GetGuildEmblemRequest
	(*GetGuildEmblemResponse)(nil),        // 56: web.v1.GetGuildEmblemResponse
	(*ListMyCharactersRequest)(nil),       // 57: web.v1.ListMyCharactersRequest
	(*WebCharacterSummary)(nil),           // 58: web.v1.WebCharacterSummary
	(*ListMyCharactersResponse)(nil),      // 59: web.v1.ListMyCharactersResponse
	(*ListItemsRequest)(nil),              // 60: web.v1.ListItemsRequest
	(*ListItemsResponse)(nil),             // 61: web.v1.ListItemsResponse
	(*AdminAck)(nil),                      // 62: web.v1.AdminAck
	(*AdminNpcShopItem)(nil),              // 63: web.v1.AdminNpcShopItem
	(*AdminNpc)(nil),                      // 64: web.v1.AdminNpc
	(*ListNpcsRequest)(nil),               // 65: web.v1.ListNpcsRequest
	(*ListNpcsResponse)(nil),              // 66: web.v1.ListNpcsResponse
	(*GetNpcRequest)(nil),                 // 67: web.v1.GetNpcRequest
	(*GetNpcResponse)(nil),                // 68: web.v1.GetNpcResponse
	(*UpsertNpcRequest)(nil),              // 69: web.v1.UpsertNpcRequest
	(*UpsertNpcResponse)(nil),             // 70: web.v1.UpsertNpcResponse
	(*SetNpcVisibilityRequest)(nil),       // 71: web.v1.SetNpcVisibilityRequest
	(*SetNpcShopRequest)(nil),             // 72: web.v1.SetNpcShopRequest
	(*SetItemPriceRequest)(nil),           // 73: web.v1.SetItemPriceRequest
	(*DeleteNpcRequest)(nil),              // 74: web.v1.DeleteNpcRequest
	(*MerchantTemplate)(nil),              // 75: web.v1.MerchantTemplate
	(*ListMerchantTemplatesRequest)(nil),  // 76: web.v1.ListMerchantTemplatesRequest
	(*ListMerchantTemplatesResponse)(nil), // 77: web.v1.ListMerchantTemplatesResponse
	(*ItemCatalogEntry)(nil),              // 78: web.v1.ItemCatalogEntry
	(*ListItemCatalogRequest)(nil),        // 79: web.v1.ListItemCatalogRequest
	(*ListItemCatalogResponse)(nil),       // 80: web.v1.ListItemCatalogResponse
	(*DropItemMob)(nil),                   // 81: web.v1.DropItemMob
	(*DropItemEntry)(nil),                 // 82: web.v1.DropItemEntry
	(*ListDropItemsRequest)(nil),          // 83: web.v1.ListDropItemsRequest
	(*ListDropItemsResponse)(nil),         // 84: web.v1.ListDropItemsResponse
	(*MobDropItem)(nil),                   // 85: web.v1.MobDropItem
	(*MobDropEntry)(nil),                  // 86: web.v1.MobDropEntry
	(*ListMobDropsRequest)(nil),           // 87: web.v1.ListMobDropsRequest
	(*ListMobDropsResponse)(nil),          // 88: web.v1.ListMobDropsResponse
	(*ItemPrice)(nil),                     // 89: web.v1.ItemPrice
	(*ListItemPricesRequest)(nil),         // 90: web.v1.ListItemPricesRequest
	(*ListItemPricesResponse)(nil),        // 91: web.v1.ListItemPricesResponse
	(*MapZone)(nil),                       // 92: web.v1.MapZone
	(*ListMapZonesRequest)(nil),           // 93: web.v1.ListMapZonesRequest
	(*ListMapZonesResponse)(nil),          // 94: web.v1.ListMapZonesResponse
	(*MobTemplateFile)(nil),               // 95: web.v1.MobTemplateFile
	(*ListMobTemplatesRequest)(nil),       // 96: web.v1.ListMobTemplatesRequest
	(*ListMobTemplatesResponse)(nil),      // 97: web.v1.ListMobTemplatesResponse
	(*AdminMobTemplateEquipItem)(nil),     // 98: web.v1.AdminMobTemplateEquipItem
	(*AdminMobTemplateStat)(nil),          // 99: web.v1.AdminMobTemplateStat
	(*GetMobTemplateStatRequest)(nil),     // 100: web.v1.GetMobTemplateStatRequest
	(*GetMobTemplateStatResponse)(nil),    // 101: web.v1.GetMobTemplateStatResponse
	(*AdminMobOrigin)(nil),                // 102: web.v1.AdminMobOrigin
	(*UpsertMobTemplateStatRequest)(nil),  // 103: web.v1.UpsertMobTemplateStatRequest
	(*UpsertMobTemplateStatResponse)(nil), // 104: web.v1.UpsertMobTemplateStatResponse
	(*SetMobTemplateEquipRequest)(nil),    // 105: web.v1.SetMobTemplateEquipRequest
	(*DeleteMobTemplateStatRequest)(nil),  // 106: web.v1.DeleteMobTemplateStatRequest
	(*GetAttributeMapInfoRequest)(nil),    // 107: web.v1.GetAttributeMapInfoRequest
	(*GetAttributeMapInfoResponse)(nil),   // 108: web.v1.GetAttributeMapInfoResponse
	(*AttributeMapInfo)(nil),              // 109: web.v1.AttributeMapInfo
	(*AttributeMapValueCount)(nil),        // 110: web.v1.AttributeMapValueCount
	(*AttributeMapMeaning)(nil),           // 111: web.v1.AttributeMapMeaning
	(*AttributeMapRect)(nil),              // 112: web.v1.AttributeMapRect
	(*AttributeMapTransformFilter)(nil),   // 113: web.v1.AttributeMapTransformFilter
	(*TransformAttributeMapRequest)(nil),  // 114: web.v1.TransformAttributeMapRequest
	(*TransformAttributeMapResponse)(nil), // 115: web.v1.TransformAttributeMapResponse
	(*DonateShopItem)(nil),                // 116: web.v1.DonateShopItem
	(*ListShopItemsRequest)(nil),          // 117: web.v1.ListShopItemsRequest
	(*ListShopItemsResponse)(nil),         // 118: web.v1.ListShopItemsResponse
	(*UpsertShopItemRequest)(nil),         // 119: web.v1.UpsertShopItemRequest
	(*UpsertShopItemResponse)(nil),        // 120: web.v1.UpsertShopItemResponse
	(*SetShopItemEnabledRequest)(nil),     // 121: web.v1.SetShopItemEnabledRequest
	(*DeleteShopItemRequest)(nil),         // 122: web.v1.DeleteShopItemRequest
	(*CreditDonateBalanceRequest)(nil),    // 123: web.v1.CreditDonateBalanceRequest
	(*CreditDonateBalanceResponse)(nil),   // 124: web.v1.CreditDonateBalanceResponse
	(*ListStoreItemsRequest)(nil),         // 125: web.v1.ListStoreItemsRequest
	(*ListStoreItemsResponse)(nil),        // 126: web.v1.ListStoreItemsResponse
	(*GetBalanceRequest)(nil),             // 127: web.v1.GetBalanceRequest
	(*GetBalanceResponse)(nil),            // 128: web.v1.GetBalanceResponse
	(*BuyRequest)(nil),                    // 129: web.v1.BuyRequest
	(*BuyResponse)(nil),                   // 130: web.v1.BuyResponse
	(*DailyRewardItem)(nil),               // 131: web.v1.DailyRewardItem
	(*ListRewardItemsRequest)(nil),        // 132: web.v1.ListRewardItemsRequest
	(*ListRewardItemsResponse)(nil),       // 133: web.v1.ListRewardItemsResponse
	(*UpsertRewardItemRequest)(nil),       // 134: web.v1.UpsertRewardItemRequest
	(*UpsertRewardItemResponse)(nil),      // 135: web.v1.UpsertRewardItemResponse
	(*SetRewardItemEnabledRequest)(nil),   // 136: web.v1.SetRewardItemEnabledRequest
	(*DeleteRewardItemRequest)(nil),       // 137: web.v1.DeleteRewardItemRequest
	(*WorldEventConfig)(nil),              // 138: web.v1.WorldEventConfig
	(*GetWorldEventConfigRequest)(nil),    // 139: web.v1.GetWorldEventConfigRequest
	(*GetWorldEventConfigResponse)(nil),   // 140: web.v1.GetWorldEventConfigResponse
	(*SetWorldEventConfigRequest)(nil),    // 141: web.v1.SetWorldEventConfigRequest
	(*ListRewardsRequest)(nil),            // 142: web.v1.ListRewardsRequest
	(*ListRewardsResponse)(nil),           // 143: web.v1.ListRewardsResponse
	(*GetClaimStatusRequest)(nil),         // 144: web.v1.GetClaimStatusRequest
	(*GetClaimStatusResponse)(nil),        // 145: web.v1.GetClaimStatusResponse
	(*ClaimRequest)(nil),                  // 146: web.v1.ClaimRequest
	(*ClaimResponse)(nil),                 // 147: web.v1.ClaimResponse
	(*AttachTopupChargeRequest)(nil),      // 148: web.v1.AttachTopupChargeRequest
	(*AttachTopupChargeResponse)(nil),     // 149: web.v1.AttachTopupChargeResponse
	(*GetPayerProfileRequest)(nil),        // 150: web.v1.GetPayerProfileRequest
	(*GetPayerProfileResponse)(nil),       // 151: web.v1.GetPayerProfileResponse
	(*SavePayerProfileRequest)(nil),       // 152: web.v1.SavePayerProfileRequest
	(*SavePayerProfileResponse)(nil),      // 153: web.v1.SavePayerProfileResponse
	(*CreateTopupOrderRequest)(nil),       // 154: web.v1.CreateTopupOrderRequest
	(*CreateTopupOrderResponse)(nil),      // 155: web.v1.CreateTopupOrderResponse
	(*ConfirmTopupOrderRequest)(nil),      // 156: web.v1.ConfirmTopupOrderRequest
	(*ConfirmTopupOrderResponse)(nil),     // 157: web.v1.ConfirmTopupOrderResponse
	(*GetTopupOrderRequest)(nil),          // 158: web.v1.GetTopupOrderRequest
	(*GetTopupOrderResponse)(nil),         // 159: web.v1.GetTopupOrderResponse
	(*RevenueWindow)(nil),                 // 160: web.v1.RevenueWindow
	(*RevenueTotals)(nil),                 // 161: web.v1.RevenueTotals
	(*RevenueByMethod)(nil),               // 162: web.v1.RevenueByMethod
	(*RevenuePoint)(nil),                  // 163: web.v1.RevenuePoint
	(*GetRevenueSummaryRequest)(nil),      // 164: web.v1.GetRevenueSummaryRequest
	(*GetRevenueSummaryResponse)(nil),     // 165: web.v1.GetRevenueSummaryResponse
	(*TopupOrderRow)(nil),                 // 166: web.v1.TopupOrderRow
	(*ListTopupOrdersRequest)(nil),        // 167: web.v1.ListTopupOrdersRequest
	(*ListTopupOrdersResponse)(nil),       // 168: web.v1.ListTopupOrdersResponse
	(*TopBuyerRow)(nil),                   // 169: web.v1.TopBuyerRow
	(*ListTopBuyersRequest)(nil),          // 170: web.v1.ListTopBuyersRequest
	(*ListTopBuyersResponse)(nil),         // 171: web.v1.ListTopBuyersResponse
	(*DonateLedgerRow)(nil),               // 172: web.v1.DonateLedgerRow
	(*ListDonateSpendRequest)(nil),        // 173: web.v1.ListDonateSpendRequest
	(*ListDonateSpendResponse)(nil),       // 174: web.v1.ListDonateSpendResponse
	(*AccountSummary)(nil),                // 175: web.v1.AccountSummary
	(*SearchAccountsRequest)(nil),         // 176: web.v1.SearchAccountsRequest
	(*SearchAccountsResponse)(nil),        // 177: web.v1.SearchAccountsResponse
	(*AdminItemStat)(nil),                 // 178: web.v1.AdminItemStat
	(*GetItemStatRequest)(nil),            // 179: web.v1.GetItemStatRequest
	(*GetItemStatResponse)(nil),           // 180: web.v1.GetItemStatResponse
	(*UpsertItemStatRequest)(nil),         // 181: web.v1.UpsertItemStatRequest
	(*DeleteItemStatRequest)(nil),         // 182: web.v1.DeleteItemStatRequest
	(*AdminMountGrowthCurve)(nil),         // 183: web.v1.AdminMountGrowthCurve
	(*ListMountGrowthCurvesRequest)(nil),  // 184: web.v1.ListMountGrowthCurvesRequest
	(*ListMountGrowthCurvesResponse)(nil), // 185: web.v1.ListMountGrowthCurvesResponse
	(*SetMountGrowthCurveRequest)(nil),    // 186: web.v1.SetMountGrowthCurveRequest
	(*ClearMountGrowthCurveRequest)(nil),  // 187: web.v1.ClearMountGrowthCurveRequest
	(*AdminMountAbsorb)(nil),              // 188: web.v1.AdminMountAbsorb
	(*MountConfigVersionRequest)(nil),     // 189: web.v1.MountConfigVersionRequest
	(*MountConfigVersionResponse)(nil),    // 190: web.v1.MountConfigVersionResponse
	(*ListMountAbsorbRequest)(nil),        // 191: web.v1.ListMountAbsorbRequest
	(*ListMountAbsorbResponse)(nil),       // 192: web.v1.ListMountAbsorbResponse
	(*SetMountAbsorbRequest)(nil),         // 193: web.v1.SetMountAbsorbRequest
	(*ClearMountAbsorbRequest)(nil),       // 194: web.v1.ClearMountAbsorbRequest
	(*AdminMountBonus)(nil),               // 195: web.v1.AdminMountBonus
	(*ListMountBonusRequest)(nil),         // 196: web.v1.ListMountBonusRequest
	(*ListMountBonusResponse)(nil),        // 197: web.v1.ListMountBonusResponse
	(*SetMountBonusRequest)(nil),          // 198: web.v1.SetMountBonusRequest
	(*ClearMountBonusRequest)(nil),        // 199: web.v1.ClearMountBonusRequest
}
var file_api_web_v1_web_proto_depIdxs = []int32{
	0,   // 0: web.v1.CreateAccountResponse.result:type_name -> web.v1.CreateResult
	1,   // 1: web.v1.SetMyDiscordLinkResponse.result:type_name -> web.v1.DiscordLinkResult
	2,   // 2: web.v1.SavePixKeyRequest.type:type_name -> web.v1.PixKeyType
	3,   // 3: web.v1.SavePixKeyResponse.result:type_name -> web.v1.PixKeyResult
	4,   // 4: web.v1.ListMarketListingsRequest.currency:type_name -> web.v1.MarketCurrency
	5,   // 5: web.v1.ListMarketListingsRequest.sort:type_name -> web.v1.MarketSort
	4,   // 6: web.v1.MarketListing.currency:type_name -> web.v1.MarketCurrency
	32,  // 7: web.v1.ListMarketListingsResponse.listings:type_name -> web.v1.MarketListing
	2,   // 8: web.v1.GetPixKeyResponse.type:type_name -> web.v1.PixKeyType
	7,   // 9: web.v1.GetPixKeyResponse.payout_wait_reason:type_name -> web.v1.PayoutWaitReason
	6,   // 10: web.v1.DeletePixKeyResponse.result:type_name -> web.v1.PixKeyDeleteResult
	8,   // 11: web.v1.GetMyCurrentPixChargeResponse.state:type_name -> web.v1.PixChargeState
	10,  // 12: web.v1.GetMyCurrentPixChargeResponse.refund_state:type_name -> web.v1.RefundState
	9,   // 13: web.v1.GetMyCurrentPixChargeResponse.delivery_state:type_name -> web.v1.DeliveryState
	11,  // 14: web.v1.NotifySyncpayEventRequest.kind:type_name -> web.v1.SyncpayEventKind
	43,  // 15: web.v1.ListExpRankingResponse.entries:type_name -> web.v1.RankingEntry
	46,  // 16: web.v1.ListDuelRankingResponse.entries:type_name -> web.v1.DuelRankingEntry
	50,  // 17: web.v1.ListMyLedGuildsResponse.guilds:type_name -> web.v1.LedGuild
	12,  // 18: web.v1.SetMyGuildEmblemResponse.result:type_name -> web.v1.GuildEmblemResult
	12,  // 19: web.v1.ClearMyGuildEmblemResponse.result:type_name -> web.v1.GuildEmblemResult
	58,  // 20: web.v1.ListMyCharactersResponse.characters:type_name -> web.v1.WebCharacterSummary
	78,  // 21: web.v1.ListItemsResponse.items:type_name -> web.v1.ItemCatalogEntry
	13,  // 22: web.v1.AdminAck.result:type_name -> web.v1.AdminResult
	63,  // 23: web.v1.AdminNpc.shop:type_name -> web.v1.AdminNpcShopItem
	13,  // 24: web.v1.ListNpcsResponse.result:type_name -> web.v1.AdminResult
	64,  // 25: web.v1.ListNpcsResponse.npcs:type_name -> web.v1.AdminNpc
	13,  // 26: web.v1.GetNpcResponse.result:type_name -> web.v1.AdminResult
	64,  // 27: web.v1.GetNpcResponse.npc:type_name -> web.v1.AdminNpc
	13,  // 28: web.v1.UpsertNpcResponse.result:type_name -> web.v1.AdminResult
	63,  // 29: web.v1.SetNpcShopRequest.items:type_name -> web.v1.AdminNpcShopItem
	13,  // 30: web.v1.ListMerchantTemplatesResponse.result:type_name -> web.v1.AdminResult
	75,  // 31: web.v1.ListMerchantTemplatesResponse.templates:type_name -> web.v1.MerchantTemplate
	13,  // 32: web.v1.ListItemCatalogResponse.result:type_name -> web.v1.AdminResult
	78,  // 33: web.v1.ListItemCatalogResponse.items:type_name -> web.v1.ItemCatalogEntry
	102, // 34: web.v1.DropItemMob.origins:type_name -> web.v1.AdminMobOrigin
	81,  // 35: web.v1.DropItemEntry.mobs:type_name -> web.v1.DropItemMob
	13,  // 36: web.v1.ListDropItemsResponse.result:type_name -> web.v1.AdminResult
	82,  // 37: web.v1.ListDropItemsResponse.items:type_name -> web.v1.DropItemEntry
	85,  // 38: web.v1.MobDropEntry.items:type_name -> web.v1.MobDropItem
	13,  // 39: web.v1.ListMobDropsResponse.result:type_name -> web.v1.AdminResult
	86,  // 40: web.v1.ListMobDropsResponse.mobs:type_name -> web.v1.MobDropEntry
	13,  // 41: web.v1.ListItemPricesResponse.result:type_name -> web.v1.AdminResult
	89,  // 42: web.v1.ListItemPricesResponse.prices:type_name -> web.v1.ItemPrice
	13,  // 43: web.v1.ListMapZonesResponse.result:type_name -> web.v1.AdminResult
	92,  // 44: web.v1.ListMapZonesResponse.zones:type_name -> web.v1.MapZone
	13,  // 45: web.v1.ListMobTemplatesResponse.result:type_name -> web.v1.AdminResult
	95,  // 46: web.v1.ListMobTemplatesResponse.templates:type_name -> web.v1.MobTemplateFile
	98,  // 47: web.v1.AdminMobTemplateStat.equip:type_name -> web.v1.AdminMobTemplateEquipItem
	13,  // 48: web.v1.GetMobTemplateStatResponse.result:type_name -> web.v1.AdminResult
	99,  // 49: web.v1.GetMobTemplateStatResponse.stat:type_name -> web.v1.AdminMobTemplateStat
	99,  // 50: web.v1.GetMobTemplateStatResponse.file_stat:type_name -> web.v1.AdminMobTemplateStat
	102, // 51: web.v1.GetMobTemplateStatResponse.origins:type_name -> web.v1.AdminMobOrigin
	99,  // 52: web.v1.UpsertMobTemplateStatRequest.stat:type_name -> web.v1.AdminMobTemplateStat
	13,  // 53: web.v1.UpsertMobTemplateStatResponse.result:type_name -> web.v1.AdminResult
	98,  // 54: web.v1.SetMobTemplateEquipRequest.items:type_name -> web.v1.AdminMobTemplateEquipItem
	13,  // 55: web.v1.GetAttributeMapInfoResponse.result:type_name -> web.v1.AdminResult
	109, // 56: web.v1.GetAttributeMapInfoResponse.info:type_name -> web.v1.AttributeMapInfo
	110, // 57: web.v1.AttributeMapInfo.histogram:type_name -> web.v1.AttributeMapValueCount
	111, // 58: web.v1.AttributeMapInfo.meanings:type_name -> web.v1.AttributeMapMeaning
	14,  // 59: web.v1.TransformAttributeMapRequest.operation:type_name -> web.v1.AttributeMapTransformOperation
	112, // 60: web.v1.TransformAttributeMapRequest.rect:type_name -> web.v1.AttributeMapRect
	113, // 61: web.v1.TransformAttributeMapRequest.filter:type_name -> web.v1.AttributeMapTransformFilter
	13,  // 62: web.v1.TransformAttributeMapResponse.result:type_name -> web.v1.AdminResult
	110, // 63: web.v1.TransformAttributeMapResponse.before_histogram:type_name -> web.v1.AttributeMapValueCount
	110, // 64: web.v1.TransformAttributeMapResponse.after_histogram:type_name -> web.v1.AttributeMapValueCount
	13,  // 65: web.v1.ListShopItemsResponse.result:type_name -> web.v1.AdminResult
	116, // 66: web.v1.ListShopItemsResponse.items:type_name -> web.v1.DonateShopItem
	116, // 67: web.v1.UpsertShopItemRequest.item:type_name -> web.v1.DonateShopItem
	13,  // 68: web.v1.UpsertShopItemResponse.result:type_name -> web.v1.AdminResult
	13,  // 69: web.v1.CreditDonateBalanceResponse.result:type_name -> web.v1.AdminResult
	116, // 70: web.v1.ListStoreItemsResponse.items:type_name -> web.v1.DonateShopItem
	15,  // 71: web.v1.BuyResponse.result:type_name -> web.v1.BuyResult
	13,  // 72: web.v1.ListRewardItemsResponse.result:type_name -> web.v1.AdminResult
	131, // 73: web.v1.ListRewardItemsResponse.items:type_name -> web.v1.DailyRewardItem
	131, // 74: web.v1.UpsertRewardItemRequest.item:type_name -> web.v1.DailyRewardItem
	13,  // 75: web.v1.UpsertRewardItemResponse.result:type_name -> web.v1.AdminResult
	13,  // 76: web.v1.GetWorldEventConfigResponse.result:type_name -> web.v1.AdminResult
	138, // 77: web.v1.GetWorldEventConfigResponse.config:type_name -> web.v1.WorldEventConfig
	138, // 78: web.v1.SetWorldEventConfigRequest.config:type_name -> web.v1.WorldEventConfig
	131, // 79: web.v1.ListRewardsResponse.items:type_name -> web.v1.DailyRewardItem
	16,  // 80: web.v1.ClaimResponse.result:type_name -> web.v1.ClaimResult
	19,  // 81: web.v1.AttachTopupChargeResponse.result:type_name -> web.v1.AttachResult
	13,  // 82: web.v1.SavePayerProfileResponse.result:type_name -> web.v1.AdminResult
	17,  // 83: web.v1.CreateTopupOrderRequest.payment_method:type_name -> web.v1.PaymentMethod
	13,  // 84: web.v1.CreateTopupOrderResponse.result:type_name -> web.v1.AdminResult
	18,  // 85: web.v1.ConfirmTopupOrderResponse.result:type_name -> web.v1.TopupResult
	20,  // 86: web.v1.GetTopupOrderResponse.status:type_name -> web.v1.TopupStatus
	17,  // 87: web.v1.RevenueByMethod.payment_method:type_name -> web.v1.PaymentMethod
	160, // 88: web.v1.GetRevenueSummaryRequest.window:type_name -> web.v1.RevenueWindow
	21,  // 89: web.v1.GetRevenueSummaryRequest.bucket:type_name -> web.v1.RevenueBucket
	13,  // 90: web.v1.GetRevenueSummaryResponse.result:type_name -> web.v1.AdminResult
	161, // 91: web.v1.GetRevenueSummaryResponse.totals:type_name -> web.v1.RevenueTotals
	162, // 92: web.v1.GetRevenueSummaryResponse.by_method:type_name -> web.v1.RevenueByMethod
	163, // 93: web.v1.GetRevenueSummaryResponse.series:type_name -> web.v1.RevenuePoint
	17,  // 94: web.v1.TopupOrderRow.payment_method:type_name -> web.v1.PaymentMethod
	20,  // 95: web.v1.TopupOrderRow.status:type_name -> web.v1.TopupStatus
	160, // 96: web.v1.ListTopupOrdersRequest.window:type_name -> web.v1.RevenueWindow
	20,  // 97: web.v1.ListTopupOrdersRequest.status:type_name -> web.v1.TopupStatus
	17,  // 98: web.v1.ListTopupOrdersRequest.payment_method:type_name -> web.v1.PaymentMethod
	13,  // 99: web.v1.ListTopupOrdersResponse.result:type_name -> web.v1.AdminResult
	166, // 100: web.v1.ListTopupOrdersResponse.orders:type_name -> web.v1.TopupOrderRow
	160, // 101: web.v1.ListTopBuyersRequest.window:type_name -> web.v1.RevenueWindow
	13,  // 102: web.v1.ListTopBuyersResponse.result:type_name -> web.v1.AdminResult
	169, // 103: web.v1.ListTopBuyersResponse.buyers:type_name -> web.v1.TopBuyerRow
	22,  // 104: web.v1.DonateLedgerRow.action:type_name -> web.v1.DonateLedgerAction
	160, // 105: web.v1.ListDonateSpendRequest.window:type_name -> web.v1.RevenueWindow
	22,  // 106: web.v1.ListDonateSpendRequest.action:type_name -> web.v1.DonateLedgerAction
	13,  // 107: web.v1.ListDonateSpendResponse.result:type_name -> web.v1.AdminResult
	172, // 108: web.v1.ListDonateSpendResponse.entries:type_name -> web.v1.DonateLedgerRow
	13,  // 109: web.v1.SearchAccountsResponse.result:type_name -> web.v1.AdminResult
	175, // 110: web.v1.SearchAccountsResponse.accounts:type_name -> web.v1.AccountSummary
	13,  // 111: web.v1.GetItemStatResponse.result:type_name -> web.v1.AdminResult
	178, // 112: web.v1.GetItemStatResponse.stat:type_name -> web.v1.AdminItemStat
	178, // 113: web.v1.UpsertItemStatRequest.stat:type_name -> web.v1.AdminItemStat
	183, // 114: web.v1.ListMountGrowthCurvesResponse.curves:type_name -> web.v1.AdminMountGrowthCurve
	188, // 115: web.v1.ListMountAbsorbResponse.absorb:type_name -> web.v1.AdminMountAbsorb
	195, // 116: web.v1.ListMountBonusResponse.bonus:type_name -> web.v1.AdminMountBonus
	23,  // 117: web.v1.AccountWebService.CreateAccount:input_type -> web.v1.CreateAccountRequest
	25,  // 118: web.v1.AccountWebService.VerifyCredentials:input_type -> web.v1.VerifyCredentialsRequest
	27,  // 119: web.v1.AccountWebService.SetMyDiscordLink:input_type -> web.v1.SetMyDiscordLinkRequest
	29,  // 120: web.v1.RmtWebService.SavePixKey:input_type -> web.v1.SavePixKeyRequest
	34,  // 121: web.v1.RmtWebService.GetPixKey:input_type -> web.v1.GetPixKeyRequest
	36,  // 122: web.v1.RmtWebService.DeletePixKey:input_type -> web.v1.DeletePixKeyRequest
	38,  // 123: web.v1.RmtWebService.GetMyCurrentPixCharge:input_type -> web.v1.GetMyCurrentPixChargeRequest
	31,  // 124: web.v1.RmtWebService.ListMarketListings:input_type -> web.v1.ListMarketListingsRequest
	40,  // 125: web.v1.RmtSystemService.NotifySyncpayEvent:input_type -> web.v1.NotifySyncpayEventRequest
	42,  // 126: web.v1.RankingWebService.ListExpRanking:input_type -> web.v1.ListExpRankingRequest
	45,  // 127: web.v1.RankingWebService.ListDuelRanking:input_type -> web.v1.ListDuelRankingRequest
	57,  // 128: web.v1.CharacterWebService.ListMyCharacters:input_type -> web.v1.ListMyCharactersRequest
	48,  // 129: web.v1.CharacterWebService.ListMyLedGuilds:input_type -> web.v1.ListMyLedGuildsRequest
	51,  // 130: web.v1.CharacterWebService.SetMyGuildEmblem:input_type -> web.v1.SetMyGuildEmblemRequest
	53,  // 131: web.v1.CharacterWebService.ClearMyGuildEmblem:input_type -> web.v1.ClearMyGuildEmblemRequest
	55,  // 132: web.v1.CharacterWebService.GetGuildEmblem:input_type -> web.v1.GetGuildEmblemRequest
	60,  // 133: web.v1.ItemCatalogService.ListItems:input_type -> web.v1.ListItemsRequest
	65,  // 134: web.v1.NpcAdminService.ListNpcs:input_type -> web.v1.ListNpcsRequest
	67,  // 135: web.v1.NpcAdminService.GetNpc:input_type -> web.v1.GetNpcRequest
	69,  // 136: web.v1.NpcAdminService.UpsertNpc:input_type -> web.v1.UpsertNpcRequest
	71,  // 137: web.v1.NpcAdminService.SetNpcVisibility:input_type -> web.v1.SetNpcVisibilityRequest
	72,  // 138: web.v1.NpcAdminService.SetNpcShop:input_type -> web.v1.SetNpcShopRequest
	73,  // 139: web.v1.NpcAdminService.SetItemPrice:input_type -> web.v1.SetItemPriceRequest
	74,  // 140: web.v1.NpcAdminService.DeleteNpc:input_type -> web.v1.DeleteNpcRequest
	76,  // 141: web.v1.NpcAdminService.ListMerchantTemplates:input_type -> web.v1.ListMerchantTemplatesRequest
	79,  // 142: web.v1.NpcAdminService.ListItemCatalog:input_type -> web.v1.ListItemCatalogRequest
	83,  // 143: web.v1.NpcAdminService.ListDropItems:input_type -> web.v1.ListDropItemsRequest
	87,  // 144: web.v1.NpcAdminService.ListMobDrops:input_type -> web.v1.ListMobDropsRequest
	90,  // 145: web.v1.NpcAdminService.ListItemPrices:input_type -> web.v1.ListItemPricesRequest
	93,  // 146: web.v1.NpcAdminService.ListMapZones:input_type -> web.v1.ListMapZonesRequest
	96,  // 147: web.v1.MobTemplateAdminService.ListMobTemplates:input_type -> web.v1.ListMobTemplatesRequest
	100, // 148: web.v1.MobTemplateAdminService.GetMobTemplateStat:input_type -> web.v1.GetMobTemplateStatRequest
	103, // 149: web.v1.MobTemplateAdminService.UpsertMobTemplateStat:input_type -> web.v1.UpsertMobTemplateStatRequest
	105, // 150: web.v1.MobTemplateAdminService.SetMobTemplateEquip:input_type -> web.v1.SetMobTemplateEquipRequest
	106, // 151: web.v1.MobTemplateAdminService.DeleteMobTemplateStat:input_type -> web.v1.DeleteMobTemplateStatRequest
	107, // 152: web.v1.AttributeMapAdminService.GetAttributeMapInfo:input_type -> web.v1.GetAttributeMapInfoRequest
	114, // 153: web.v1.AttributeMapAdminService.TransformAttributeMap:input_type -> web.v1.TransformAttributeMapRequest
	117, // 154: web.v1.DonateAdminService.ListShopItems:input_type -> web.v1.ListShopItemsRequest
	119, // 155: web.v1.DonateAdminService.UpsertShopItem:input_type -> web.v1.UpsertShopItemRequest
	121, // 156: web.v1.DonateAdminService.SetShopItemEnabled:input_type -> web.v1.SetShopItemEnabledRequest
	122, // 157: web.v1.DonateAdminService.DeleteShopItem:input_type -> web.v1.DeleteShopItemRequest
	123, // 158: web.v1.DonateAdminService.CreditDonateBalance:input_type -> web.v1.CreditDonateBalanceRequest
	125, // 159: web.v1.DonateShopService.ListShopItems:input_type -> web.v1.ListStoreItemsRequest
	127, // 160: web.v1.DonateShopService.GetBalance:input_type -> web.v1.GetBalanceRequest
	129, // 161: web.v1.DonateShopService.Buy:input_type -> web.v1.BuyRequest
	132, // 162: web.v1.DailyRewardAdminService.ListRewardItems:input_type -> web.v1.ListRewardItemsRequest
	134, // 163: web.v1.DailyRewardAdminService.UpsertRewardItem:input_type -> web.v1.UpsertRewardItemRequest
	136, // 164: web.v1.DailyRewardAdminService.SetRewardItemEnabled:input_type -> web.v1.SetRewardItemEnabledRequest
	137, // 165: web.v1.DailyRewardAdminService.DeleteRewardItem:input_type -> web.v1.DeleteRewardItemRequest
	139, // 166: web.v1.WorldEventAdminService.GetWorldEventConfig:input_type -> web.v1.GetWorldEventConfigRequest
	141, // 167: web.v1.WorldEventAdminService.SetWorldEventConfig:input_type -> web.v1.SetWorldEventConfigRequest
	142, // 168: web.v1.DailyRewardService.ListRewards:input_type -> web.v1.ListRewardsRequest
	144, // 169: web.v1.DailyRewardService.GetClaimStatus:input_type -> web.v1.GetClaimStatusRequest
	146, // 170: web.v1.DailyRewardService.Claim:input_type -> web.v1.ClaimRequest
	150, // 171: web.v1.DonateTopupService.GetPayerProfile:input_type -> web.v1.GetPayerProfileRequest
	152, // 172: web.v1.DonateTopupService.SavePayerProfile:input_type -> web.v1.SavePayerProfileRequest
	154, // 173: web.v1.DonateTopupService.CreateTopupOrder:input_type -> web.v1.CreateTopupOrderRequest
	156, // 174: web.v1.DonateTopupService.ConfirmTopupOrder:input_type -> web.v1.ConfirmTopupOrderRequest
	158, // 175: web.v1.DonateTopupService.GetTopupOrder:input_type -> web.v1.GetTopupOrderRequest
	148, // 176: web.v1.DonateTopupService.AttachTopupCharge:input_type -> web.v1.AttachTopupChargeRequest
	164, // 177: web.v1.DonateRevenueAdminService.GetRevenueSummary:input_type -> web.v1.GetRevenueSummaryRequest
	167, // 178: web.v1.DonateRevenueAdminService.ListTopupOrders:input_type -> web.v1.ListTopupOrdersRequest
	170, // 179: web.v1.DonateRevenueAdminService.ListTopBuyers:input_type -> web.v1.ListTopBuyersRequest
	173, // 180: web.v1.DonateRevenueAdminService.ListDonateSpend:input_type -> web.v1.ListDonateSpendRequest
	176, // 181: web.v1.DonateRevenueAdminService.SearchAccounts:input_type -> web.v1.SearchAccountsRequest
	179, // 182: web.v1.ItemStatAdminService.GetItemStat:input_type -> web.v1.GetItemStatRequest
	181, // 183: web.v1.ItemStatAdminService.UpsertItemStat:input_type -> web.v1.UpsertItemStatRequest
	182, // 184: web.v1.ItemStatAdminService.DeleteItemStat:input_type -> web.v1.DeleteItemStatRequest
	184, // 185: web.v1.MountGrowthAdminService.ListMountGrowthCurves:input_type -> web.v1.ListMountGrowthCurvesRequest
	186, // 186: web.v1.MountGrowthAdminService.SetMountGrowthCurve:input_type -> web.v1.SetMountGrowthCurveRequest
	187, // 187: web.v1.MountGrowthAdminService.ClearMountGrowthCurve:input_type -> web.v1.ClearMountGrowthCurveRequest
	191, // 188: web.v1.MountGrowthAdminService.ListMountAbsorb:input_type -> web.v1.ListMountAbsorbRequest
	193, // 189: web.v1.MountGrowthAdminService.SetMountAbsorb:input_type -> web.v1.SetMountAbsorbRequest
	194, // 190: web.v1.MountGrowthAdminService.ClearMountAbsorb:input_type -> web.v1.ClearMountAbsorbRequest
	196, // 191: web.v1.MountGrowthAdminService.ListMountBonus:input_type -> web.v1.ListMountBonusRequest
	198, // 192: web.v1.MountGrowthAdminService.SetMountBonus:input_type -> web.v1.SetMountBonusRequest
	199, // 193: web.v1.MountGrowthAdminService.ClearMountBonus:input_type -> web.v1.ClearMountBonusRequest
	189, // 194: web.v1.MountGrowthAdminService.MountConfigVersion:input_type -> web.v1.MountConfigVersionRequest
	24,  // 195: web.v1.AccountWebService.CreateAccount:output_type -> web.v1.CreateAccountResponse
	26,  // 196: web.v1.AccountWebService.VerifyCredentials:output_type -> web.v1.VerifyCredentialsResponse
	28,  // 197: web.v1.AccountWebService.SetMyDiscordLink:output_type -> web.v1.SetMyDiscordLinkResponse
	30,  // 198: web.v1.RmtWebService.SavePixKey:output_type -> web.v1.SavePixKeyResponse
	35,  // 199: web.v1.RmtWebService.GetPixKey:output_type -> web.v1.GetPixKeyResponse
	37,  // 200: web.v1.RmtWebService.DeletePixKey:output_type -> web.v1.DeletePixKeyResponse
	39,  // 201: web.v1.RmtWebService.GetMyCurrentPixCharge:output_type -> web.v1.GetMyCurrentPixChargeResponse
	33,  // 202: web.v1.RmtWebService.ListMarketListings:output_type -> web.v1.ListMarketListingsResponse
	41,  // 203: web.v1.RmtSystemService.NotifySyncpayEvent:output_type -> web.v1.NotifySyncpayEventResponse
	44,  // 204: web.v1.RankingWebService.ListExpRanking:output_type -> web.v1.ListExpRankingResponse
	47,  // 205: web.v1.RankingWebService.ListDuelRanking:output_type -> web.v1.ListDuelRankingResponse
	59,  // 206: web.v1.CharacterWebService.ListMyCharacters:output_type -> web.v1.ListMyCharactersResponse
	49,  // 207: web.v1.CharacterWebService.ListMyLedGuilds:output_type -> web.v1.ListMyLedGuildsResponse
	52,  // 208: web.v1.CharacterWebService.SetMyGuildEmblem:output_type -> web.v1.SetMyGuildEmblemResponse
	54,  // 209: web.v1.CharacterWebService.ClearMyGuildEmblem:output_type -> web.v1.ClearMyGuildEmblemResponse
	56,  // 210: web.v1.CharacterWebService.GetGuildEmblem:output_type -> web.v1.GetGuildEmblemResponse
	61,  // 211: web.v1.ItemCatalogService.ListItems:output_type -> web.v1.ListItemsResponse
	66,  // 212: web.v1.NpcAdminService.ListNpcs:output_type -> web.v1.ListNpcsResponse
	68,  // 213: web.v1.NpcAdminService.GetNpc:output_type -> web.v1.GetNpcResponse
	70,  // 214: web.v1.NpcAdminService.UpsertNpc:output_type -> web.v1.UpsertNpcResponse
	62,  // 215: web.v1.NpcAdminService.SetNpcVisibility:output_type -> web.v1.AdminAck
	62,  // 216: web.v1.NpcAdminService.SetNpcShop:output_type -> web.v1.AdminAck
	62,  // 217: web.v1.NpcAdminService.SetItemPrice:output_type -> web.v1.AdminAck
	62,  // 218: web.v1.NpcAdminService.DeleteNpc:output_type -> web.v1.AdminAck
	77,  // 219: web.v1.NpcAdminService.ListMerchantTemplates:output_type -> web.v1.ListMerchantTemplatesResponse
	80,  // 220: web.v1.NpcAdminService.ListItemCatalog:output_type -> web.v1.ListItemCatalogResponse
	84,  // 221: web.v1.NpcAdminService.ListDropItems:output_type -> web.v1.ListDropItemsResponse
	88,  // 222: web.v1.NpcAdminService.ListMobDrops:output_type -> web.v1.ListMobDropsResponse
	91,  // 223: web.v1.NpcAdminService.ListItemPrices:output_type -> web.v1.ListItemPricesResponse
	94,  // 224: web.v1.NpcAdminService.ListMapZones:output_type -> web.v1.ListMapZonesResponse
	97,  // 225: web.v1.MobTemplateAdminService.ListMobTemplates:output_type -> web.v1.ListMobTemplatesResponse
	101, // 226: web.v1.MobTemplateAdminService.GetMobTemplateStat:output_type -> web.v1.GetMobTemplateStatResponse
	104, // 227: web.v1.MobTemplateAdminService.UpsertMobTemplateStat:output_type -> web.v1.UpsertMobTemplateStatResponse
	62,  // 228: web.v1.MobTemplateAdminService.SetMobTemplateEquip:output_type -> web.v1.AdminAck
	62,  // 229: web.v1.MobTemplateAdminService.DeleteMobTemplateStat:output_type -> web.v1.AdminAck
	108, // 230: web.v1.AttributeMapAdminService.GetAttributeMapInfo:output_type -> web.v1.GetAttributeMapInfoResponse
	115, // 231: web.v1.AttributeMapAdminService.TransformAttributeMap:output_type -> web.v1.TransformAttributeMapResponse
	118, // 232: web.v1.DonateAdminService.ListShopItems:output_type -> web.v1.ListShopItemsResponse
	120, // 233: web.v1.DonateAdminService.UpsertShopItem:output_type -> web.v1.UpsertShopItemResponse
	62,  // 234: web.v1.DonateAdminService.SetShopItemEnabled:output_type -> web.v1.AdminAck
	62,  // 235: web.v1.DonateAdminService.DeleteShopItem:output_type -> web.v1.AdminAck
	124, // 236: web.v1.DonateAdminService.CreditDonateBalance:output_type -> web.v1.CreditDonateBalanceResponse
	126, // 237: web.v1.DonateShopService.ListShopItems:output_type -> web.v1.ListStoreItemsResponse
	128, // 238: web.v1.DonateShopService.GetBalance:output_type -> web.v1.GetBalanceResponse
	130, // 239: web.v1.DonateShopService.Buy:output_type -> web.v1.BuyResponse
	133, // 240: web.v1.DailyRewardAdminService.ListRewardItems:output_type -> web.v1.ListRewardItemsResponse
	135, // 241: web.v1.DailyRewardAdminService.UpsertRewardItem:output_type -> web.v1.UpsertRewardItemResponse
	62,  // 242: web.v1.DailyRewardAdminService.SetRewardItemEnabled:output_type -> web.v1.AdminAck
	62,  // 243: web.v1.DailyRewardAdminService.DeleteRewardItem:output_type -> web.v1.AdminAck
	140, // 244: web.v1.WorldEventAdminService.GetWorldEventConfig:output_type -> web.v1.GetWorldEventConfigResponse
	62,  // 245: web.v1.WorldEventAdminService.SetWorldEventConfig:output_type -> web.v1.AdminAck
	143, // 246: web.v1.DailyRewardService.ListRewards:output_type -> web.v1.ListRewardsResponse
	145, // 247: web.v1.DailyRewardService.GetClaimStatus:output_type -> web.v1.GetClaimStatusResponse
	147, // 248: web.v1.DailyRewardService.Claim:output_type -> web.v1.ClaimResponse
	151, // 249: web.v1.DonateTopupService.GetPayerProfile:output_type -> web.v1.GetPayerProfileResponse
	153, // 250: web.v1.DonateTopupService.SavePayerProfile:output_type -> web.v1.SavePayerProfileResponse
	155, // 251: web.v1.DonateTopupService.CreateTopupOrder:output_type -> web.v1.CreateTopupOrderResponse
	157, // 252: web.v1.DonateTopupService.ConfirmTopupOrder:output_type -> web.v1.ConfirmTopupOrderResponse
	159, // 253: web.v1.DonateTopupService.GetTopupOrder:output_type -> web.v1.GetTopupOrderResponse
	149, // 254: web.v1.DonateTopupService.AttachTopupCharge:output_type -> web.v1.AttachTopupChargeResponse
	165, // 255: web.v1.DonateRevenueAdminService.GetRevenueSummary:output_type -> web.v1.GetRevenueSummaryResponse
	168, // 256: web.v1.DonateRevenueAdminService.ListTopupOrders:output_type -> web.v1.ListTopupOrdersResponse
	171, // 257: web.v1.DonateRevenueAdminService.ListTopBuyers:output_type -> web.v1.ListTopBuyersResponse
	174, // 258: web.v1.DonateRevenueAdminService.ListDonateSpend:output_type -> web.v1.ListDonateSpendResponse
	177, // 259: web.v1.DonateRevenueAdminService.SearchAccounts:output_type -> web.v1.SearchAccountsResponse
	180, // 260: web.v1.ItemStatAdminService.GetItemStat:output_type -> web.v1.GetItemStatResponse
	62,  // 261: web.v1.ItemStatAdminService.UpsertItemStat:output_type -> web.v1.AdminAck
	62,  // 262: web.v1.ItemStatAdminService.DeleteItemStat:output_type -> web.v1.AdminAck
	185, // 263: web.v1.MountGrowthAdminService.ListMountGrowthCurves:output_type -> web.v1.ListMountGrowthCurvesResponse
	62,  // 264: web.v1.MountGrowthAdminService.SetMountGrowthCurve:output_type -> web.v1.AdminAck
	62,  // 265: web.v1.MountGrowthAdminService.ClearMountGrowthCurve:output_type -> web.v1.AdminAck
	192, // 266: web.v1.MountGrowthAdminService.ListMountAbsorb:output_type -> web.v1.ListMountAbsorbResponse
	62,  // 267: web.v1.MountGrowthAdminService.SetMountAbsorb:output_type -> web.v1.AdminAck
	62,  // 268: web.v1.MountGrowthAdminService.ClearMountAbsorb:output_type -> web.v1.AdminAck
	197, // 269: web.v1.MountGrowthAdminService.ListMountBonus:output_type -> web.v1.ListMountBonusResponse
	62,  // 270: web.v1.MountGrowthAdminService.SetMountBonus:output_type -> web.v1.AdminAck
	62,  // 271: web.v1.MountGrowthAdminService.ClearMountBonus:output_type -> web.v1.AdminAck
	190, // 272: web.v1.MountGrowthAdminService.MountConfigVersion:output_type -> web.v1.MountConfigVersionResponse
	195, // [195:273] is the sub-list for method output_type
	117, // [117:195] is the sub-list for method input_type
...
func file_api_web_v1_web_proto_init() {
	...
	file_api_web_v1_web_proto_msgTypes[40].OneofWrappers = []any{}
	file_api_web_v1_web_proto_msgTypes[115].OneofWrappers = []any{}
	type x struct{}
