...
rem A marca do servidor vira recurso do proprio DLL (ver fundo.rc).
rc /nologo /fo out\fundo.res fundo.rc || exit /b 1
cl /nologo /LD /MT /O2 /W4 /EHsc /Fo:out\ gamepatch.cpp timerfields.cpp acessoriopct.cpp olhosdeaguia.cpp divisao.cpp macromago.cpp zoomcam.cpp alvos.cpp camadas.cpp pincel.cpp d3dpainel.cpp overlay.cpp loja.cpp lojarede.cpp fundo.cpp icones.cpp teclas.cpp servidor.cpp /link out\fundo.res user32.lib gdi32.lib d3d9.lib ws2_32.lib /OUT:out\GamePatch.dll /NOLOGO || exit /b 1
echo.
