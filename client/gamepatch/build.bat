...
cl /nologo /LD /MT /O2 /W4 /EHsc /Fo:out\ gamepatch.cpp timerfields.cpp acessoriopct.cpp olhosdeaguia.cpp divisao.cpp /link /OUT:out\GamePatch.dll /NOLOGO || exit /b 1
echo.
