...
var effectDefs = map[string][2]string{
	...
	"EF_WDAY":       {"Expira: dia", "Vencimento do item; BASE_CheckItemDate lê stEffect direto, sem passar pelo multiplicador de refino"},
	"EF_WMONTH":     {"Expira: mês", "Vencimento do item, lida direto por BASE_CheckItemDate"},
	"EF_HOUR":       {"Expira: hora", ""},
