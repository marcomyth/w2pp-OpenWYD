-- 0142_lava_golem_e_ninja — o salão de lava do 2º andar da Dungeon vira campo de
-- XP: cinco vezes mais Golem de Pedra e Anf Ninja, saque de campo no lugar do
-- template, e dois mini chefes de 2 em 2 horas.
--
-- Pedido do Marco em 25/09/2026, com fotos em (972,3994).
--
-- Quantidade (NPCGener.txt do mesmo commit): os 95 blocos dos dois dentro do
-- Dungeon_2_Andar passam a MaxNumMob × 5 — o Anf Ninja de 60 para 300 bichos, o
-- Golem de Pedra de 56 para 280. Os seis blocos do Anf Ninja com MinuteGenerate -1
-- passam a 1, como os vizinhos: o boot levanta um grupo por bloco e só o relógio de
-- minuto enche o resto até o teto.
--
-- Saque dos dois, e só isto: âmagos de Lobo e Urso a 0,50%, de Dente de Sabre a
-- 0,40%, Diamante a 0,30%, Classe D a 0,50% e C a 0,40%, a Moeda de Prata (1Mi) a
-- 0,30% (taxa baixa, a mesma do Gelo), e o Sem Sela, o mais difícil, a 0,20% o N e
-- 0,15% o B (eram 0,33% e 0,29% na 0091). Tudo o que o template soltava vai a 0%.
-- Pelo viés do sorteio da Mesa (droprule/vies_test.go) cada número abaixo paga
-- 22,1% a mais: 50 sai 0,61%, 15 sai 0,18%.
--
-- Os mini chefes (Boss_Golem e Boss_Anf_Ninja, blocos 6147 e 6148) não têm linha
-- aqui: o Carry deles é vazio e o saque é código (handler/dungeon_lava.go), UM
-- prêmio por morte.
