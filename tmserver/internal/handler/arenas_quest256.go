...
// As arenas da Quest 256 do Coração do Kaizen (passo 3) e das Hidras (passo 4)
// usam templates do legado que só nascem nelas (NPCGener 3476-3508). Desde
// 14/09/2026 elas pagam em Restos e Âmagos pela Mesa de Drops (migração 0065).
